...
此表所述功能并不包括turms-plugin与turms-admin（CMS）所提供的功能，此表功能仅包括Turms服务端自身通过RESTful API（JSON通信）所提供的功能。具体API接口文档，请查阅[Turms服务端集成开发文档]()
...
| **功能**       | **功能说明**                                           | **URL**                 | **实现版本** |
| :------------- | :----------------------------------------------------- | ----------------------- | ------------ |
| 管理员登陆     |                                                        | POST /admins/sessions   | 0.8.0        |
| 管理员退出     |                                                        | DELETE /admins/sessions | 0.8.0        |
