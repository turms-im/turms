...
public final class NearbyUserOuterClass {
  ...
  static {
    ...
    internal_static_im_turms_proto_NearbyUser_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_im_turms_proto_NearbyUser_descriptor,
        new java.lang.String[] { "UserId", "DeviceType", "Info", "Distance", "Location", "DeviceType", "Info", "Distance", "Location", });
    im.turms.common.constant.DeviceTypeOuterClass.getDescriptor();
    im.turms.common.model.bo.user.UserLocationOuterClass.getDescriptor();
    im.turms.common.model.bo.user.UserInfoOuterClass.getDescriptor();
  }
