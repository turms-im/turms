...
import { CreateMeetingRequest } from "./conference/create_meeting_request";
import { DeleteMeetingRequest } from "./conference/delete_meeting_request";
import { QueryMeetingsRequest } from "./conference/query_meetings_request";
import { UpdateMeetingInvitationRequest } from "./conference/update_meeting_invitation_request";
import { UpdateMeetingRequest } from "./conference/update_meeting_request";
import { DeleteConversationSettingsRequest } from "./conversation/delete_conversation_settings_request";
import { QueryConversationSettingsRequest } from "./conversation/query_conversation_settings_request";
...
import { UpdateConversationSettingsRequest } from "./conversation/update_conversation_settings_request";
...
import { CreateMessageReactionsRequest } from "./message/create_message_reactions_request";
import { CreateMessageRequest } from "./message/create_message_request";
import { DeleteMessageReactionsRequest } from "./message/delete_message_reactions_request";
...
import { DeleteUserSettingsRequest } from "./user/delete_user_settings_request";
...
import { QueryUserSettingsRequest } from "./user/query_user_settings_request";
...
import { UpdateUserSettingsRequest } from "./user/update_user_settings_request";
...
export interface TurmsRequest {
  ...
  updateUserSettingsRequest?: UpdateUserSettingsRequest | undefined;
  deleteUserSettingsRequest?: DeleteUserSettingsRequest | undefined;
  ...
  updateGroupJoinRequestRequest?:
    ...
    | undefined;
  /** Conference */
  createMeetingRequest?: CreateMeetingRequest | undefined;
  deleteMeetingRequest?: DeleteMeetingRequest | undefined;
  queryMeetingsRequest?: QueryMeetingsRequest | undefined;
  updateMeetingRequest?: UpdateMeetingRequest | undefined;
  ...
  deleteConversationSettingsRequest?: DeleteConversationSettingsRequest | undefined;
  queryConversationSettingsRequest?: QueryConversationSettingsRequest | undefined;
  updateConversationSettingsRequest?:
    | UpdateConversationSettingsRequest
    | undefined;
  /** Message - Supplement */
  createMessageReactionsRequest?: CreateMessageReactionsRequest | undefined;
  deleteMessageReactionsRequest?: DeleteMessageReactionsRequest | undefined;
}
...
function createBaseTurmsRequest(): TurmsRequest {
  return {
    ...
    updateUserSettingsRequest: undefined,
    deleteUserSettingsRequest: undefined,
    queryUserSettingsRequest: undefined,
    ...
    createMeetingRequest: undefined,
    deleteMeetingRequest: undefined,
    queryMeetingsRequest: undefined,
    updateMeetingRequest: undefined,
    updateMeetingInvitationRequest: undefined,
    ...
    deleteConversationSettingsRequest: undefined,
    queryConversationSettingsRequest: undefined,
    updateConversationSettingsRequest: undefined,
    createMessageReactionsRequest: undefined,
    deleteMessageReactionsRequest: undefined,
  };
}

export const TurmsRequest: MessageFns<TurmsRequest> = {
  encode(message: TurmsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.createSessionRequest !== undefined) {
      CreateSessionRequest.encode(message.createSessionRequest, writer.uint32(26).fork()).join();
    }
    if (message.deleteSessionRequest !== undefined) {
      DeleteSessionRequest.encode(message.deleteSessionRequest, writer.uint32(34).fork()).join();
    }
    if (message.queryConversationsRequest !== undefined) {
      QueryConversationsRequest.encode(message.queryConversationsRequest, writer.uint32(42).fork()).join();
    }
    if (message.updateConversationRequest !== undefined) {
      UpdateConversationRequest.encode(message.updateConversationRequest, writer.uint32(50).fork()).join();
    }
    if (message.updateTypingStatusRequest !== undefined) {
      UpdateTypingStatusRequest.encode(message.updateTypingStatusRequest, writer.uint32(58).fork()).join();
    }
    if (message.createMessageRequest !== undefined) {
      CreateMessageRequest.encode(message.createMessageRequest, writer.uint32(66).fork()).join();
    }
    if (message.queryMessagesRequest !== undefined) {
      QueryMessagesRequest.encode(message.queryMessagesRequest, writer.uint32(74).fork()).join();
    }
    if (message.updateMessageRequest !== undefined) {
      UpdateMessageRequest.encode(message.updateMessageRequest, writer.uint32(82).fork()).join();
    }
    if (message.createGroupMembersRequest !== undefined) {
      CreateGroupMembersRequest.encode(message.createGroupMembersRequest, writer.uint32(90).fork()).join();
    }
    if (message.deleteGroupMembersRequest !== undefined) {
      DeleteGroupMembersRequest.encode(message.deleteGroupMembersRequest, writer.uint32(98).fork()).join();
    }
    if (message.queryGroupMembersRequest !== undefined) {
      QueryGroupMembersRequest.encode(message.queryGroupMembersRequest, writer.uint32(106).fork()).join();
    }
    if (message.updateGroupMemberRequest !== undefined) {
      UpdateGroupMemberRequest.encode(message.updateGroupMemberRequest, writer.uint32(114).fork()).join();
    }
    if (message.queryUserProfilesRequest !== undefined) {
      QueryUserProfilesRequest.encode(message.queryUserProfilesRequest, writer.uint32(802).fork()).join();
    }
    if (message.queryNearbyUsersRequest !== undefined) {
      QueryNearbyUsersRequest.encode(message.queryNearbyUsersRequest, writer.uint32(810).fork()).join();
    }
    if (message.queryUserOnlineStatusesRequest !== undefined) {
      QueryUserOnlineStatusesRequest.encode(message.queryUserOnlineStatusesRequest, writer.uint32(818).fork()).join();
    }
    if (message.updateUserLocationRequest !== undefined) {
      UpdateUserLocationRequest.encode(message.updateUserLocationRequest, writer.uint32(826).fork()).join();
    }
    if (message.updateUserOnlineStatusRequest !== undefined) {
      UpdateUserOnlineStatusRequest.encode(message.updateUserOnlineStatusRequest, writer.uint32(834).fork()).join();
    }
    if (message.updateUserRequest !== undefined) {
      UpdateUserRequest.encode(message.updateUserRequest, writer.uint32(842).fork()).join();
    }
    if (message.updateUserSettingsRequest !== undefined) {
      UpdateUserSettingsRequest.encode(message.updateUserSettingsRequest, writer.uint32(850).fork()).join();
    }
    if (message.deleteUserSettingsRequest !== undefined) {
      DeleteUserSettingsRequest.encode(message.deleteUserSettingsRequest, writer.uint32(858).fork()).join();
    }
    if (message.queryUserSettingsRequest !== undefined) {
      QueryUserSettingsRequest.encode(message.queryUserSettingsRequest, writer.uint32(866).fork()).join();
    }
    if (message.createFriendRequestRequest !== undefined) {
      CreateFriendRequestRequest.encode(message.createFriendRequestRequest, writer.uint32(1602).fork()).join();
    }
    if (message.createRelationshipGroupRequest !== undefined) {
      CreateRelationshipGroupRequest.encode(message.createRelationshipGroupRequest, writer.uint32(1610).fork()).join();
    }
    if (message.createRelationshipRequest !== undefined) {
      CreateRelationshipRequest.encode(message.createRelationshipRequest, writer.uint32(1618).fork()).join();
    }
    if (message.deleteFriendRequestRequest !== undefined) {
      DeleteFriendRequestRequest.encode(message.deleteFriendRequestRequest, writer.uint32(1626).fork()).join();
    }
    if (message.deleteRelationshipGroupRequest !== undefined) {
      DeleteRelationshipGroupRequest.encode(message.deleteRelationshipGroupRequest, writer.uint32(1634).fork()).join();
    }
    if (message.deleteRelationshipRequest !== undefined) {
      DeleteRelationshipRequest.encode(message.deleteRelationshipRequest, writer.uint32(1642).fork()).join();
    }
    if (message.queryFriendRequestsRequest !== undefined) {
      QueryFriendRequestsRequest.encode(message.queryFriendRequestsRequest, writer.uint32(1650).fork()).join();
    }
    if (message.queryRelatedUserIdsRequest !== undefined) {
      QueryRelatedUserIdsRequest.encode(message.queryRelatedUserIdsRequest, writer.uint32(1658).fork()).join();
    }
    if (message.queryRelationshipGroupsRequest !== undefined) {
      QueryRelationshipGroupsRequest.encode(message.queryRelationshipGroupsRequest, writer.uint32(1666).fork()).join();
    }
    if (message.queryRelationshipsRequest !== undefined) {
      QueryRelationshipsRequest.encode(message.queryRelationshipsRequest, writer.uint32(1674).fork()).join();
    }
    if (message.updateFriendRequestRequest !== undefined) {
      UpdateFriendRequestRequest.encode(message.updateFriendRequestRequest, writer.uint32(1682).fork()).join();
    }
    if (message.updateRelationshipGroupRequest !== undefined) {
      UpdateRelationshipGroupRequest.encode(message.updateRelationshipGroupRequest, writer.uint32(1690).fork()).join();
    }
    if (message.updateRelationshipRequest !== undefined) {
      UpdateRelationshipRequest.encode(message.updateRelationshipRequest, writer.uint32(1698).fork()).join();
    }
    if (message.createGroupRequest !== undefined) {
      CreateGroupRequest.encode(message.createGroupRequest, writer.uint32(2402).fork()).join();
    }
    if (message.deleteGroupRequest !== undefined) {
      DeleteGroupRequest.encode(message.deleteGroupRequest, writer.uint32(2410).fork()).join();
    }
    if (message.queryGroupsRequest !== undefined) {
      QueryGroupsRequest.encode(message.queryGroupsRequest, writer.uint32(2418).fork()).join();
    }
    if (message.queryJoinedGroupIdsRequest !== undefined) {
      QueryJoinedGroupIdsRequest.encode(message.queryJoinedGroupIdsRequest, writer.uint32(2426).fork()).join();
    }
    if (message.queryJoinedGroupInfosRequest !== undefined) {
      QueryJoinedGroupInfosRequest.encode(message.queryJoinedGroupInfosRequest, writer.uint32(2434).fork()).join();
    }
    if (message.updateGroupRequest !== undefined) {
      UpdateGroupRequest.encode(message.updateGroupRequest, writer.uint32(2442).fork()).join();
    }
    if (message.createGroupBlockedUserRequest !== undefined) {
      CreateGroupBlockedUserRequest.encode(message.createGroupBlockedUserRequest, writer.uint32(3202).fork()).join();
    }
    if (message.deleteGroupBlockedUserRequest !== undefined) {
      DeleteGroupBlockedUserRequest.encode(message.deleteGroupBlockedUserRequest, writer.uint32(3210).fork()).join();
    }
    ...
    if (message.createGroupInvitationRequest !== undefined) {
      CreateGroupInvitationRequest.encode(message.createGroupInvitationRequest, writer.uint32(4010).fork()).join();
    }
    if (message.createGroupJoinRequestRequest !== undefined) {
      CreateGroupJoinRequestRequest.encode(message.createGroupJoinRequestRequest, writer.uint32(4018).fork()).join();
    }
    ...
    if (message.deleteGroupInvitationRequest !== undefined) {
      DeleteGroupInvitationRequest.encode(message.deleteGroupInvitationRequest, writer.uint32(4034).fork()).join();
    }
    if (message.deleteGroupJoinRequestRequest !== undefined) {
      DeleteGroupJoinRequestRequest.encode(message.deleteGroupJoinRequestRequest, writer.uint32(4042).fork()).join();
    }
    ...
    if (message.queryGroupInvitationsRequest !== undefined) {
      QueryGroupInvitationsRequest.encode(message.queryGroupInvitationsRequest, writer.uint32(4058).fork()).join();
    }
    if (message.queryGroupJoinRequestsRequest !== undefined) {
      QueryGroupJoinRequestsRequest.encode(message.queryGroupJoinRequestsRequest, writer.uint32(4066).fork()).join();
    }
    if (message.queryGroupJoinQuestionsRequest !== undefined) {
      QueryGroupJoinQuestionsRequest.encode(message.queryGroupJoinQuestionsRequest, writer.uint32(4074).fork()).join();
    }
    if (message.updateGroupInvitationRequest !== undefined) {
      UpdateGroupInvitationRequest.encode(message.updateGroupInvitationRequest, writer.uint32(4082).fork()).join();
    }
    if (message.updateGroupJoinQuestionRequest !== undefined) {
      UpdateGroupJoinQuestionRequest.encode(message.updateGroupJoinQuestionRequest, writer.uint32(4090).fork()).join();
    }
    if (message.updateGroupJoinRequestRequest !== undefined) {
      UpdateGroupJoinRequestRequest.encode(message.updateGroupJoinRequestRequest, writer.uint32(4098).fork()).join();
    }
    if (message.createMeetingRequest !== undefined) {
      CreateMeetingRequest.encode(message.createMeetingRequest, writer.uint32(7202).fork()).join();
    }
    if (message.deleteMeetingRequest !== undefined) {
      DeleteMeetingRequest.encode(message.deleteMeetingRequest, writer.uint32(7210).fork()).join();
    }
    if (message.queryMeetingsRequest !== undefined) {
      QueryMeetingsRequest.encode(message.queryMeetingsRequest, writer.uint32(7218).fork()).join();
    }
    if (message.updateMeetingRequest !== undefined) {
      UpdateMeetingRequest.encode(message.updateMeetingRequest, writer.uint32(7226).fork()).join();
    }
    if (message.updateMeetingInvitationRequest !== undefined) {
      UpdateMeetingInvitationRequest.encode(message.updateMeetingInvitationRequest, writer.uint32(7234).fork()).join();
    }
    if (message.deleteResourceRequest !== undefined) {
      DeleteResourceRequest.encode(message.deleteResourceRequest, writer.uint32(8002).fork()).join();
    }
    ...
    if (message.queryResourceUploadInfoRequest !== undefined) {
      QueryResourceUploadInfoRequest.encode(message.queryResourceUploadInfoRequest, writer.uint32(8018).fork()).join();
    }
    ...
    if (message.deleteConversationSettingsRequest !== undefined) {
      DeleteConversationSettingsRequest.encode(message.deleteConversationSettingsRequest, writer.uint32(8802).fork())
        .join();
    }
    if (message.queryConversationSettingsRequest !== undefined) {
      QueryConversationSettingsRequest.encode(message.queryConversationSettingsRequest, writer.uint32(8810).fork())
        .join();
    }
    if (message.updateConversationSettingsRequest !== undefined) {
      UpdateConversationSettingsRequest.encode(message.updateConversationSettingsRequest, writer.uint32(8818).fork())
        .join();
    }
    if (message.createMessageReactionsRequest !== undefined) {
      CreateMessageReactionsRequest.encode(message.createMessageReactionsRequest, writer.uint32(9602).fork()).join();
    }
    if (message.deleteMessageReactionsRequest !== undefined) {
      DeleteMessageReactionsRequest.encode(message.deleteMessageReactionsRequest, writer.uint32(9610).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TurmsRequest {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 106: {
          ...
          message.updateUserSettingsRequest = UpdateUserSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 107: {
          if (tag !== 858) {
          ...
          message.deleteUserSettingsRequest = DeleteUserSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 108: {
          if (tag !== 866) {
          ...
          message.queryUserSettingsRequest = QueryUserSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 200: {
          if (tag !== 1602) {
        ...
        case 900: {
          ...
          message.createMeetingRequest = CreateMeetingRequest.decode(reader, reader.uint32());
          continue;
        }
        case 901: {
          if (tag !== 7210) {
          ...
          message.deleteMeetingRequest = DeleteMeetingRequest.decode(reader, reader.uint32());
          continue;
        }
        case 902: {
          if (tag !== 7218) {
          ...
          message.queryMeetingsRequest = QueryMeetingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 903: {
          if (tag !== 7226) {
          ...
          message.updateMeetingRequest = UpdateMeetingRequest.decode(reader, reader.uint32());
          continue;
        }
        case 904: {
          if (tag !== 7234) {
          ...
          message.updateMeetingInvitationRequest = UpdateMeetingInvitationRequest.decode(reader, reader.uint32());
          continue;
        }
        case 1000: {
          if (tag !== 8002) {
        ...
        case 1100: {
          ...
          message.deleteConversationSettingsRequest = DeleteConversationSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 1101: {
          if (tag !== 8810) {
          ...
          message.queryConversationSettingsRequest = QueryConversationSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 1102: {
          if (tag !== 8818) {
          ...
          message.updateConversationSettingsRequest = UpdateConversationSettingsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 1200: {
          if (tag !== 9602) {
          ...
          message.createMessageReactionsRequest = CreateMessageReactionsRequest.decode(reader, reader.uint32());
          continue;
        }
        case 1201: {
          if (tag !== 9610) {
          ...
          message.deleteMessageReactionsRequest = DeleteMessageReactionsRequest.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
