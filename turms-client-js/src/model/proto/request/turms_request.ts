...
export const TurmsRequest = {
  encode(message: TurmsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.updateUserSettingsRequest !== undefined) {
      UpdateUserSettingsRequest.encode(message.updateUserSettingsRequest, writer.uint32(850).fork()).ldelim();
    }
    if (message.deleteUserSettingsRequest !== undefined) {
      DeleteUserSettingsRequest.encode(message.deleteUserSettingsRequest, writer.uint32(858).fork()).ldelim();
    }
    if (message.queryUserSettingsRequest !== undefined) {
      QueryUserSettingsRequest.encode(message.queryUserSettingsRequest, writer.uint32(866).fork()).ldelim();
    }
    ...
    if (message.createMeetingRequest !== undefined) {
      CreateMeetingRequest.encode(message.createMeetingRequest, writer.uint32(7202).fork()).ldelim();
    }
    if (message.deleteMeetingRequest !== undefined) {
      DeleteMeetingRequest.encode(message.deleteMeetingRequest, writer.uint32(7210).fork()).ldelim();
    }
    if (message.queryMeetingsRequest !== undefined) {
      QueryMeetingsRequest.encode(message.queryMeetingsRequest, writer.uint32(7218).fork()).ldelim();
    }
    if (message.updateMeetingRequest !== undefined) {
      UpdateMeetingRequest.encode(message.updateMeetingRequest, writer.uint32(7226).fork()).ldelim();
    }
    if (message.updateMeetingInvitationRequest !== undefined) {
      UpdateMeetingInvitationRequest.encode(message.updateMeetingInvitationRequest, writer.uint32(7234).fork())
        .ldelim();
    }
    ...
    if (message.createMessageReactionsRequest !== undefined) {
      CreateMessageReactionsRequest.encode(message.createMessageReactionsRequest, writer.uint32(9602).fork()).ldelim();
    }
    if (message.deleteMessageReactionsRequest !== undefined) {
      DeleteMessageReactionsRequest.encode(message.deleteMessageReactionsRequest, writer.uint32(9610).fork()).ldelim();
    }
    return writer;
  },
