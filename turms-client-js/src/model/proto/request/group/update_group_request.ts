...
export const UpdateGroupRequest: MessageFns<UpdateGroupRequest> = {
  encode(message: UpdateGroupRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.userDefinedAttributes).forEach(([key, value]) => {
      UpdateGroupRequest_UserDefinedAttributesEntry.encode({ key: key as any, value }, writer.uint32(82).fork()).join();
    });
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.successorId = reader.int64().toString();
          continue;
        }
        case 10: {
          if (tag !== 82) {
...
export const UpdateGroupRequest_UserDefinedAttributesEntry: MessageFns<UpdateGroupRequest_UserDefinedAttributesEntry> =
  {
    encode(
      message: UpdateGroupRequest_UserDefinedAttributesEntry,
    ...
    decode(input: BinaryReader | Uint8Array, length?: number): UpdateGroupRequest_UserDefinedAttributesEntry {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
