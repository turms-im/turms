...
export const DeleteGroupBlockedUserRequest: MessageFns<DeleteGroupBlockedUserRequest> = {
  encode(message: DeleteGroupBlockedUserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteGroupBlockedUserRequest {
