...
export const QueryGroupBlockedUserInfosRequest: MessageFns<QueryGroupBlockedUserInfosRequest> = {
  encode(message: QueryGroupBlockedUserInfosRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGroupBlockedUserInfosRequest {
