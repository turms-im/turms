...
export const QueryJoinedGroupInfosRequest: MessageFns<QueryJoinedGroupInfosRequest> = {
  encode(message: QueryJoinedGroupInfosRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryJoinedGroupInfosRequest {
