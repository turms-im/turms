...
export const QueryGroupJoinQuestionsRequest: MessageFns<QueryGroupJoinQuestionsRequest> = {
  encode(message: QueryGroupJoinQuestionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGroupJoinQuestionsRequest {
