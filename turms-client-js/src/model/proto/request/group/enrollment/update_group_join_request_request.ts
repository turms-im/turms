...
export const UpdateGroupJoinRequestRequest: MessageFns<UpdateGroupJoinRequestRequest> = {
  encode(message: UpdateGroupJoinRequestRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateGroupJoinRequestRequest {
