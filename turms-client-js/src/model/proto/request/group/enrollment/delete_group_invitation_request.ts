...
export const DeleteGroupInvitationRequest: MessageFns<DeleteGroupInvitationRequest> = {
  encode(message: DeleteGroupInvitationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteGroupInvitationRequest {
