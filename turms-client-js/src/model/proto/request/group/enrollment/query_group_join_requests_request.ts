...
function createBaseQueryGroupJoinRequestsRequest(): QueryGroupJoinRequestsRequest {
  return { groupId: undefined, lastUpdatedDate: undefined, customAttributes: [] };
}

export const QueryGroupJoinRequestsRequest: MessageFns<QueryGroupJoinRequestsRequest> = {
  encode(message: QueryGroupJoinRequestsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGroupJoinRequestsRequest {
