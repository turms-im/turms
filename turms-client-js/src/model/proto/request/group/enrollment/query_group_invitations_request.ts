...
function createBaseQueryGroupInvitationsRequest(): QueryGroupInvitationsRequest {
  return { groupId: undefined, areSentByMe: undefined, lastUpdatedDate: undefined, customAttributes: [] };
}

export const QueryGroupInvitationsRequest: MessageFns<QueryGroupInvitationsRequest> = {
  encode(message: QueryGroupInvitationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryGroupInvitationsRequest {
