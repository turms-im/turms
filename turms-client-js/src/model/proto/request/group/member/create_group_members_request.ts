...
export const CreateGroupMembersRequest: MessageFns<CreateGroupMembersRequest> = {
  encode(message: CreateGroupMembersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateGroupMembersRequest {
