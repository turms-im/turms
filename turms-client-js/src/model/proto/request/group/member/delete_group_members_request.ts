...
export const DeleteGroupMembersRequest: MessageFns<DeleteGroupMembersRequest> = {
  encode(message: DeleteGroupMembersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteGroupMembersRequest {
