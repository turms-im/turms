...
function createBaseUpdateUserOnlineStatusRequest(): UpdateUserOnlineStatusRequest {
  return { deviceTypes: [], userStatus: 0, customAttributes: [] };
}

export const UpdateUserOnlineStatusRequest: MessageFns<UpdateUserOnlineStatusRequest> = {
  encode(message: UpdateUserOnlineStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateUserOnlineStatusRequest {
