...
export const DeleteRelationshipGroupRequest: MessageFns<DeleteRelationshipGroupRequest> = {
  encode(message: DeleteRelationshipGroupRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteRelationshipGroupRequest {
