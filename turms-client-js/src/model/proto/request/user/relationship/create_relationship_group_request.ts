...
export const CreateRelationshipGroupRequest: MessageFns<CreateRelationshipGroupRequest> = {
  encode(message: CreateRelationshipGroupRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateRelationshipGroupRequest {
