...
export const QueryFriendRequestsRequest: MessageFns<QueryFriendRequestsRequest> = {
  encode(message: QueryFriendRequestsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFriendRequestsRequest {
