...
export const QueryResourceDownloadInfoRequest: MessageFns<QueryResourceDownloadInfoRequest> = {
  encode(message: QueryResourceDownloadInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryResourceDownloadInfoRequest {
