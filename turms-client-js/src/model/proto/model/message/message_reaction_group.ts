...
export const MessageReactionGroup = {
  encode(message: MessageReactionGroup, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.userInfos) {
      UserInfo.encode(v!, writer.uint32(26).fork()).ldelim();
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MessageReactionGroup {
