...
export const Message: MessageFns<Message> = {
  encode(message: Message, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.reactionGroups) {
      MessageReactionGroup.encode(v!, writer.uint32(98).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.modificationDate = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 34) {
        ...
        case 5: {
          ...
          message.senderId = reader.int64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
        ...
        case 11: {
          ...
          message.preMessageId = reader.int64().toString();
          continue;
        }
        case 12: {
          if (tag !== 98) {
