...
export const UserOnlineStatus: MessageFns<UserOnlineStatus> = {
  encode(message: UserOnlineStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserOnlineStatus {
