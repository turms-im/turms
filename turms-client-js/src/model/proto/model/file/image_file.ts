...
export const ImageFile: MessageFns<ImageFile> = {
  encode(message: ImageFile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.description !== undefined) {
      ImageFile_Description.encode(message.description, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImageFile {
...
export const ImageFile_Description: MessageFns<ImageFile_Description> = {
  encode(message: ImageFile_Description, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImageFile_Description {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
