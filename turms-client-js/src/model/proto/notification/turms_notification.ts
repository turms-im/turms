...
export const TurmsNotification: MessageFns<TurmsNotification> = {
  encode(message: TurmsNotification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.data !== undefined) {
      TurmsNotification_Data.encode(message.data, writer.uint32(58).fork()).join();
    }
    ...
    if (message.relayedRequest !== undefined) {
      TurmsRequest.encode(message.relayedRequest, writer.uint32(98).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TurmsNotification {
...
export const TurmsNotification_Data: MessageFns<TurmsNotification_Data> = {
  encode(message: TurmsNotification_Data, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.longsWithVersion !== undefined) {
      LongsWithVersion.encode(message.longsWithVersion, writer.uint32(26).fork()).join();
    }
    if (message.stringsWithVersion !== undefined) {
      StringsWithVersion.encode(message.stringsWithVersion, writer.uint32(34).fork()).join();
    }
    if (message.conversations !== undefined) {
      Conversations.encode(message.conversations, writer.uint32(42).fork()).join();
    }
    if (message.messages !== undefined) {
      Messages.encode(message.messages, writer.uint32(50).fork()).join();
    }
    if (message.messagesWithTotalList !== undefined) {
      MessagesWithTotalList.encode(message.messagesWithTotalList, writer.uint32(58).fork()).join();
    }
    if (message.userSession !== undefined) {
      UserSession.encode(message.userSession, writer.uint32(66).fork()).join();
    }
    if (message.userInfosWithVersion !== undefined) {
      UserInfosWithVersion.encode(message.userInfosWithVersion, writer.uint32(74).fork()).join();
    }
    if (message.userOnlineStatuses !== undefined) {
      UserOnlineStatuses.encode(message.userOnlineStatuses, writer.uint32(82).fork()).join();
    }
    if (message.userFriendRequestsWithVersion !== undefined) {
      UserFriendRequestsWithVersion.encode(message.userFriendRequestsWithVersion, writer.uint32(90).fork()).join();
    }
    ...
    if (message.userRelationshipsWithVersion !== undefined) {
      UserRelationshipsWithVersion.encode(message.userRelationshipsWithVersion, writer.uint32(106).fork()).join();
    }
    if (message.nearbyUsers !== undefined) {
      NearbyUsers.encode(message.nearbyUsers, writer.uint32(114).fork()).join();
    }
    if (message.groupInvitationsWithVersion !== undefined) {
      GroupInvitationsWithVersion.encode(message.groupInvitationsWithVersion, writer.uint32(122).fork()).join();
    }
    if (message.groupJoinQuestionAnswerResult !== undefined) {
      GroupJoinQuestionsAnswerResult.encode(message.groupJoinQuestionAnswerResult, writer.uint32(130).fork()).join();
    }
    if (message.groupJoinRequestsWithVersion !== undefined) {
      GroupJoinRequestsWithVersion.encode(message.groupJoinRequestsWithVersion, writer.uint32(138).fork()).join();
    }
    if (message.groupJoinQuestionsWithVersion !== undefined) {
      GroupJoinQuestionsWithVersion.encode(message.groupJoinQuestionsWithVersion, writer.uint32(146).fork()).join();
    }
    if (message.groupMembersWithVersion !== undefined) {
      GroupMembersWithVersion.encode(message.groupMembersWithVersion, writer.uint32(154).fork()).join();
    }
    if (message.groupsWithVersion !== undefined) {
      GroupsWithVersion.encode(message.groupsWithVersion, writer.uint32(162).fork()).join();
    }
    if (message.meetings !== undefined) {
      Meetings.encode(message.meetings, writer.uint32(322).fork()).join();
    }
    if (message.storageResourceInfos !== undefined) {
      StorageResourceInfos.encode(message.storageResourceInfos, writer.uint32(402).fork()).join();
    }
    if (message.conversationSettingsList !== undefined) {
      ConversationSettingsList.encode(message.conversationSettingsList, writer.uint32(1602).fork()).join();
    }
    if (message.userSettings !== undefined) {
      UserSettings.encode(message.userSettings, writer.uint32(3202).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TurmsNotification_Data {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.long = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
