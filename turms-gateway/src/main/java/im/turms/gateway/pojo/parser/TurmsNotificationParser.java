...
public final class TurmsNotificationParser {
    ...
    public static SimpleTurmsNotification parseSimpleNotification(ByteBuffer turmsNotificationBuffer) {
        ...
        try {
            ...
            if (requesterId == Long.MIN_VALUE) {
                throw TurmsBusinessException.get(TurmsStatusCode.ILLEGAL_ARGUMENT, "Not a valid TurmsNotification: No requester ID");
            }
            ...
            throw TurmsBusinessException.get(TurmsStatusCode.ILLEGAL_ARGUMENT, "Not a valid TurmsNotification: " + e.getMessage());
        }
    }
