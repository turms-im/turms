...
public enum PolicyStatementResource {
    ...
    USER(Collections.emptySet(),
            ...
            Set.of(UPDATE_USER_REQUEST),
            Collections.emptySet()),
    USER_LOCATION(Collections.emptySet(),
            Collections.emptySet(),
            Set.of(UPDATE_USER_LOCATION_REQUEST),
            Collections.emptySet()),
    USER_ONLINE_STATUS(Collections.emptySet(),
            Collections.emptySet(),
            Set.of(UPDATE_USER_ONLINE_STATUS_REQUEST),
            Set.of(QUERY_USER_ONLINE_STATUSES_REQUEST)),
    ...
    //endregion
    //region relationship
    RELATIONSHIP(Set.of(CREATE_RELATIONSHIP_REQUEST),
            Set.of(DELETE_RELATIONSHIP_REQUEST),
            Set.of(UPDATE_RELATIONSHIP_REQUEST),
            Set.of(QUERY_RELATIONSHIPS_REQUEST,
                    QUERY_RELATED_USER_IDS_REQUEST)),
    RELATIONSHIP_GROUP(Set.of(CREATE_RELATIONSHIP_GROUP_REQUEST),
            Set.of(DELETE_RELATIONSHIP_GROUP_REQUEST),
            Set.of(UPDATE_RELATIONSHIP_GROUP_REQUEST),
            Set.of(QUERY_RELATIONSHIP_GROUPS_REQUEST)),
    FRIEND_REQUEST(Set.of(KindCase.CREATE_FRIEND_REQUEST_REQUEST),
            Collections.emptySet(),
            Set.of(UPDATE_FRIEND_REQUEST_REQUEST),
    ...
    GROUP_BLOCKED_USER(Set.of(CREATE_GROUP_BLOCKED_USER_REQUEST),
            ...
            Collections.emptySet(),
            Set.of(QUERY_GROUP_BLOCKED_USER_IDS_REQUEST,
    ...
    TYPING_STATUS(Collections.emptySet(),
            Collections.emptySet(),
            Set.of(UPDATE_TYPING_STATUS_REQUEST),
            Collections.emptySet()),
    //endregion
    //region storage
