...
enum ProfileAccessStrategy : int {
  ...
  FRIENDS = 2,
  ProfileAccessStrategy_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::int32_t>::min(),
  ProfileAccessStrategy_INT_MAX_SENTINEL_DO_NOT_USE_ =
...
const std::string& ProfileAccessStrategy_Name(T value) {
  static_assert(std::is_same<T, ProfileAccessStrategy>::value ||
