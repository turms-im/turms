...
#ifndef constant_2frequest_5fstatus_2eproto_2epb_2eh
#define constant_2frequest_5fstatus_2eproto_2epb_2eh
...
const std::string& RequestStatus_Name(T value) {
    static_assert(std::is_same<T, RequestStatus>::value || std::is_integral<T>::value,
...
#endif  // constant_2frequest_5fstatus_2eproto_2epb_2eh