...
#ifndef GOOGLE_PROTOBUF_INCLUDED_constant_2fdevice_5ftype_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_constant_2fdevice_5ftype_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_constant_2fdevice_5ftype_2eproto
...
struct TableStruct_constant_2fdevice_5ftype_2eproto {
...
const std::string& DeviceType_Name(T value) {
    static_assert(std::is_same<T, DeviceType>::value || std::is_integral<T>::value,
...
template <>
struct is_proto_enum<::turms::client::model::proto::DeviceType> : std::true_type {};
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_constant_2fdevice_5ftype_2eproto_2epb_2eh
