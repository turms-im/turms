...
#ifndef request_2fuser_2fquery_5fnearby_5fusers_5frequest_2eproto_2epb_2eh
#define request_2fuser_2fquery_5fnearby_5fusers_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryNearbyUsersRequest) */ {
   public:
    ...
    ~QueryNearbyUsersRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryNearbyUsersRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryNearbyUsersRequest));
    }
#endif
    ...
    QueryNearbyUsersRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryNearbyUsersRequest& from) {
        QueryNearbyUsersRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fuser_2fquery_5fnearby_5fusers_5frequest_2eproto_2epb_2eh