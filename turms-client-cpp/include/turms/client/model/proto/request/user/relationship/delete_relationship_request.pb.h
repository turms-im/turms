...
#ifndef request_2fuser_2frelationship_2fdelete_5frelationship_5frequest_2eproto_2epb_2eh
#define request_2fuser_2frelationship_2fdelete_5frelationship_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.DeleteRelationshipRequest) */
{
   public:
    ...
    ~DeleteRelationshipRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(DeleteRelationshipRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(DeleteRelationshipRequest));
    }
#endif
    ...
    DeleteRelationshipRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const DeleteRelationshipRequest& from) {
        DeleteRelationshipRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fuser_2frelationship_2fdelete_5frelationship_5frequest_2eproto_2epb_2eh