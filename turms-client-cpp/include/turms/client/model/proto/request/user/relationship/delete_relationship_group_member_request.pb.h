...
struct TableStruct_request_2fuser_2frelationship_2fdelete_5frelationship_5fgroup_5fmember_5frequest_2eproto {
...
extern DeleteRelationshipGroupMemberRequestDefaultTypeInternal _DeleteRelationshipGroupMemberRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
class DeleteRelationshipGroupMemberRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.DeleteRelationshipGroupMemberRequest) */ {
 public:
  inline DeleteRelationshipGroupMemberRequest() : DeleteRelationshipGroupMemberRequest(nullptr) {}
  ~DeleteRelationshipGroupMemberRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DeleteRelationshipGroupMemberRequest(::google::protobuf::internal::ConstantInitialized);

  DeleteRelationshipGroupMemberRequest(const DeleteRelationshipGroupMemberRequest& from);
  DeleteRelationshipGroupMemberRequest(DeleteRelationshipGroupMemberRequest&& from) noexcept
    : DeleteRelationshipGroupMemberRequest() {
    *this = ::std::move(from);
  }

  inline DeleteRelationshipGroupMemberRequest& operator=(const DeleteRelationshipGroupMemberRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline DeleteRelationshipGroupMemberRequest& operator=(DeleteRelationshipGroupMemberRequest&& from) noexcept {
  ...
  friend void swap(DeleteRelationshipGroupMemberRequest& a, DeleteRelationshipGroupMemberRequest& b) {
    a.Swap(&b);
  }
  ...
  DeleteRelationshipGroupMemberRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DeleteRelationshipGroupMemberRequest>(arena);
  }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_request_2fuser_2frelationship_2fdelete_5frelationship_5fgroup_5fmember_5frequest_2eproto;
};
...
inline void DeleteRelationshipGroupMemberRequest::_internal_set_target_group_index(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_._has_bits_[0] |= 0x00000001u;
