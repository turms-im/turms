...
#ifndef request_2fuser_2frelationship_2fquery_5frelated_5fuser_5fids_5frequest_2eproto_2epb_2eh
#define request_2fuser_2frelationship_2fquery_5frelated_5fuser_5fids_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryRelatedUserIdsRequest) */
{
   public:
    ...
    ~QueryRelatedUserIdsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryRelatedUserIdsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryRelatedUserIdsRequest));
    }
#endif
    ...
    QueryRelatedUserIdsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryRelatedUserIdsRequest& from) {
        QueryRelatedUserIdsRequest::MergeImpl(*this, from);
    }
   ...
   public:
    ...
    enum : int {
        ...
        kUserIdsForCommonRelationshipsFieldNumber = 4,
...
// repeated int64 user_ids_for_common_relationships = 4;
inline int QueryRelatedUserIdsRequest::_internal_user_ids_for_common_relationships_size() const {
    return _internal_user_ids_for_common_relationships().size();
}
inline int QueryRelatedUserIdsRequest::user_ids_for_common_relationships_size() const {
    return _internal_user_ids_for_common_relationships_size();
}
inline void QueryRelatedUserIdsRequest::clear_user_ids_for_common_relationships() {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _impl_.user_ids_for_common_relationships_.Clear();
}
inline ::int64_t QueryRelatedUserIdsRequest::user_ids_for_common_relationships(int index) const {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryRelatedUserIdsRequest.user_ids_for_common_relationships)
    return _internal_user_ids_for_common_relationships().Get(index);
}
inline void QueryRelatedUserIdsRequest::set_user_ids_for_common_relationships(int index,
                                                                              ::int64_t value) {
    _internal_mutable_user_ids_for_common_relationships()->Set(index, value);
    // @@protoc_insertion_point(field_set:turms.client.model.proto.QueryRelatedUserIdsRequest.user_ids_for_common_relationships)
}
inline void QueryRelatedUserIdsRequest::add_user_ids_for_common_relationships(::int64_t value) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _internal_mutable_user_ids_for_common_relationships()->Add(value);
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryRelatedUserIdsRequest.user_ids_for_common_relationships)
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryRelatedUserIdsRequest::user_ids_for_common_relationships() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryRelatedUserIdsRequest.user_ids_for_common_relationships)
    return _internal_user_ids_for_common_relationships();
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryRelatedUserIdsRequest::mutable_user_ids_for_common_relationships()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryRelatedUserIdsRequest.user_ids_for_common_relationships)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_user_ids_for_common_relationships();
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryRelatedUserIdsRequest::_internal_user_ids_for_common_relationships() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.user_ids_for_common_relationships_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryRelatedUserIdsRequest::_internal_mutable_user_ids_for_common_relationships() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.user_ids_for_common_relationships_;
}
...
#endif  // request_2fuser_2frelationship_2fquery_5frelated_5fuser_5fids_5frequest_2eproto_2epb_2eh