...
extern QueryRelationshipGroupsRequestDefaultTypeInternal _QueryRelationshipGroupsRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
class QueryRelationshipGroupsRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryRelationshipGroupsRequest) */ {
 public:
  inline QueryRelationshipGroupsRequest() : QueryRelationshipGroupsRequest(nullptr) {}
  ~QueryRelationshipGroupsRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR QueryRelationshipGroupsRequest(::google::protobuf::internal::ConstantInitialized);

  QueryRelationshipGroupsRequest(const QueryRelationshipGroupsRequest& from);
  QueryRelationshipGroupsRequest(QueryRelationshipGroupsRequest&& from) noexcept
  ...
  inline QueryRelationshipGroupsRequest& operator=(QueryRelationshipGroupsRequest&& from) noexcept {
  ...
  QueryRelationshipGroupsRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<QueryRelationshipGroupsRequest>(arena);
  }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_request_2fuser_2frelationship_2fquery_5frelationship_5fgroups_5frequest_2eproto;
};
