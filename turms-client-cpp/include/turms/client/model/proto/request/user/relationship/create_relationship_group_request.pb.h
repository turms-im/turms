...
#ifndef request_2fuser_2frelationship_2fcreate_5frelationship_5fgroup_5frequest_2eproto_2epb_2eh
#define request_2fuser_2frelationship_2fcreate_5frelationship_5fgroup_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~CreateRelationshipGroupRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(CreateRelationshipGroupRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(CreateRelationshipGroupRequest));
    }
#endif
    ...
    CreateRelationshipGroupRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const CreateRelationshipGroupRequest& from) {
        CreateRelationshipGroupRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fuser_2frelationship_2fcreate_5frelationship_5fgroup_5frequest_2eproto_2epb_2eh