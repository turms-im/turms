...
#ifndef request_2fuser_2frelationship_2fquery_5frelationships_5frequest_2eproto_2epb_2eh
#define request_2fuser_2frelationship_2fquery_5frelationships_5frequest_2eproto_2epb_2eh
...
class QueryRelationshipsRequest final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryRelationshipsRequest) */
{
   public:
    inline QueryRelationshipsRequest()
        : QueryRelationshipsRequest(nullptr) {
    }
    ~QueryRelationshipsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryRelationshipsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryRelationshipsRequest));
    }
#endif

    template <typename = void>
    explicit PROTOBUF_CONSTEXPR QueryRelationshipsRequest(
        ::google::protobuf::internal::ConstantInitialized);

    inline QueryRelationshipsRequest(const QueryRelationshipsRequest& from)
        : QueryRelationshipsRequest(nullptr, from) {
    }
    inline QueryRelationshipsRequest(QueryRelationshipsRequest&& from) noexcept
        : QueryRelationshipsRequest(nullptr, std::move(from)) {
    }
    ...
    QueryRelationshipsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
        return ::google::protobuf::MessageLite::DefaultConstruct<QueryRelationshipsRequest>(arena);
    }
    void CopyFrom(const QueryRelationshipsRequest& from);
    void MergeFrom(const QueryRelationshipsRequest& from) {
        QueryRelationshipsRequest::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    QueryRelationshipsRequest(::google::protobuf::Arena* arena,
                              const QueryRelationshipsRequest& from);
    QueryRelationshipsRequest(::google::protobuf::Arena* arena,
                              QueryRelationshipsRequest&& from) noexcept
        : QueryRelationshipsRequest(arena) {
        *this = ::std::move(from);
    }
   ...
   public:
    ...
    enum : int {
        ...
        kUserIdsForCommonRelationshipsFieldNumber = 5,
   ...
   public:
    // repeated int64 user_ids_for_common_relationships = 5;
    int user_ids_for_common_relationships_size() const;

   private:
    int _internal_user_ids_for_common_relationships_size() const;

   public:
    void clear_user_ids_for_common_relationships();
    ::int64_t user_ids_for_common_relationships(int index) const;
    void set_user_ids_for_common_relationships(int index, ::int64_t value);
    void add_user_ids_for_common_relationships(::int64_t value);
    const ::google::protobuf::RepeatedField<::int64_t>& user_ids_for_common_relationships() const;
    ::google::protobuf::RepeatedField<::int64_t>* mutable_user_ids_for_common_relationships();

   private:
    const ::google::protobuf::RepeatedField<::int64_t>&
    _internal_user_ids_for_common_relationships() const;
    ::google::protobuf::RepeatedField<::int64_t>*
    _internal_mutable_user_ids_for_common_relationships();
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const QueryRelationshipsRequest& from_msg);
        ...
        ::google::protobuf::internal::CachedSize _group_indexes_cached_byte_size_;
        ::google::protobuf::RepeatedField<::int64_t> user_ids_for_common_relationships_;
        ::google::protobuf::internal::CachedSize
            _user_ids_for_common_relationships_cached_byte_size_;
        ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>
            custom_attributes_;
    ...
    friend struct ::
        TableStruct_request_2fuser_2frelationship_2fquery_5frelationships_5frequest_2eproto;
};
...
inline const ::google::protobuf::RepeatedField<::int64_t>& QueryRelationshipsRequest::user_ids()
...
QueryRelationshipsRequest::_internal_user_ids() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.user_ids_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryRelationshipsRequest::_internal_mutable_user_ids() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.user_ids_;
}
...
QueryRelationshipsRequest::group_indexes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
QueryRelationshipsRequest::mutable_group_indexes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::google::protobuf::RepeatedField<::int32_t>&
QueryRelationshipsRequest::_internal_group_indexes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.group_indexes_;
}
inline ::google::protobuf::RepeatedField<::int32_t>*
QueryRelationshipsRequest::_internal_mutable_group_indexes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.group_indexes_;
}
...
// repeated int64 user_ids_for_common_relationships = 5;
inline int QueryRelationshipsRequest::_internal_user_ids_for_common_relationships_size() const {
    return _internal_user_ids_for_common_relationships().size();
}
inline int QueryRelationshipsRequest::user_ids_for_common_relationships_size() const {
    return _internal_user_ids_for_common_relationships_size();
}
inline void QueryRelationshipsRequest::clear_user_ids_for_common_relationships() {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _impl_.user_ids_for_common_relationships_.Clear();
}
inline ::int64_t QueryRelationshipsRequest::user_ids_for_common_relationships(int index) const {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryRelationshipsRequest.user_ids_for_common_relationships)
    return _internal_user_ids_for_common_relationships().Get(index);
}
inline void QueryRelationshipsRequest::set_user_ids_for_common_relationships(int index,
                                                                             ::int64_t value) {
    _internal_mutable_user_ids_for_common_relationships()->Set(index, value);
    // @@protoc_insertion_point(field_set:turms.client.model.proto.QueryRelationshipsRequest.user_ids_for_common_relationships)
}
inline void QueryRelationshipsRequest::add_user_ids_for_common_relationships(::int64_t value) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _internal_mutable_user_ids_for_common_relationships()->Add(value);
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryRelationshipsRequest.user_ids_for_common_relationships)
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryRelationshipsRequest::user_ids_for_common_relationships() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryRelationshipsRequest.user_ids_for_common_relationships)
    return _internal_user_ids_for_common_relationships();
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryRelationshipsRequest::mutable_user_ids_for_common_relationships()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryRelationshipsRequest.user_ids_for_common_relationships)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_user_ids_for_common_relationships();
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryRelationshipsRequest::_internal_user_ids_for_common_relationships() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.user_ids_for_common_relationships_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryRelationshipsRequest::_internal_mutable_user_ids_for_common_relationships() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.user_ids_for_common_relationships_;
}

// repeated .turms.client.model.proto.Value custom_attributes = 15;
inline int QueryRelationshipsRequest::_internal_custom_attributes_size() const {
    return _internal_custom_attributes().size();
}
inline int QueryRelationshipsRequest::custom_attributes_size() const {
    return _internal_custom_attributes_size();
}
inline ::turms::client::model::proto::Value* QueryRelationshipsRequest::mutable_custom_attributes(
    int index) ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable:turms.client.model.proto.QueryRelationshipsRequest.custom_attributes)
...
QueryRelationshipsRequest::mutable_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryRelationshipsRequest.custom_attributes)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_custom_attributes();
}
inline const ::turms::client::model::proto::Value& QueryRelationshipsRequest::custom_attributes(
    int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryRelationshipsRequest.custom_attributes)
    return _internal_custom_attributes().Get(index);
}
inline ::turms::client::model::proto::Value* QueryRelationshipsRequest::add_custom_attributes()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::turms::client::model::proto::Value* _add = _internal_mutable_custom_attributes()->Add();
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryRelationshipsRequest.custom_attributes)
    return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryRelationshipsRequest::custom_attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryRelationshipsRequest.custom_attributes)
    return _internal_custom_attributes();
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryRelationshipsRequest::_internal_custom_attributes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.custom_attributes_;
}
inline ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>*
QueryRelationshipsRequest::_internal_mutable_custom_attributes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.custom_attributes_;
}
...
#endif  // request_2fuser_2frelationship_2fquery_5frelationships_5frequest_2eproto_2epb_2eh