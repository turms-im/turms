...
#ifndef request_2fconference_2fcreate_5fmeeting_5frequest_2eproto_2epb_2eh
#define request_2fconference_2fcreate_5fmeeting_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.CreateMeetingRequest) */ {
   public:
    ...
    void operator delete(CreateMeetingRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
    ...
    CreateMeetingRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const CreateMeetingRequest& from) {
        CreateMeetingRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fconference_2fcreate_5fmeeting_5frequest_2eproto_2epb_2eh