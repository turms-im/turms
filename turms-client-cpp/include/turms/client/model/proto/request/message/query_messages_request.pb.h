...
#ifndef request_2fmessage_2fquery_5fmessages_5frequest_2eproto_2epb_2eh
#define request_2fmessage_2fquery_5fmessages_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryMessagesRequest) */ {
   public:
    ...
    ~QueryMessagesRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryMessagesRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryMessagesRequest));
    }
#endif
    ...
    QueryMessagesRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryMessagesRequest& from) {
        QueryMessagesRequest::MergeImpl(*this, from);
    }
   ...
   private:
    ...
    struct Impl_ {
        ...
        ::google::protobuf::internal::CachedSize _from_ids_cached_byte_size_;
        ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>
            custom_attributes_;
...
#endif  // request_2fmessage_2fquery_5fmessages_5frequest_2eproto_2epb_2eh