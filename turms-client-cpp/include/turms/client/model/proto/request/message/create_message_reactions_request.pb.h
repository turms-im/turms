...
#ifndef request_2fmessage_2fcreate_5fmessage_5freactions_5frequest_2eproto_2epb_2eh
#define request_2fmessage_2fcreate_5fmessage_5freactions_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~CreateMessageReactionsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(CreateMessageReactionsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(CreateMessageReactionsRequest));
    }
#endif
    ...
    CreateMessageReactionsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const CreateMessageReactionsRequest& from) {
        CreateMessageReactionsRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fmessage_2fcreate_5fmessage_5freactions_5frequest_2eproto_2epb_2eh