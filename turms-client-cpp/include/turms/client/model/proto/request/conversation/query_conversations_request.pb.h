...
#ifndef GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fquery_5fconversations_5frequest_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fquery_5fconversations_5frequest_2eproto_2epb_2eh
...
class QueryConversationsRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryConversationsRequest) */ {
 public:
  inline QueryConversationsRequest() : QueryConversationsRequest(nullptr) {}
  ~QueryConversationsRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR QueryConversationsRequest(::google::protobuf::internal::ConstantInitialized);

  QueryConversationsRequest(const QueryConversationsRequest& from);
  QueryConversationsRequest(QueryConversationsRequest&& from) noexcept
  ...
  QueryConversationsRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<QueryConversationsRequest>(arena);
  }
  ...
  ::int64_t target_ids(int index) const;
  void set_target_ids(int index, ::int64_t value);
  void add_target_ids(::int64_t value);
  const ::google::protobuf::RepeatedField<::int64_t>& target_ids() const;
  ::google::protobuf::RepeatedField<::int64_t>* mutable_target_ids();

  private:
  const ::google::protobuf::RepeatedField<::int64_t>& _internal_target_ids() const;
  ::google::protobuf::RepeatedField<::int64_t>* _internal_mutable_target_ids();
 ...
 private:
  ...
  struct Impl_ {
    ::google::protobuf::RepeatedField<::int64_t> target_ids_;
...
// repeated int64 target_ids = 1;
inline int QueryConversationsRequest::_internal_target_ids_size() const {
  return _internal_target_ids().size();
}
inline int QueryConversationsRequest::target_ids_size() const {
  return _internal_target_ids_size();
}
inline void QueryConversationsRequest::clear_target_ids() {
  _internal_mutable_target_ids()->Clear();
}
inline ::int64_t QueryConversationsRequest::target_ids(int index) const {
  // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryConversationsRequest.target_ids)
  return _internal_target_ids().Get(index);
}
inline void QueryConversationsRequest::set_target_ids(int index, ::int64_t value) {
  _internal_mutable_target_ids()->Set(index, value);
  // @@protoc_insertion_point(field_set:turms.client.model.proto.QueryConversationsRequest.target_ids)
}
inline void QueryConversationsRequest::add_target_ids(::int64_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_target_ids()->Add(value);
  // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryConversationsRequest.target_ids)
}
inline const ::google::protobuf::RepeatedField<::int64_t>& QueryConversationsRequest::target_ids() const {
  // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryConversationsRequest.target_ids)
  return _internal_target_ids();
}
inline ::google::protobuf::RepeatedField<::int64_t>* QueryConversationsRequest::mutable_target_ids() {
  // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryConversationsRequest.target_ids)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_target_ids();
}

inline const ::google::protobuf::RepeatedField<::int64_t>& QueryConversationsRequest::_internal_target_ids() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.target_ids_;
}
inline ::google::protobuf::RepeatedField<::int64_t>* QueryConversationsRequest::_internal_mutable_target_ids() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.target_ids_;
}
...
inline const ::google::protobuf::RepeatedField<::int64_t>& QueryConversationsRequest::group_ids() const {
...
inline const ::google::protobuf::RepeatedField<::int64_t>& QueryConversationsRequest::_internal_group_ids() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.group_ids_;
}
inline ::google::protobuf::RepeatedField<::int64_t>* QueryConversationsRequest::_internal_mutable_group_ids() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.group_ids_;
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fquery_5fconversations_5frequest_2eproto_2epb_2eh
