...
inline const ::google::protobuf::RepeatedField<::int64_t>& QueryConversationsRequest::target_ids()
...
QueryConversationsRequest::_internal_target_ids() const {
    PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
    return _impl_.target_ids_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryConversationsRequest::_internal_mutable_target_ids() {
    PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
    return &_impl_.target_ids_;
}
