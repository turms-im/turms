...
#ifndef GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fupdate_5ftyping_5fstatus_5frequest_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fupdate_5ftyping_5fstatus_5frequest_2eproto_2epb_2eh
...
class UpdateTypingStatusRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.UpdateTypingStatusRequest) */ {
 public:
  inline UpdateTypingStatusRequest() : UpdateTypingStatusRequest(nullptr) {}
  ~UpdateTypingStatusRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR UpdateTypingStatusRequest(::google::protobuf::internal::ConstantInitialized);

  UpdateTypingStatusRequest(const UpdateTypingStatusRequest& from);
  UpdateTypingStatusRequest(UpdateTypingStatusRequest&& from) noexcept
  ...
  UpdateTypingStatusRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UpdateTypingStatusRequest>(arena);
  }
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_request_2fconversation_2fupdate_5ftyping_5fstatus_5frequest_2eproto_2epb_2eh
