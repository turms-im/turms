...
#ifndef request_2fstorage_2fquery_5fmessage_5fattachment_5finfos_5frequest_2eproto_2epb_2eh
#define request_2fstorage_2fquery_5fmessage_5fattachment_5finfos_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~QueryMessageAttachmentInfosRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryMessageAttachmentInfosRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryMessageAttachmentInfosRequest));
    }
#endif
    ...
    QueryMessageAttachmentInfosRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryMessageAttachmentInfosRequest& from) {
        QueryMessageAttachmentInfosRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fstorage_2fquery_5fmessage_5fattachment_5finfos_5frequest_2eproto_2epb_2eh