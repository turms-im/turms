...
#ifndef request_2fstorage_2fupdate_5fmessage_5fattachment_5finfo_5frequest_2eproto_2epb_2eh
#define request_2fstorage_2fupdate_5fmessage_5fattachment_5finfo_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~UpdateMessageAttachmentInfoRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(UpdateMessageAttachmentInfoRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(UpdateMessageAttachmentInfoRequest));
    }
#endif
    ...
    UpdateMessageAttachmentInfoRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const UpdateMessageAttachmentInfoRequest& from) {
        UpdateMessageAttachmentInfoRequest::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    static const ::google::protobuf::internal::ClassDataLite<60> _class_data_;
...
inline void UpdateMessageAttachmentInfoRequest::set_allocated_attachment_id_str(
    ...
    if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() &&
        _impl_.attachment_id_str_.IsDefault()) {
        _impl_.attachment_id_str_.Set("", GetArena());
    }
...
#endif  // request_2fstorage_2fupdate_5fmessage_5fattachment_5finfo_5frequest_2eproto_2epb_2eh