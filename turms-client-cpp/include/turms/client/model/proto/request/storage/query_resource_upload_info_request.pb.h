...
QueryResourceUploadInfoRequest::_internal_extra() const {
    PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
    return _impl_.extra_.GetMap();
}
inline const ::google::protobuf::Map<std::string, std::string>&
QueryResourceUploadInfoRequest::extra() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_map:turms.client.model.proto.QueryResourceUploadInfoRequest.extra)
    return _internal_extra();
}
inline ::google::protobuf::Map<std::string, std::string>*
QueryResourceUploadInfoRequest::_internal_mutable_extra() {
    PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
    return _impl_.extra_.MutableMap();
}
inline ::google::protobuf::Map<std::string, std::string>*
QueryResourceUploadInfoRequest::mutable_extra() ABSL_ATTRIBUTE_LIFETIME_BOUND {
