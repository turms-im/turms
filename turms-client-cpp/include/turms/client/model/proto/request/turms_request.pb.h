...
#ifndef request_2fturms_5frequest_2eproto_2epb_2eh
#define request_2fturms_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.TurmsRequest) */ {
   public:
    ...
    ~TurmsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(TurmsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(TurmsRequest));
    }
#endif
    ...
    TurmsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const TurmsRequest& from) {
        TurmsRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fturms_5frequest_2eproto_2epb_2eh