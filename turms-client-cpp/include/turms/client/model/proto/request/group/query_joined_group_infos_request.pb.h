...
#ifndef request_2fgroup_2fquery_5fjoined_5fgroup_5finfos_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fquery_5fjoined_5fgroup_5finfos_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~QueryJoinedGroupInfosRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryJoinedGroupInfosRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryJoinedGroupInfosRequest));
    }
#endif
    ...
    QueryJoinedGroupInfosRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryJoinedGroupInfosRequest& from) {
        QueryJoinedGroupInfosRequest::MergeImpl(*this, from);
    }
   ...
   public:
    ...
    // accessors -------------------------------------------------------
    enum : int {
        kUserIdsForCommonGroupsFieldNumber = 2,
        kCustomAttributesFieldNumber = 15,
        kLastUpdatedDateFieldNumber = 1,
    };
    // repeated int64 user_ids_for_common_groups = 2;
    int user_ids_for_common_groups_size() const;

   private:
    int _internal_user_ids_for_common_groups_size() const;

   public:
    void clear_user_ids_for_common_groups();
    ::int64_t user_ids_for_common_groups(int index) const;
    void set_user_ids_for_common_groups(int index, ::int64_t value);
    void add_user_ids_for_common_groups(::int64_t value);
    const ::google::protobuf::RepeatedField<::int64_t>& user_ids_for_common_groups() const;
    ::google::protobuf::RepeatedField<::int64_t>* mutable_user_ids_for_common_groups();

   private:
    const ::google::protobuf::RepeatedField<::int64_t>& _internal_user_ids_for_common_groups()
        const;
    ::google::protobuf::RepeatedField<::int64_t>* _internal_mutable_user_ids_for_common_groups();
   ...
   private:
    ...
    struct Impl_ {
        ...
        ::google::protobuf::RepeatedField<::int64_t> user_ids_for_common_groups_;
        ::google::protobuf::internal::CachedSize _user_ids_for_common_groups_cached_byte_size_;
        ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>
            custom_attributes_;
...
// repeated int64 user_ids_for_common_groups = 2;
inline int QueryJoinedGroupInfosRequest::_internal_user_ids_for_common_groups_size() const {
    return _internal_user_ids_for_common_groups().size();
}
inline int QueryJoinedGroupInfosRequest::user_ids_for_common_groups_size() const {
    return _internal_user_ids_for_common_groups_size();
}
inline void QueryJoinedGroupInfosRequest::clear_user_ids_for_common_groups() {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _impl_.user_ids_for_common_groups_.Clear();
}
inline ::int64_t QueryJoinedGroupInfosRequest::user_ids_for_common_groups(int index) const {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryJoinedGroupInfosRequest.user_ids_for_common_groups)
    return _internal_user_ids_for_common_groups().Get(index);
}
inline void QueryJoinedGroupInfosRequest::set_user_ids_for_common_groups(int index,
                                                                         ::int64_t value) {
    _internal_mutable_user_ids_for_common_groups()->Set(index, value);
    // @@protoc_insertion_point(field_set:turms.client.model.proto.QueryJoinedGroupInfosRequest.user_ids_for_common_groups)
}
inline void QueryJoinedGroupInfosRequest::add_user_ids_for_common_groups(::int64_t value) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _internal_mutable_user_ids_for_common_groups()->Add(value);
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryJoinedGroupInfosRequest.user_ids_for_common_groups)
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryJoinedGroupInfosRequest::user_ids_for_common_groups() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryJoinedGroupInfosRequest.user_ids_for_common_groups)
    return _internal_user_ids_for_common_groups();
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryJoinedGroupInfosRequest::mutable_user_ids_for_common_groups() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryJoinedGroupInfosRequest.user_ids_for_common_groups)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_user_ids_for_common_groups();
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryJoinedGroupInfosRequest::_internal_user_ids_for_common_groups() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.user_ids_for_common_groups_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryJoinedGroupInfosRequest::_internal_mutable_user_ids_for_common_groups() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.user_ids_for_common_groups_;
}
...
#endif  // request_2fgroup_2fquery_5fjoined_5fgroup_5finfos_5frequest_2eproto_2epb_2eh