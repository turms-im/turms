...
struct TableStruct_request_2fgroup_2fenrollment_2fdelete_5fgroup_5fjoin_5frequest_5frequest_2eproto {
...
extern DeleteGroupJoinRequestRequestDefaultTypeInternal _DeleteGroupJoinRequestRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
class DeleteGroupJoinRequestRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.DeleteGroupJoinRequestRequest) */ {
 public:
  inline DeleteGroupJoinRequestRequest() : DeleteGroupJoinRequestRequest(nullptr) {}
  ~DeleteGroupJoinRequestRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DeleteGroupJoinRequestRequest(::google::protobuf::internal::ConstantInitialized);

  DeleteGroupJoinRequestRequest(const DeleteGroupJoinRequestRequest& from);
  DeleteGroupJoinRequestRequest(DeleteGroupJoinRequestRequest&& from) noexcept
  ...
  DeleteGroupJoinRequestRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DeleteGroupJoinRequestRequest>(arena);
  }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_request_2fgroup_2fenrollment_2fdelete_5fgroup_5fjoin_5frequest_5frequest_2eproto;
};
