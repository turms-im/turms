...
#ifndef request_2fgroup_2fenrollment_2fquery_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fenrollment_2fquery_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~QueryGroupJoinQuestionsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryGroupJoinQuestionsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryGroupJoinQuestionsRequest));
    }
#endif
    ...
    QueryGroupJoinQuestionsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryGroupJoinQuestionsRequest& from) {
        QueryGroupJoinQuestionsRequest::MergeImpl(*this, from);
    }
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const QueryGroupJoinQuestionsRequest& from_msg);
...
// repeated .turms.client.model.proto.Value custom_attributes = 15;
inline int QueryGroupJoinQuestionsRequest::_internal_custom_attributes_size() const {
    return _internal_custom_attributes().size();
}
inline int QueryGroupJoinQuestionsRequest::custom_attributes_size() const {
    return _internal_custom_attributes_size();
}
inline ::turms::client::model::proto::Value*
QueryGroupJoinQuestionsRequest::mutable_custom_attributes(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable:turms.client.model.proto.QueryGroupJoinQuestionsRequest.custom_attributes)
...
QueryGroupJoinQuestionsRequest::mutable_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryGroupJoinQuestionsRequest.custom_attributes)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_custom_attributes();
}
inline const ::turms::client::model::proto::Value&
QueryGroupJoinQuestionsRequest::custom_attributes(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryGroupJoinQuestionsRequest.custom_attributes)
    return _internal_custom_attributes().Get(index);
}
inline ::turms::client::model::proto::Value* QueryGroupJoinQuestionsRequest::add_custom_attributes()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::turms::client::model::proto::Value* _add = _internal_mutable_custom_attributes()->Add();
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryGroupJoinQuestionsRequest.custom_attributes)
    return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryGroupJoinQuestionsRequest::custom_attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryGroupJoinQuestionsRequest.custom_attributes)
    return _internal_custom_attributes();
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryGroupJoinQuestionsRequest::_internal_custom_attributes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.custom_attributes_;
}
inline ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>*
QueryGroupJoinQuestionsRequest::_internal_mutable_custom_attributes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.custom_attributes_;
}
...
#endif  // request_2fgroup_2fenrollment_2fquery_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh