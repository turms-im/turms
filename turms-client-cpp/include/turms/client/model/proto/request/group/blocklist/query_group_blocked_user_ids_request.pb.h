...
struct TableStruct_request_2fgroup_2fblocklist_2fquery_5fgroup_5fblocked_5fuser_5fids_5frequest_2eproto {
...
extern QueryGroupBlockedUserIdsRequestDefaultTypeInternal _QueryGroupBlockedUserIdsRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
class QueryGroupBlockedUserIdsRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryGroupBlockedUserIdsRequest) */ {
 public:
  inline QueryGroupBlockedUserIdsRequest() : QueryGroupBlockedUserIdsRequest(nullptr) {}
  ~QueryGroupBlockedUserIdsRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR QueryGroupBlockedUserIdsRequest(::google::protobuf::internal::ConstantInitialized);

  QueryGroupBlockedUserIdsRequest(const QueryGroupBlockedUserIdsRequest& from);
  QueryGroupBlockedUserIdsRequest(QueryGroupBlockedUserIdsRequest&& from) noexcept
  ...
  inline QueryGroupBlockedUserIdsRequest& operator=(QueryGroupBlockedUserIdsRequest&& from) noexcept {
  ...
  QueryGroupBlockedUserIdsRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<QueryGroupBlockedUserIdsRequest>(arena);
  }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_request_2fgroup_2fblocklist_2fquery_5fgroup_5fblocked_5fuser_5fids_5frequest_2eproto;
};
