...
#ifndef request_2fgroup_2fenrollment_2fcreate_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fenrollment_2fcreate_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh
...
struct
    TableStruct_request_2fgroup_2fenrollment_2fcreate_5fgroup_5fjoin_5fquestions_5frequest_2eproto {
...
extern CreateGroupJoinQuestionsRequestDefaultTypeInternal
...
class CreateGroupJoinQuestionsRequest final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.CreateGroupJoinQuestionsRequest)
 */
{
   public:
    inline CreateGroupJoinQuestionsRequest()
        : CreateGroupJoinQuestionsRequest(nullptr) {
    }
    ~CreateGroupJoinQuestionsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(CreateGroupJoinQuestionsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(CreateGroupJoinQuestionsRequest));
    }
#endif

    template <typename = void>
    explicit PROTOBUF_CONSTEXPR CreateGroupJoinQuestionsRequest(
        ::google::protobuf::internal::ConstantInitialized);

    inline CreateGroupJoinQuestionsRequest(const CreateGroupJoinQuestionsRequest& from)
        : CreateGroupJoinQuestionsRequest(nullptr, from) {
    }
    inline CreateGroupJoinQuestionsRequest(CreateGroupJoinQuestionsRequest&& from) noexcept
        : CreateGroupJoinQuestionsRequest(nullptr, std::move(from)) {
    }
    inline CreateGroupJoinQuestionsRequest& operator=(const CreateGroupJoinQuestionsRequest& from) {
        CopyFrom(from);
        return *this;
    }
    inline CreateGroupJoinQuestionsRequest& operator=(
        CreateGroupJoinQuestionsRequest&& from) noexcept {
        if (this == &from)
            return *this;
    ...
    CreateGroupJoinQuestionsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
        return ::google::protobuf::MessageLite::DefaultConstruct<CreateGroupJoinQuestionsRequest>(
            arena);
    }
    void CopyFrom(const CreateGroupJoinQuestionsRequest& from);
    void MergeFrom(const CreateGroupJoinQuestionsRequest& from) {
        CreateGroupJoinQuestionsRequest::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    CreateGroupJoinQuestionsRequest(::google::protobuf::Arena* arena,
                                    const CreateGroupJoinQuestionsRequest& from);
    CreateGroupJoinQuestionsRequest(::google::protobuf::Arena* arena,
                                    CreateGroupJoinQuestionsRequest&& from) noexcept
        : CreateGroupJoinQuestionsRequest(arena) {
        *this = ::std::move(from);
    }
   ...
   private:
    ...
    _internal_questions() const;
    ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::GroupJoinQuestion>*
    _internal_mutable_questions();
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const CreateGroupJoinQuestionsRequest& from_msg);
        ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::GroupJoinQuestion>
            questions_;
        ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>
            custom_attributes_;
...
CreateGroupJoinQuestionsRequest::mutable_questions(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
CreateGroupJoinQuestionsRequest::mutable_questions() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
CreateGroupJoinQuestionsRequest::questions(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::turms::client::model::proto::GroupJoinQuestion*
CreateGroupJoinQuestionsRequest::add_questions() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
CreateGroupJoinQuestionsRequest::questions() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
// repeated .turms.client.model.proto.Value custom_attributes = 15;
inline int CreateGroupJoinQuestionsRequest::_internal_custom_attributes_size() const {
    return _internal_custom_attributes().size();
}
inline int CreateGroupJoinQuestionsRequest::custom_attributes_size() const {
    return _internal_custom_attributes_size();
}
inline ::turms::client::model::proto::Value*
CreateGroupJoinQuestionsRequest::mutable_custom_attributes(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable:turms.client.model.proto.CreateGroupJoinQuestionsRequest.custom_attributes)
...
CreateGroupJoinQuestionsRequest::mutable_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.CreateGroupJoinQuestionsRequest.custom_attributes)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_custom_attributes();
}
inline const ::turms::client::model::proto::Value&
CreateGroupJoinQuestionsRequest::custom_attributes(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.CreateGroupJoinQuestionsRequest.custom_attributes)
    return _internal_custom_attributes().Get(index);
}
inline ::turms::client::model::proto::Value*
CreateGroupJoinQuestionsRequest::add_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::turms::client::model::proto::Value* _add = _internal_mutable_custom_attributes()->Add();
    // @@protoc_insertion_point(field_add:turms.client.model.proto.CreateGroupJoinQuestionsRequest.custom_attributes)
    return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
CreateGroupJoinQuestionsRequest::custom_attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.CreateGroupJoinQuestionsRequest.custom_attributes)
    return _internal_custom_attributes();
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
CreateGroupJoinQuestionsRequest::_internal_custom_attributes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.custom_attributes_;
}
inline ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>*
CreateGroupJoinQuestionsRequest::_internal_mutable_custom_attributes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.custom_attributes_;
}
...
#endif  // request_2fgroup_2fenrollment_2fcreate_5fgroup_5fjoin_5fquestions_5frequest_2eproto_2epb_2eh