...
class QueryJoinedGroupIdsRequest final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryJoinedGroupIdsRequest) */ {
 public:
  inline QueryJoinedGroupIdsRequest() : QueryJoinedGroupIdsRequest(nullptr) {}
  ~QueryJoinedGroupIdsRequest() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR QueryJoinedGroupIdsRequest(::google::protobuf::internal::ConstantInitialized);

  QueryJoinedGroupIdsRequest(const QueryJoinedGroupIdsRequest& from);
  QueryJoinedGroupIdsRequest(QueryJoinedGroupIdsRequest&& from) noexcept
  ...
  QueryJoinedGroupIdsRequest* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<QueryJoinedGroupIdsRequest>(arena);
  }
