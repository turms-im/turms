...
#ifndef request_2fgroup_2fquery_5fjoined_5fgroup_5fids_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fquery_5fjoined_5fgroup_5fids_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.QueryJoinedGroupIdsRequest) */
{
   public:
    ...
    ~QueryJoinedGroupIdsRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryJoinedGroupIdsRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryJoinedGroupIdsRequest));
    }
#endif
    ...
    QueryJoinedGroupIdsRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryJoinedGroupIdsRequest& from) {
        QueryJoinedGroupIdsRequest::MergeImpl(*this, from);
    }
...
// repeated int64 user_ids_for_common_groups = 2;
inline int QueryJoinedGroupIdsRequest::_internal_user_ids_for_common_groups_size() const {
    return _internal_user_ids_for_common_groups().size();
}
inline int QueryJoinedGroupIdsRequest::user_ids_for_common_groups_size() const {
    return _internal_user_ids_for_common_groups_size();
}
inline void QueryJoinedGroupIdsRequest::clear_user_ids_for_common_groups() {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _impl_.user_ids_for_common_groups_.Clear();
}
inline ::int64_t QueryJoinedGroupIdsRequest::user_ids_for_common_groups(int index) const {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryJoinedGroupIdsRequest.user_ids_for_common_groups)
    return _internal_user_ids_for_common_groups().Get(index);
}
inline void QueryJoinedGroupIdsRequest::set_user_ids_for_common_groups(int index, ::int64_t value) {
    _internal_mutable_user_ids_for_common_groups()->Set(index, value);
    // @@protoc_insertion_point(field_set:turms.client.model.proto.QueryJoinedGroupIdsRequest.user_ids_for_common_groups)
}
inline void QueryJoinedGroupIdsRequest::add_user_ids_for_common_groups(::int64_t value) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    _internal_mutable_user_ids_for_common_groups()->Add(value);
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryJoinedGroupIdsRequest.user_ids_for_common_groups)
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryJoinedGroupIdsRequest::user_ids_for_common_groups() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryJoinedGroupIdsRequest.user_ids_for_common_groups)
    return _internal_user_ids_for_common_groups();
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryJoinedGroupIdsRequest::mutable_user_ids_for_common_groups() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryJoinedGroupIdsRequest.user_ids_for_common_groups)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_user_ids_for_common_groups();
}
inline const ::google::protobuf::RepeatedField<::int64_t>&
QueryJoinedGroupIdsRequest::_internal_user_ids_for_common_groups() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.user_ids_for_common_groups_;
}
inline ::google::protobuf::RepeatedField<::int64_t>*
QueryJoinedGroupIdsRequest::_internal_mutable_user_ids_for_common_groups() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.user_ids_for_common_groups_;
}
...
#endif  // request_2fgroup_2fquery_5fjoined_5fgroup_5fids_5frequest_2eproto_2epb_2eh