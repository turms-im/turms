...
#ifndef request_2fgroup_2fblocklist_2fquery_5fgroup_5fblocked_5fuser_5finfos_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fblocklist_2fquery_5fgroup_5fblocked_5fuser_5finfos_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~QueryGroupBlockedUserInfosRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(QueryGroupBlockedUserInfosRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(QueryGroupBlockedUserInfosRequest));
    }
#endif
    ...
    QueryGroupBlockedUserInfosRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const QueryGroupBlockedUserInfosRequest& from) {
        QueryGroupBlockedUserInfosRequest::MergeImpl(*this, from);
    }
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const QueryGroupBlockedUserInfosRequest& from_msg);
...
// repeated .turms.client.model.proto.Value custom_attributes = 15;
inline int QueryGroupBlockedUserInfosRequest::_internal_custom_attributes_size() const {
    return _internal_custom_attributes().size();
}
inline int QueryGroupBlockedUserInfosRequest::custom_attributes_size() const {
    return _internal_custom_attributes_size();
}
inline ::turms::client::model::proto::Value*
QueryGroupBlockedUserInfosRequest::mutable_custom_attributes(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable:turms.client.model.proto.QueryGroupBlockedUserInfosRequest.custom_attributes)
...
QueryGroupBlockedUserInfosRequest::mutable_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.QueryGroupBlockedUserInfosRequest.custom_attributes)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_custom_attributes();
}
inline const ::turms::client::model::proto::Value&
QueryGroupBlockedUserInfosRequest::custom_attributes(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.QueryGroupBlockedUserInfosRequest.custom_attributes)
    return _internal_custom_attributes().Get(index);
}
inline ::turms::client::model::proto::Value*
QueryGroupBlockedUserInfosRequest::add_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::turms::client::model::proto::Value* _add = _internal_mutable_custom_attributes()->Add();
    // @@protoc_insertion_point(field_add:turms.client.model.proto.QueryGroupBlockedUserInfosRequest.custom_attributes)
    return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryGroupBlockedUserInfosRequest::custom_attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.QueryGroupBlockedUserInfosRequest.custom_attributes)
    return _internal_custom_attributes();
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
QueryGroupBlockedUserInfosRequest::_internal_custom_attributes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.custom_attributes_;
}
inline ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>*
QueryGroupBlockedUserInfosRequest::_internal_mutable_custom_attributes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.custom_attributes_;
}
...
#endif  // request_2fgroup_2fblocklist_2fquery_5fgroup_5fblocked_5fuser_5finfos_5frequest_2eproto_2epb_2eh