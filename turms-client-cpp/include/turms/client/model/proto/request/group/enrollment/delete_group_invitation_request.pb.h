...
#ifndef request_2fgroup_2fenrollment_2fdelete_5fgroup_5finvitation_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fenrollment_2fdelete_5fgroup_5finvitation_5frequest_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~DeleteGroupInvitationRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(DeleteGroupInvitationRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(DeleteGroupInvitationRequest));
    }
#endif
    ...
    DeleteGroupInvitationRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const DeleteGroupInvitationRequest& from) {
        DeleteGroupInvitationRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fgroup_2fenrollment_2fdelete_5fgroup_5finvitation_5frequest_2eproto_2epb_2eh