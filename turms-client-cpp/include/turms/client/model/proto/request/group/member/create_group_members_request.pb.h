...
#ifndef request_2fgroup_2fmember_2fcreate_5fgroup_5fmembers_5frequest_2eproto_2epb_2eh
#define request_2fgroup_2fmember_2fcreate_5fgroup_5fmembers_5frequest_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.CreateGroupMembersRequest) */
{
   public:
    ...
    ~CreateGroupMembersRequest() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(CreateGroupMembersRequest* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(CreateGroupMembersRequest));
    }
#endif
    ...
    CreateGroupMembersRequest* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const CreateGroupMembersRequest& from) {
        CreateGroupMembersRequest::MergeImpl(*this, from);
    }
...
#endif  // request_2fgroup_2fmember_2fcreate_5fgroup_5fmembers_5frequest_2eproto_2epb_2eh