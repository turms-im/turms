...
#ifndef model_2ffile_2faudio_5ffile_2eproto_2epb_2eh
#define model_2ffile_2faudio_5ffile_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.AudioFile.Description) */ {
   public:
    ...
    ~AudioFile_Description() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(AudioFile_Description* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(AudioFile_Description));
    }
#endif
    ...
    AudioFile_Description* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const AudioFile_Description& from) {
        AudioFile_Description::MergeImpl(*this, from);
    }
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.AudioFile) */ {
   public:
    ...
    ~AudioFile() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(AudioFile* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(AudioFile));
    }
#endif
    ...
    AudioFile* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // model_2ffile_2faudio_5ffile_2eproto_2epb_2eh