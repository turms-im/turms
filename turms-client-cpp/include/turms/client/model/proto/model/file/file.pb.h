...
#ifndef model_2ffile_2ffile_2eproto_2epb_2eh
#define model_2ffile_2ffile_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.File.Description) */ {
   public:
    ...
    ~File_Description() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(File_Description* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(File_Description));
    }
#endif
    ...
    File_Description* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const File_Description& from) {
        File_Description::MergeImpl(*this, from);
    }
...
#endif  // model_2ffile_2ffile_2eproto_2epb_2eh