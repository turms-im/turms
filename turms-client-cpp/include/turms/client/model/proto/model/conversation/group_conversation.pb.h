...
#ifndef model_2fconversation_2fgroup_5fconversation_2eproto_2epb_2eh
#define model_2fconversation_2fgroup_5fconversation_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupConversation) */ {
   public:
    ...
    ~GroupConversation() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupConversation* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupConversation));
    }
#endif
    ...
    GroupConversation* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupConversation& from) {
        GroupConversation::MergeImpl(*this, from);
    }
...
#endif  // model_2fconversation_2fgroup_5fconversation_2eproto_2epb_2eh