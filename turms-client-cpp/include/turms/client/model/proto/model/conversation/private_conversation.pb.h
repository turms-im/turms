...
#ifndef model_2fconversation_2fprivate_5fconversation_2eproto_2epb_2eh
#define model_2fconversation_2fprivate_5fconversation_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.PrivateConversation) */ {
   public:
    ...
    ~PrivateConversation() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(PrivateConversation* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(PrivateConversation));
    }
#endif
    ...
    PrivateConversation* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const PrivateConversation& from) {
        PrivateConversation::MergeImpl(*this, from);
    }
...
#endif  // model_2fconversation_2fprivate_5fconversation_2eproto_2epb_2eh