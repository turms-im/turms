...
#ifndef model_2fgroup_2fgroup_5finvitation_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5finvitation_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupInvitation) */ {
   public:
    ...
    ~GroupInvitation() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupInvitation* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupInvitation));
    }
#endif
    ...
    GroupInvitation* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupInvitation& from) {
        GroupInvitation::MergeImpl(*this, from);
    }
...
#endif  // model_2fgroup_2fgroup_5finvitation_2eproto_2epb_2eh