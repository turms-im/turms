...
#ifndef model_2fgroup_2fgroup_5fjoin_5fquestions_5fanswer_5fresult_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5fjoin_5fquestions_5fanswer_5fresult_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~GroupJoinQuestionsAnswerResult() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupJoinQuestionsAnswerResult* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupJoinQuestionsAnswerResult));
    }
#endif
    ...
    GroupJoinQuestionsAnswerResult* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupJoinQuestionsAnswerResult& from) {
        GroupJoinQuestionsAnswerResult::MergeImpl(*this, from);
    }
...
#endif  // model_2fgroup_2fgroup_5fjoin_5fquestions_5fanswer_5fresult_2eproto_2epb_2eh