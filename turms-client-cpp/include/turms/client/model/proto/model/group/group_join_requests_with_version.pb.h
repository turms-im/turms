...
#ifndef model_2fgroup_2fgroup_5fjoin_5frequests_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5fjoin_5frequests_5fwith_5fversion_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~GroupJoinRequestsWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupJoinRequestsWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupJoinRequestsWithVersion));
    }
#endif
    ...
    GroupJoinRequestsWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupJoinRequestsWithVersion& from) {
        GroupJoinRequestsWithVersion::MergeImpl(*this, from);
    }
...
#endif  // model_2fgroup_2fgroup_5fjoin_5frequests_5fwith_5fversion_2eproto_2epb_2eh