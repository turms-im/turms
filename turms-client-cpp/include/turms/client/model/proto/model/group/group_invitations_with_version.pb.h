...
#ifndef model_2fgroup_2fgroup_5finvitations_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5finvitations_5fwith_5fversion_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~GroupInvitationsWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupInvitationsWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupInvitationsWithVersion));
    }
#endif
    ...
    GroupInvitationsWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupInvitationsWithVersion& from) {
        GroupInvitationsWithVersion::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    static const ::google::protobuf::internal::ClassDataLite<53> _class_data_;
...
#endif  // model_2fgroup_2fgroup_5finvitations_5fwith_5fversion_2eproto_2epb_2eh