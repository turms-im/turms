...
#ifndef model_2fgroup_2fgroups_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fgroup_2fgroups_5fwith_5fversion_2eproto_2epb_2eh
...
class GroupsWithVersion final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupsWithVersion) */ {
   public:
    inline GroupsWithVersion()
        : GroupsWithVersion(nullptr) {
    }
    ~GroupsWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupsWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupsWithVersion));
    }
#endif

    template <typename = void>
    explicit PROTOBUF_CONSTEXPR GroupsWithVersion(
        ::google::protobuf::internal::ConstantInitialized);

    inline GroupsWithVersion(const GroupsWithVersion& from)
        : GroupsWithVersion(nullptr, from) {
    }
    inline GroupsWithVersion(GroupsWithVersion&& from) noexcept
        : GroupsWithVersion(nullptr, std::move(from)) {
    }
    ...
    static inline const GroupsWithVersion* internal_default_instance() {
        return reinterpret_cast<const GroupsWithVersion*>(&_GroupsWithVersion_default_instance_);
    }
    ...
    GroupsWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
        return ::google::protobuf::MessageLite::DefaultConstruct<GroupsWithVersion>(arena);
    }
    void CopyFrom(const GroupsWithVersion& from);
    void MergeFrom(const GroupsWithVersion& from) {
        GroupsWithVersion::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    GroupsWithVersion(::google::protobuf::Arena* arena, const GroupsWithVersion& from);
    GroupsWithVersion(::google::protobuf::Arena* arena, GroupsWithVersion&& from) noexcept
        : GroupsWithVersion(arena) {
        *this = ::std::move(from);
    }
   ...
   public:
    ...
    ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Group>* mutable_groups();
   ...
   public:
    ...
    const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Group>& groups()
        const;
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const GroupsWithVersion& from_msg);
...
GroupsWithVersion::mutable_groups() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
GroupsWithVersion::groups() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
#endif  // model_2fgroup_2fgroups_5fwith_5fversion_2eproto_2epb_2eh