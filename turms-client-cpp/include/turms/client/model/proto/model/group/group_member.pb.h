...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupMember) */ {
   ...
   private:
    ...
    static const ::google::protobuf::internal::TcParseTable<4, 9, 1, 57, 2> _table_;

    static constexpr const void* _raw_default_instance_ = &_GroupMember_default_instance_;
