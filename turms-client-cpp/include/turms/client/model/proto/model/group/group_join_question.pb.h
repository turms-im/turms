...
#ifndef model_2fgroup_2fgroup_5fjoin_5fquestion_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5fjoin_5fquestion_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupJoinQuestion) */ {
   public:
    ...
    ~GroupJoinQuestion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupJoinQuestion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupJoinQuestion));
    }
#endif
    ...
    GroupJoinQuestion* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const GroupJoinQuestion& from) {
        GroupJoinQuestion::MergeImpl(*this, from);
    }
...
template <typename Arg_, typename... Args_>
inline void GroupJoinQuestion::set_answers(int index, Arg_&& value, Args_... args) {
...
template <typename Arg_, typename... Args_>
inline void GroupJoinQuestion::add_answers(Arg_&& value, Args_... args) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
#endif  // model_2fgroup_2fgroup_5fjoin_5fquestion_2eproto_2epb_2eh