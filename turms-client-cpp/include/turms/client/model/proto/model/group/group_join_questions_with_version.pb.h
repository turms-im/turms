...
extern GroupJoinQuestionsWithVersionDefaultTypeInternal _GroupJoinQuestionsWithVersion_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
class GroupJoinQuestionsWithVersion final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupJoinQuestionsWithVersion) */ {
 public:
  inline GroupJoinQuestionsWithVersion() : GroupJoinQuestionsWithVersion(nullptr) {}
  ~GroupJoinQuestionsWithVersion() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR GroupJoinQuestionsWithVersion(::google::protobuf::internal::ConstantInitialized);

  GroupJoinQuestionsWithVersion(const GroupJoinQuestionsWithVersion& from);
  GroupJoinQuestionsWithVersion(GroupJoinQuestionsWithVersion&& from) noexcept
  ...
  GroupJoinQuestionsWithVersion* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GroupJoinQuestionsWithVersion>(arena);
  }
  ...
  private:
  const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::GroupJoinQuestion>& _internal_group_join_questions() const;
  ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::GroupJoinQuestion>* _internal_mutable_group_join_questions();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::turms::client::model::proto::GroupJoinQuestion > group_join_questions_;
...
inline ::turms::client::model::proto::GroupJoinQuestion* GroupJoinQuestionsWithVersion::mutable_group_join_questions(int index) {
...
GroupJoinQuestionsWithVersion::mutable_group_join_questions() {
...
inline const ::turms::client::model::proto::GroupJoinQuestion& GroupJoinQuestionsWithVersion::group_join_questions(int index) const {
...
inline ::turms::client::model::proto::GroupJoinQuestion* GroupJoinQuestionsWithVersion::add_group_join_questions() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::turms::client::model::proto::GroupJoinQuestion* _add = _internal_mutable_group_join_questions()->Add();
...
GroupJoinQuestionsWithVersion::group_join_questions() const {
