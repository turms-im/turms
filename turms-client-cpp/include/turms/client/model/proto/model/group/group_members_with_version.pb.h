...
#ifndef model_2fgroup_2fgroup_5fmembers_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fgroup_2fgroup_5fmembers_5fwith_5fversion_2eproto_2epb_2eh
...
class GroupMembersWithVersion final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.GroupMembersWithVersion) */ {
   public:
    inline GroupMembersWithVersion()
        : GroupMembersWithVersion(nullptr) {
    }
    ~GroupMembersWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(GroupMembersWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(GroupMembersWithVersion));
    }
#endif

    template <typename = void>
    explicit PROTOBUF_CONSTEXPR GroupMembersWithVersion(
        ::google::protobuf::internal::ConstantInitialized);

    inline GroupMembersWithVersion(const GroupMembersWithVersion& from)
        : GroupMembersWithVersion(nullptr, from) {
    }
    inline GroupMembersWithVersion(GroupMembersWithVersion&& from) noexcept
        : GroupMembersWithVersion(nullptr, std::move(from)) {
    }
    ...
    GroupMembersWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
        return ::google::protobuf::MessageLite::DefaultConstruct<GroupMembersWithVersion>(arena);
    }
    void CopyFrom(const GroupMembersWithVersion& from);
    void MergeFrom(const GroupMembersWithVersion& from) {
        GroupMembersWithVersion::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    GroupMembersWithVersion(::google::protobuf::Arena* arena, const GroupMembersWithVersion& from);
    GroupMembersWithVersion(::google::protobuf::Arena* arena,
                            GroupMembersWithVersion&& from) noexcept
        : GroupMembersWithVersion(arena) {
        *this = ::std::move(from);
    }
   ...
   private:
    ...
    _internal_group_members() const;
    ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::GroupMember>*
    _internal_mutable_group_members();
   ...
   private:
    ...
    struct Impl_ {
        ...
        inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena* arena,
                              const Impl_& from,
                              const GroupMembersWithVersion& from_msg);
...
inline ::turms::client::model::proto::GroupMember* GroupMembersWithVersion::mutable_group_members(
...
GroupMembersWithVersion::mutable_group_members() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::turms::client::model::proto::GroupMember& GroupMembersWithVersion::group_members(
...
GroupMembersWithVersion::group_members() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
#endif  // model_2fgroup_2fgroup_5fmembers_5fwith_5fversion_2eproto_2epb_2eh