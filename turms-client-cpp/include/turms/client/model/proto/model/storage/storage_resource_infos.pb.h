...
#ifndef model_2fstorage_2fstorage_5fresource_5finfos_2eproto_2epb_2eh
#define model_2fstorage_2fstorage_5fresource_5finfos_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.StorageResourceInfos) */ {
   public:
    ...
    ~StorageResourceInfos() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(StorageResourceInfos* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(StorageResourceInfos));
    }
#endif
    ...
    StorageResourceInfos* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const StorageResourceInfos& from) {
        StorageResourceInfos::MergeImpl(*this, from);
    }
...
#endif  // model_2fstorage_2fstorage_5fresource_5finfos_2eproto_2epb_2eh