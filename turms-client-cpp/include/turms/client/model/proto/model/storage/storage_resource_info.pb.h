...
#ifndef model_2fstorage_2fstorage_5fresource_5finfo_2eproto_2epb_2eh
#define model_2fstorage_2fstorage_5fresource_5finfo_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.StorageResourceInfo) */ {
   public:
    ...
    ~StorageResourceInfo() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(StorageResourceInfo* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(StorageResourceInfo));
    }
#endif
    ...
    StorageResourceInfo* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const StorageResourceInfo& from) {
        StorageResourceInfo::MergeImpl(*this, from);
    }
   ...
   protected:
    ...
    static const ::google::protobuf::internal::ClassDataLite<45> _class_data_;
...
#endif  // model_2fstorage_2fstorage_5fresource_5finfo_2eproto_2epb_2eh