...
#ifndef model_2fuser_2fuser_5fsession_2eproto_2epb_2eh
#define model_2fuser_2fuser_5fsession_2eproto_2epb_2eh
...
class UserSession final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.UserSession) */ {
   public:
    inline UserSession()
        : UserSession(nullptr) {
    }
    ~UserSession() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(UserSession* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(UserSession));
    }
#endif
    ...
    inline UserSession(const UserSession& from)
        : UserSession(nullptr, from) {
    }
    ...
    static inline const UserSession* internal_default_instance() {
        return reinterpret_cast<const UserSession*>(&_UserSession_default_instance_);
    }
    ...
    UserSession* New(::google::protobuf::Arena* arena = nullptr) const {
        return ::google::protobuf::MessageLite::DefaultConstruct<UserSession>(arena);
    }
    void CopyFrom(const UserSession& from);
    void MergeFrom(const UserSession& from) {
        UserSession::MergeImpl(*this, from);
    }
...
inline const std::string& UserSession::session_id() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.UserSession.session_id)
    return _internal_session_id();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void UserSession::set_session_id(Arg_&& arg, Args_... args) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* UserSession::mutable_session_id() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const std::string& UserSession::server_id() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.UserSession.server_id)
    return _internal_server_id();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void UserSession::set_server_id(Arg_&& arg, Args_... args) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* UserSession::mutable_server_id() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
// repeated .turms.client.model.proto.Value custom_attributes = 15;
inline int UserSession::_internal_custom_attributes_size() const {
    return _internal_custom_attributes().size();
}
inline int UserSession::custom_attributes_size() const {
    return _internal_custom_attributes_size();
}
inline ::turms::client::model::proto::Value* UserSession::mutable_custom_attributes(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable:turms.client.model.proto.UserSession.custom_attributes)
...
UserSession::mutable_custom_attributes() ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_mutable_list:turms.client.model.proto.UserSession.custom_attributes)
    ::google::protobuf::internal::TSanWrite(&_impl_);
    return _internal_mutable_custom_attributes();
}
inline const ::turms::client::model::proto::Value& UserSession::custom_attributes(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:turms.client.model.proto.UserSession.custom_attributes)
    return _internal_custom_attributes().Get(index);
}
inline ::turms::client::model::proto::Value* UserSession::add_custom_attributes()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
    ::google::protobuf::internal::TSanWrite(&_impl_);
    ::turms::client::model::proto::Value* _add = _internal_mutable_custom_attributes()->Add();
    // @@protoc_insertion_point(field_add:turms.client.model.proto.UserSession.custom_attributes)
    return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
UserSession::custom_attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_list:turms.client.model.proto.UserSession.custom_attributes)
    return _internal_custom_attributes();
}
inline const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>&
UserSession::_internal_custom_attributes() const {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return _impl_.custom_attributes_;
}
inline ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::Value>*
UserSession::_internal_mutable_custom_attributes() {
    ::google::protobuf::internal::TSanRead(&_impl_);
    return &_impl_.custom_attributes_;
}
...
#endif  // model_2fuser_2fuser_5fsession_2eproto_2epb_2eh