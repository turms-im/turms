...
#ifndef model_2fuser_2fuser_5ffriend_5frequests_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fuser_2fuser_5ffriend_5frequests_5fwith_5fversion_2eproto_2epb_2eh
 ...
 */
{
   public:
    ...
    ~UserFriendRequestsWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(UserFriendRequestsWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(UserFriendRequestsWithVersion));
    }
#endif
    ...
    UserFriendRequestsWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const UserFriendRequestsWithVersion& from) {
        UserFriendRequestsWithVersion::MergeImpl(*this, from);
    }
...
#endif  // model_2fuser_2fuser_5ffriend_5frequests_5fwith_5fversion_2eproto_2epb_2eh