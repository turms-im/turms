...
#ifndef model_2fuser_2fuser_5frelationship_5fgroup_2eproto_2epb_2eh
#define model_2fuser_2fuser_5frelationship_5fgroup_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.UserRelationshipGroup) */ {
   public:
    ...
    ~UserRelationshipGroup() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(UserRelationshipGroup* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(UserRelationshipGroup));
    }
#endif
    ...
    UserRelationshipGroup* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const UserRelationshipGroup& from) {
        UserRelationshipGroup::MergeImpl(*this, from);
    }
...
#endif  // model_2fuser_2fuser_5frelationship_5fgroup_2eproto_2epb_2eh