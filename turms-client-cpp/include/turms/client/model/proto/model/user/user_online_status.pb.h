...
inline ::turms::client::model::proto::DeviceType UserOnlineStatus::using_device_types(
    int index) const {
...
inline void UserOnlineStatus::set_using_device_types(
...
inline void UserOnlineStatus::add_using_device_types(
...
UserOnlineStatus::_internal_using_device_types() const {
    PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
    return _impl_.using_device_types_;
}
inline ::google::protobuf::RepeatedField<int>*
UserOnlineStatus::_internal_mutable_using_device_types() {
    PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
    return &_impl_.using_device_types_;
}
