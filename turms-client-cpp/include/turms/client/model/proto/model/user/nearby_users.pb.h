...
class NearbyUsers final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.NearbyUsers) */ {
 public:
  ...
  private:
  const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::NearbyUser>& _internal_nearby_users() const;
  ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::NearbyUser>* _internal_mutable_nearby_users();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::google::protobuf::RepeatedPtrField< ::turms::client::model::proto::NearbyUser > nearby_users_;
...
NearbyUsers::mutable_nearby_users() {
...
NearbyUsers::nearby_users() const {
