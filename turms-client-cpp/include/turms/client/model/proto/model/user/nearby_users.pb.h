...
#ifndef model_2fuser_2fnearby_5fusers_2eproto_2epb_2eh
#define model_2fuser_2fnearby_5fusers_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.NearbyUsers) */ {
   public:
    ...
    ~NearbyUsers() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(NearbyUsers* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(NearbyUsers));
    }
#endif
    ...
    NearbyUsers* New(::google::protobuf::Arena* arena = nullptr) const {
...
#endif  // model_2fuser_2fnearby_5fusers_2eproto_2epb_2eh