...
class UserInfosWithVersion final :
    public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:turms.client.model.proto.UserInfosWithVersion) */ {
 public:
  inline UserInfosWithVersion() : UserInfosWithVersion(nullptr) {}
  ~UserInfosWithVersion() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR UserInfosWithVersion(::google::protobuf::internal::ConstantInitialized);

  UserInfosWithVersion(const UserInfosWithVersion& from);
  UserInfosWithVersion(UserInfosWithVersion&& from) noexcept
  ...
  UserInfosWithVersion* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UserInfosWithVersion>(arena);
  }
  ...
  ::google::protobuf::RepeatedPtrField< ::turms::client::model::proto::UserInfo >*
      mutable_user_infos();
  private:
  const ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::UserInfo>& _internal_user_infos() const;
  ::google::protobuf::RepeatedPtrField<::turms::client::model::proto::UserInfo>* _internal_mutable_user_infos();
  public:
...
UserInfosWithVersion::mutable_user_infos() {
...
inline const ::turms::client::model::proto::UserInfo& UserInfosWithVersion::user_infos(int index) const {
...
UserInfosWithVersion::user_infos() const {
