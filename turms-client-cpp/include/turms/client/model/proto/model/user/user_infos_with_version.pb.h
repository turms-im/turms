...
#ifndef model_2fuser_2fuser_5finfos_5fwith_5fversion_2eproto_2epb_2eh
#define model_2fuser_2fuser_5finfos_5fwith_5fversion_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:turms.client.model.proto.UserInfosWithVersion) */ {
   public:
    ...
    ~UserInfosWithVersion() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
    void operator delete(UserInfosWithVersion* msg, std::destroying_delete_t) {
        SharedDtor(*msg);
        ::google::protobuf::internal::SizedDelete(msg, sizeof(UserInfosWithVersion));
    }
#endif
    ...
    UserInfosWithVersion* New(::google::protobuf::Arena* arena = nullptr) const {
    ...
    void MergeFrom(const UserInfosWithVersion& from) {
        UserInfosWithVersion::MergeImpl(*this, from);
    }
...
#endif  // model_2fuser_2fuser_5finfos_5fwith_5fversion_2eproto_2epb_2eh