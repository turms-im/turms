...
const std::string& UserStatus_Name(UserStatus value) {
  static const bool kDummy =
      ::google::protobuf::internal::InitializeEnumStrings(
          UserStatus_entries, UserStatus_entries_by_number,
          7, UserStatus_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(
      UserStatus_entries, UserStatus_entries_by_number, 7,
      value);
...
bool UserStatus_Parse(absl::string_view name, UserStatus* value) {
  ...
  bool success = ::google::protobuf::internal::LookUpEnumValue(
      UserStatus_entries, 7, name, &int_value);
  if (success) {
