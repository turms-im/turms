...
const std::string& GroupMemberRole_Name(GroupMemberRole value) {
  static const bool kDummy =
      ::google::protobuf::internal::InitializeEnumStrings(
          GroupMemberRole_entries, GroupMemberRole_entries_by_number,
          5, GroupMemberRole_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(
      GroupMemberRole_entries, GroupMemberRole_entries_by_number, 5,
      value);
...
bool GroupMemberRole_Parse(absl::string_view name, GroupMemberRole* value) {
  ...
  bool success = ::google::protobuf::internal::LookUpEnumValue(
      GroupMemberRole_entries, 5, name, &int_value);
  if (success) {
