...
const std::string& StorageResourceType_Name(StorageResourceType value) {
  static const bool kDummy =
      ::google::protobuf::internal::InitializeEnumStrings(
          StorageResourceType_entries, StorageResourceType_entries_by_number,
          3, StorageResourceType_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(
      StorageResourceType_entries, StorageResourceType_entries_by_number, 3,
      value);
