...
const std::string& ProfileAccessStrategy_Name(ProfileAccessStrategy value) {
  static const bool kDummy =
      ::google::protobuf::internal::InitializeEnumStrings(
          ProfileAccessStrategy_entries, ProfileAccessStrategy_entries_by_number,
          3, ProfileAccessStrategy_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(
      ProfileAccessStrategy_entries, ProfileAccessStrategy_entries_by_number, 3,
      value);
