...
PROTOBUF_CONSTEXPR MessagesWithTotalList::MessagesWithTotalList(::_pbi::ConstantInitialized)
    : _impl_{
      /*decltype(_impl_.messages_with_total_list_)*/ {},
      /*decltype(_impl_._cached_size_)*/ {},
    } {}
struct MessagesWithTotalListDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MessagesWithTotalListDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MessagesWithTotalListDefaultTypeInternal _MessagesWithTotalList_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
void MessagesWithTotalList::clear_messages_with_total_list() {
  _internal_mutable_messages_with_total_list()->Clear();
}
...
MessagesWithTotalList::MessagesWithTotalList(const MessagesWithTotalList& from) : ::google::protobuf::MessageLite() {
  MessagesWithTotalList* const _this = this;
  (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.messages_with_total_list_){from._impl_.messages_with_total_list_},
      /*decltype(_impl_._cached_size_)*/ {},
  };
...
inline void MessagesWithTotalList::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
      decltype(_impl_.messages_with_total_list_){arena},
      /*decltype(_impl_._cached_size_)*/ {},
  };
}
...
inline void MessagesWithTotalList::SharedDtor() {
  ...
  _impl_.messages_with_total_list_.~RepeatedPtrField();
}
void MessagesWithTotalList::SetCachedSize(int size) const {
...
const char* MessagesWithTotalList::_InternalParse(
...
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> MessagesWithTotalList::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastMtR1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(MessagesWithTotalList, _impl_.messages_with_total_list_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .turms.client.model.proto.MessagesWithTotal messages_with_total_list = 1;
    {PROTOBUF_FIELD_OFFSET(MessagesWithTotalList, _impl_.messages_with_total_list_), 0, 0,
...
::uint8_t* MessagesWithTotalList::_InternalSerialize(
  ...
  // repeated .turms.client.model.proto.MessagesWithTotal messages_with_total_list = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_messages_with_total_list_size()); i < n; i++) {
...
void MessagesWithTotalList::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const MessagesWithTotalList*>(
      &from));
}
...
void MessagesWithTotalList::MergeFrom(const MessagesWithTotalList& from) {
  ...
  _this->_internal_mutable_messages_with_total_list()->MergeFrom(from._internal_messages_with_total_list());
...
PROTOBUF_NOINLINE bool MessagesWithTotalList::IsInitialized() const {
  return true;
}

void MessagesWithTotalList::InternalSwap(MessagesWithTotalList* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.messages_with_total_list_.InternalSwap(&other->_impl_.messages_with_total_list_);
}

std::string MessagesWithTotalList::GetTypeName() const {
