...
inline void* Value::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena) {
...
constexpr auto Value::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(Value, _impl_.list_value_) +
            decltype(Value::_impl_.list_value_)::InternalGetArenaOffset(
    ...
    if (arena_bits.has_value()) {
        ...
        return ::google::protobuf::internal::MessageCreator(
            &Value::PlacementNew_, sizeof(Value), alignof(Value));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<31> Value::_class_data_ = {
    {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Value::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<Value>(),
        &Value::ByteSizeLong,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* Value::_InternalSerialize(const MessageLite& base,
                                     ::uint8_t* target,
...
::uint8_t* Value::_InternalSerialize(::uint8_t* target,
    ...
    switch (this_.kind_case()) {
        ...
        case kFloatValue: {
            ...
            target =
                ::_pbi::WireFormatLite::WriteFloatToArray(3, this_._internal_float_value(), target);
            break;
        }
        case kDoubleValue: {
            target = stream->EnsureSpace(target);
        ...
        case kBoolValue: {
            target = stream->EnsureSpace(target);
            target =
                ::_pbi::WireFormatLite::WriteBoolToArray(5, this_._internal_bool_value(), target);
            break;
        }
        case kBytesValue: {
    ...
    // repeated .turms.client.model.proto.Value list_value = 8;
    for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_list_value_size()); i < n; i++) {
        const auto& repfield = this_._internal_list_value().Get(i);
...
::size_t Value::ByteSizeLong() const {
    ...
    ::_pbi::Prefetch5LinesFrom7Lines(&this_);
    {
        // repeated .turms.client.model.proto.Value list_value = 8;
        {
            total_size += 1UL * this_._internal_list_value_size();
            for (const auto& msg : this_._internal_list_value()) {
    ...
    switch (this_.kind_case()) {
        // int32 int32_value = 1;
        case kInt32Value: {
            total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this_._internal_int32_value());
            break;
        }
        // int64 int64_value = 2;
        case kInt64Value: {
            total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this_._internal_int64_value());
            break;
        }
        // float float_value = 3;
        case kFloatValue: {
