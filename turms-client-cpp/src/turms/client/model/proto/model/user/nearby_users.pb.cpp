...
inline void NearbyUsers::SharedDtor(MessageLite& self) {
    NearbyUsers& this_ = static_cast<NearbyUsers&>(self);
    this_._internal_metadata_.Delete<std::string>();
    ABSL_DCHECK(this_.GetArena() == nullptr);
    this_._impl_.~Impl_();
}

inline void* NearbyUsers::PlacementNew_(const void*, void* mem, ::google::protobuf::Arena* arena) {
    return ::new (mem) NearbyUsers(arena);
}
constexpr auto NearbyUsers::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(NearbyUsers, _impl_.nearby_users_) +
            decltype(NearbyUsers::_impl_.nearby_users_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::ZeroInit(
            sizeof(NearbyUsers), alignof(NearbyUsers), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(
            &NearbyUsers::PlacementNew_, sizeof(NearbyUsers), alignof(NearbyUsers));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<37> NearbyUsers::_class_data_ = {
    {
        ...
        ::google::protobuf::MessageLite::GetNewImpl<NearbyUsers>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &NearbyUsers::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<NearbyUsers>(),
        &NearbyUsers::ByteSizeLong,
        &NearbyUsers::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* NearbyUsers::GetClassData() const {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* NearbyUsers::_InternalSerialize(const MessageLite& base,
                                           ::uint8_t* target,
                                           ::google::protobuf::io::EpsCopyOutputStream* stream) {
    const NearbyUsers& this_ = static_cast<const NearbyUsers&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* NearbyUsers::_InternalSerialize(
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const {
    const NearbyUsers& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
    ...
    // repeated .turms.client.model.proto.NearbyUser nearby_users = 1;
    for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_nearby_users_size()); i < n;
         i++) {
        const auto& repfield = this_._internal_nearby_users().Get(i);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t NearbyUsers::ByteSizeLong(const MessageLite& base) {
    const NearbyUsers& this_ = static_cast<const NearbyUsers&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::size_t NearbyUsers::ByteSizeLong() const {
    ...
    ::_pbi::Prefetch5LinesFrom7Lines(&this_);
    {
        // repeated .turms.client.model.proto.NearbyUser nearby_users = 1;
        {
            total_size += 1UL * this_._internal_nearby_users_size();
            for (const auto& msg : this_._internal_nearby_users()) {
...
void NearbyUsers::MergeImpl(::google::protobuf::MessageLite& to_msg,
