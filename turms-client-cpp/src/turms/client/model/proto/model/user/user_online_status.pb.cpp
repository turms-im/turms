...
UserOnlineStatus::UserOnlineStatus(const UserOnlineStatus& from) : ::google::protobuf::MessageLite() {
  ...
  ::memcpy(&_impl_.user_id_, &from._impl_.user_id_,
    ...
    reinterpret_cast<char*>(&_impl_.user_id_)) + sizeof(_impl_.user_status_));
...
const char* UserOnlineStatus::_InternalParse(
...
const ::_pbi::TcParseTable<2, 3, 0, 0, 2> UserOnlineStatus::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int64 user_id = 1;
    {PROTOBUF_FIELD_OFFSET(UserOnlineStatus, _impl_.user_id_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // .turms.client.model.proto.UserStatus user_status = 2;
    {PROTOBUF_FIELD_OFFSET(UserOnlineStatus, _impl_.user_status_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // repeated .turms.client.model.proto.DeviceType using_device_types = 3;
    {PROTOBUF_FIELD_OFFSET(UserOnlineStatus, _impl_.using_device_types_), 0, 0,
...
::uint8_t* UserOnlineStatus::_InternalSerialize(
  ...
  // repeated .turms.client.model.proto.DeviceType using_device_types = 3;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteEnumPacked(3, _internal_using_device_types(),
                                       byte_size, target);
    }
  }
...
void UserOnlineStatus::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const UserOnlineStatus*>(
      &from));
}
...
std::string UserOnlineStatus::GetTypeName() const {
