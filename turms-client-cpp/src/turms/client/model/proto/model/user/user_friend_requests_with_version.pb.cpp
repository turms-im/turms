...
namespace proto {
        template <typename>
PROTOBUF_CONSTEXPR UserFriendRequestsWithVersion::UserFriendRequestsWithVersion(::_pbi::ConstantInitialized)
    : _impl_{
      /*decltype(_impl_._has_bits_)*/ {},
      /*decltype(_impl_._cached_size_)*/ {},
      /*decltype(_impl_.user_friend_requests_)*/ {},
      /*decltype(_impl_.last_updated_date_)*/ ::int64_t{0},
    } {}
struct UserFriendRequestsWithVersionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UserFriendRequestsWithVersionDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UserFriendRequestsWithVersionDefaultTypeInternal _UserFriendRequestsWithVersion_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
void UserFriendRequestsWithVersion::clear_user_friend_requests() {
  _internal_mutable_user_friend_requests()->Clear();
}
...
UserFriendRequestsWithVersion::UserFriendRequestsWithVersion(const UserFriendRequestsWithVersion& from) : ::google::protobuf::MessageLite() {
  UserFriendRequestsWithVersion* const _this = this;
  (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_},
      /*decltype(_impl_._cached_size_)*/ {},
      decltype(_impl_.user_friend_requests_){from._impl_.user_friend_requests_},
...
inline void UserFriendRequestsWithVersion::SharedCtor(::_pb::Arena* arena) {
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){},
      /*decltype(_impl_._cached_size_)*/ {},
      decltype(_impl_.user_friend_requests_){arena},
      decltype(_impl_.last_updated_date_){::int64_t{0}},
  };
}
...
inline void UserFriendRequestsWithVersion::SharedDtor() {
  ...
  _impl_.user_friend_requests_.~RepeatedPtrField();
}
void UserFriendRequestsWithVersion::SetCachedSize(int size) const {
...
const char* UserFriendRequestsWithVersion::_InternalParse(
...
const ::_pbi::TcParseTable<1, 2, 1, 0, 2> UserFriendRequestsWithVersion::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV64S1,
     {16, 0, 0, PROTOBUF_FIELD_OFFSET(UserFriendRequestsWithVersion, _impl_.last_updated_date_)}},
    // repeated .turms.client.model.proto.UserFriendRequest user_friend_requests = 1;
    {::_pbi::TcParser::FastMtR1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(UserFriendRequestsWithVersion, _impl_.user_friend_requests_)}},
  }}, {{
    65535, 65535
  }}, {{
    // repeated .turms.client.model.proto.UserFriendRequest user_friend_requests = 1;
    {PROTOBUF_FIELD_OFFSET(UserFriendRequestsWithVersion, _impl_.user_friend_requests_), -1, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
    // optional int64 last_updated_date = 2;
    {PROTOBUF_FIELD_OFFSET(UserFriendRequestsWithVersion, _impl_.last_updated_date_), _Internal::kHasBitsOffset + 0, 0,
...
::uint8_t* UserFriendRequestsWithVersion::_InternalSerialize(
  ...
  // repeated .turms.client.model.proto.UserFriendRequest user_friend_requests = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_user_friend_requests_size()); i < n; i++) {
...
void UserFriendRequestsWithVersion::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const UserFriendRequestsWithVersion*>(
      &from));
}
...
void UserFriendRequestsWithVersion::MergeFrom(const UserFriendRequestsWithVersion& from) {
  ...
  _this->_internal_mutable_user_friend_requests()->MergeFrom(from._internal_user_friend_requests());
...
PROTOBUF_NOINLINE bool UserFriendRequestsWithVersion::IsInitialized() const {
  return true;
}

void UserFriendRequestsWithVersion::InternalSwap(UserFriendRequestsWithVersion* other) {
  using std::swap;
...
std::string UserFriendRequestsWithVersion::GetTypeName() const {
