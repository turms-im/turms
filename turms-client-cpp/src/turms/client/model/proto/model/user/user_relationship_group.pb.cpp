...
void UserRelationshipGroup::clear_custom_attributes() {
...
inline PROTOBUF_NDEBUG_INLINE UserRelationshipGroup::Impl_::Impl_(
    ...
    const Impl_& from,
    const ::turms::client::model::proto::UserRelationshipGroup& from_msg)
...
inline void UserRelationshipGroup::SharedDtor(MessageLite& self) {
    UserRelationshipGroup& this_ = static_cast<UserRelationshipGroup&>(self);
...
inline void* UserRelationshipGroup::PlacementNew_(const void*,
                                                  void* mem,
                                                  ::google::protobuf::Arena* arena) {
    return ::new (mem) UserRelationshipGroup(arena);
}
constexpr auto UserRelationshipGroup::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(UserRelationshipGroup, _impl_.custom_attributes_) +
            decltype(UserRelationshipGroup::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::CopyInit(
            sizeof(UserRelationshipGroup), alignof(UserRelationshipGroup), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(&UserRelationshipGroup::PlacementNew_,
                                                            sizeof(UserRelationshipGroup),
                                                            alignof(UserRelationshipGroup));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<47> UserRelationshipGroup::_class_data_ = {
    {
        &_UserRelationshipGroup_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        nullptr,  // IsInitialized
        &UserRelationshipGroup::MergeImpl,
        ::google::protobuf::MessageLite::GetNewImpl<UserRelationshipGroup>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &UserRelationshipGroup::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<UserRelationshipGroup>(),
        &UserRelationshipGroup::ByteSizeLong,
        &UserRelationshipGroup::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* UserRelationshipGroup::GetClassData() const {
    return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 3, 1, 59, 2>
    UserRelationshipGroup::_table_ = {
        ...
        {{
            ...
            {::_pbi::TcParser::FastMtR1,
             {122, 63, 0, PROTOBUF_FIELD_OFFSET(UserRelationshipGroup, _impl_.custom_attributes_)}},
        }},
        {{65535, 65535}},
        {{
            // int32 index = 1;
...
::uint8_t* UserRelationshipGroup::_InternalSerialize(
    ...
    const UserRelationshipGroup& this_ = static_cast<const UserRelationshipGroup&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* UserRelationshipGroup::_InternalSerialize(
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const {
    const UserRelationshipGroup& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t UserRelationshipGroup::ByteSizeLong(const MessageLite& base) {
    const UserRelationshipGroup& this_ = static_cast<const UserRelationshipGroup&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
...
void UserRelationshipGroup::MergeImpl(::google::protobuf::MessageLite& to_msg,
                                      const ::google::protobuf::MessageLite& from_msg) {
    auto* const _this = static_cast<UserRelationshipGroup*>(&to_msg);
    auto& from = static_cast<const UserRelationshipGroup&>(from_msg);
