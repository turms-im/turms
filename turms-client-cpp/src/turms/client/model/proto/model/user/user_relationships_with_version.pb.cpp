...
const ::google::protobuf::MessageLite::ClassData* UserRelationshipsWithVersion::GetClassData()
    const {
    struct ClassData_ {
...
const char* UserRelationshipsWithVersion::_InternalParse(const char* ptr,
...
::uint8_t* UserRelationshipsWithVersion::_InternalSerialize(
    ...
    // repeated .turms.client.model.proto.UserRelationship user_relationships = 1;
    for (unsigned i = 0, n = static_cast<unsigned>(this->_internal_user_relationships_size());
         i < n;
         i++) {
...
void UserRelationshipsWithVersion::CheckTypeAndMergeFrom(
    ...
    MergeFrom(*::_pbi::DownCast<const UserRelationshipsWithVersion*>(&from));
}
