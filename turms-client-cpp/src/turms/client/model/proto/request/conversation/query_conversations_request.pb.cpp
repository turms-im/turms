...
const char* QueryConversationsRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 0, 2>
    QueryConversationsRequest::_table_ = {
        ...
        {{
            // repeated int64 target_ids = 1;
            {PROTOBUF_FIELD_OFFSET(QueryConversationsRequest, _impl_.target_ids_),
             0,
             0,
...
::uint8_t* QueryConversationsRequest::_InternalSerialize(
    ...
    // repeated int64 target_ids = 1;
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteInt64Packed(1, _internal_target_ids(), byte_size, target);
        }
    }
...
::size_t QueryConversationsRequest::ByteSizeLong() const {
    ...
    // repeated int64 target_ids = 1;
    {
        std::size_t data_size = ::_pbi::WireFormatLite::Int64Size(this->_internal_target_ids());
