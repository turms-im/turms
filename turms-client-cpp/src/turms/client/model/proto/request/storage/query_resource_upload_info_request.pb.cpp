...
inline constexpr QueryResourceUploadInfoRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_{0},
      custom_attributes_{},
...
template <typename>
PROTOBUF_CONSTEXPR QueryResourceUploadInfoRequest::QueryResourceUploadInfoRequest(
    ::_pbi::ConstantInitialized)
...
struct QueryResourceUploadInfoRequestDefaultTypeInternal {
    PROTOBUF_CONSTEXPR QueryResourceUploadInfoRequestDefaultTypeInternal()
...
void QueryResourceUploadInfoRequest::clear_custom_attributes() {
...
inline PROTOBUF_NDEBUG_INLINE QueryResourceUploadInfoRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena,
    const Impl_& from,
    const ::turms::client::model::proto::QueryResourceUploadInfoRequest& from_msg)
...
QueryResourceUploadInfoRequest::QueryResourceUploadInfoRequest(
    ::google::protobuf::Arena* arena, const QueryResourceUploadInfoRequest& from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, _class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::MessageLite(arena) {
...
inline void QueryResourceUploadInfoRequest::SharedDtor(MessageLite& self) {
    QueryResourceUploadInfoRequest& this_ = static_cast<QueryResourceUploadInfoRequest&>(self);
...
inline void* QueryResourceUploadInfoRequest::PlacementNew_(const void*,
                                                           void* mem,
                                                           ::google::protobuf::Arena* arena) {
    return ::new (mem) QueryResourceUploadInfoRequest(arena);
}
constexpr auto QueryResourceUploadInfoRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(QueryResourceUploadInfoRequest, _impl_.custom_attributes_) +
            decltype(QueryResourceUploadInfoRequest::_impl_.custom_attributes_)::
                InternalGetArenaOffset(::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::CopyInit(
            sizeof(QueryResourceUploadInfoRequest),
            alignof(QueryResourceUploadInfoRequest),
            *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(
            &QueryResourceUploadInfoRequest::PlacementNew_,
            sizeof(QueryResourceUploadInfoRequest),
            alignof(QueryResourceUploadInfoRequest));
    }
}
...
const ::google::protobuf::internal::ClassDataLite<56> QueryResourceUploadInfoRequest::_class_data_ =
    {
        {
            ...
            &QueryResourceUploadInfoRequest::MergeImpl,
            ::google::protobuf::MessageLite::GetNewImpl<QueryResourceUploadInfoRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
            &QueryResourceUploadInfoRequest::SharedDtor,
            ::google::protobuf::MessageLite::GetClearImpl<QueryResourceUploadInfoRequest>(),
            &QueryResourceUploadInfoRequest::ByteSizeLong,
            &QueryResourceUploadInfoRequest::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
            PROTOBUF_FIELD_OFFSET(QueryResourceUploadInfoRequest, _impl_._cached_size_),
            true,
        },
        "turms.client.model.proto.QueryResourceUploadInfoRequest",
    };
const ::google::protobuf::internal::ClassData* QueryResourceUploadInfoRequest::GetClassData()
    const {
    return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<3, 6, 1, 84, 2>
    QueryResourceUploadInfoRequest::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::turms::client::model::proto::QueryResourceUploadInfoRequest>(),  // to_prefetch
        ...
        {{
            ...
            // optional string id_str = 3;
            {PROTOBUF_FIELD_OFFSET(QueryResourceUploadInfoRequest, _impl_.id_str_),
             _Internal::kHasBitsOffset + 0,
             0,
             (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // optional string name = 4;
            {PROTOBUF_FIELD_OFFSET(QueryResourceUploadInfoRequest, _impl_.name_),
             _Internal::kHasBitsOffset + 1,
             0,
             (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // optional string media_type = 5;
            {PROTOBUF_FIELD_OFFSET(QueryResourceUploadInfoRequest, _impl_.media_type_),
...
::uint8_t* QueryResourceUploadInfoRequest::_InternalSerialize(
    ...
    const QueryResourceUploadInfoRequest& this_ =
        static_cast<const QueryResourceUploadInfoRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* QueryResourceUploadInfoRequest::_InternalSerialize(
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const {
    const QueryResourceUploadInfoRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
    ...
    if (cached_has_bits & 0x00000001u) {
        ...
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "turms.client.model.proto.QueryResourceUploadInfoRequest.id_str");
    ...
    if (cached_has_bits & 0x00000002u) {
        ...
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            static_cast<int>(_s.length()),
            ::google::protobuf::internal::WireFormatLite::SERIALIZE,
            "turms.client.model.proto.QueryResourceUploadInfoRequest.name");
    ...
    if (cached_has_bits & 0x00000004u) {
        ...
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            static_cast<int>(_s.length()),
            ::google::protobuf::internal::WireFormatLite::SERIALIZE,
            "turms.client.model.proto.QueryResourceUploadInfoRequest.media_type");
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t QueryResourceUploadInfoRequest::ByteSizeLong(const MessageLite& base) {
    const QueryResourceUploadInfoRequest& this_ =
        static_cast<const QueryResourceUploadInfoRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
...
void QueryResourceUploadInfoRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
                                               const ::google::protobuf::MessageLite& from_msg) {
    auto* const _this = static_cast<QueryResourceUploadInfoRequest*>(&to_msg);
    auto& from = static_cast<const QueryResourceUploadInfoRequest&>(from_msg);
...
void QueryResourceUploadInfoRequest::InternalSwap(
    QueryResourceUploadInfoRequest* PROTOBUF_RESTRICT other) {
    using std::swap;
    auto* arena = GetArena();
