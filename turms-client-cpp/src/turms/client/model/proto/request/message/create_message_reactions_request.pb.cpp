...
inline void CreateMessageReactionsRequest::SharedDtor() {
    ABSL_DCHECK(GetArena() == nullptr);
    _impl_.~Impl_();
}

const ::google::protobuf::MessageLite::ClassData* CreateMessageReactionsRequest::GetClassData()
    const {
...
void CreateMessageReactionsRequest::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
    MergeFrom(*::_pbi::DownCast<const CreateMessageReactionsRequest*>(&from));
}

void CreateMessageReactionsRequest::MergeFrom(const CreateMessageReactionsRequest& from) {
    CreateMessageReactionsRequest* const _this = this;
