...
const char* TurmsRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
    return ptr;
}

PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 60, 59, 0, 32>
    TurmsRequest::_table_ = {
        ...
        {{100, 0,     1,  65472, 13, 200, 0,     1,  57344, 19, 300, 0,     1,  65472, 32,   400, 0,
          1,   65520, 38, 500,   0,  1,   57344, 42, 1000,  0,  1,   65504, 55, 65535, 65535}},
        {{
            // optional int64 request_id = 1;
