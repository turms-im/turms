...
const ::google::protobuf::MessageLite::ClassData* QueryGroupJoinQuestionsRequest::GetClassData()
    const {
...
::uint8_t* QueryGroupJoinQuestionsRequest::_InternalSerialize(
    ...
    if (this->_internal_with_answers() != 0) {
        ...
        target =
            ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_with_answers(), target);
    }
...
void QueryGroupJoinQuestionsRequest::CheckTypeAndMergeFrom(
    ...
    MergeFrom(*::_pbi::DownCast<const QueryGroupJoinQuestionsRequest*>(&from));
}
