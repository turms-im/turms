...
const char* DeleteGroupRequest::_InternalParse(
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> DeleteGroupRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int64 group_id = 1;
    {PROTOBUF_FIELD_OFFSET(DeleteGroupRequest, _impl_.group_id_), 0, 0,
