...
const ::google::protobuf::MessageLite::ClassData* UpdateGroupInvitationRequest::GetClassData()
    const {
    struct ClassData_ {
...
const char* UpdateGroupInvitationRequest::_InternalParse(const char* ptr,
                                                         ::_pbi::ParseContext* ctx) {
    ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
    return ptr;
}

PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 3, 0, 68, 2>
...
void UpdateGroupInvitationRequest::CheckTypeAndMergeFrom(
    ...
    MergeFrom(*::_pbi::DownCast<const UpdateGroupInvitationRequest*>(&from));
}
