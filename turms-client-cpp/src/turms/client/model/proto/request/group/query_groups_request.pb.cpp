...
inline constexpr QueryGroupsRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_{0},
      group_ids_{},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    QueryGroupsRequestDefaultTypeInternal _QueryGroupsRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
void QueryGroupsRequest::clear_custom_attributes() {
...
inline PROTOBUF_NDEBUG_INLINE QueryGroupsRequest::Impl_::Impl_(
    ...
    const Impl_& from,
    const ::turms::client::model::proto::QueryGroupsRequest& from_msg)
...
inline void* QueryGroupsRequest::PlacementNew_(const void*,
                                               void* mem,
                                               ::google::protobuf::Arena* arena) {
...
constexpr auto QueryGroupsRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.group_ids_) +
            decltype(QueryGroupsRequest::_impl_.group_ids_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
        PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.fields_to_highlight_) +
            decltype(QueryGroupsRequest::_impl_.fields_to_highlight_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
        PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.custom_attributes_) +
            decltype(QueryGroupsRequest::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::CopyInit(
            sizeof(QueryGroupsRequest), alignof(QueryGroupsRequest), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(&QueryGroupsRequest::PlacementNew_,
                                                            sizeof(QueryGroupsRequest),
                                                            alignof(QueryGroupsRequest));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<44> QueryGroupsRequest::_class_data_ = {
    {
        ...
        ::google::protobuf::MessageLite::GetNewImpl<QueryGroupsRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &QueryGroupsRequest::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<QueryGroupsRequest>(),
        &QueryGroupsRequest::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<3, 7, 1, 56, 2>
    QueryGroupsRequest::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::turms::client::model::proto::QueryGroupsRequest>(),  // to_prefetch
        ...
        {{
            ...
            {::_pbi::TcParser::FastV64S1,
             {16, 1, 0, PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.last_updated_date_)}},
            // optional string name = 3;
            {::_pbi::TcParser::FastUS1,
             {26, 0, 0, PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.name_)}},
            // repeated int32 fields_to_highlight = 12;
            {::_pbi::TcParser::FastV32P1,
             {98, 63, 0, PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.fields_to_highlight_)}},
            {::_pbi::TcParser::MiniParse, {}},
            {::_pbi::TcParser::MiniParse, {}},
            // repeated .turms.client.model.proto.Value custom_attributes = 15;
            {::_pbi::TcParser::FastMtR1,
             {122, 63, 0, PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.custom_attributes_)}},
        }},
        {{65535, 65535}},
        {{
            // repeated int64 group_ids = 1;
            ...
            // optional int64 last_updated_date = 2;
            {PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.last_updated_date_),
             _Internal::kHasBitsOffset + 1,
             0,
             (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
            // optional string name = 3;
            {PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.name_),
             _Internal::kHasBitsOffset + 0,
             0,
             (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
            // optional int32 skip = 10;
            {PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.skip_),
             _Internal::kHasBitsOffset + 2,
             0,
             (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
            // optional int32 limit = 11;
            {PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.limit_),
...
::uint8_t* QueryGroupsRequest::_InternalSerialize(
    ...
    // repeated int64 group_ids = 1;
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteInt64Packed(1, this_._internal_group_ids(), byte_size, target);
        }
    }
    ...
    if (cached_has_bits & 0x00000001u) {
        ...
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            "turms.client.model.proto.QueryGroupsRequest.name");
...
void QueryGroupsRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
...
void QueryGroupsRequest::InternalSwap(QueryGroupsRequest* PROTOBUF_RESTRICT other) {
    ...
    ::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(QueryGroupsRequest, _impl_.limit_) +
                                          sizeof(QueryGroupsRequest::_impl_.limit_) -
                                          PROTOBUF_FIELD_OFFSET(QueryGroupsRequest,
