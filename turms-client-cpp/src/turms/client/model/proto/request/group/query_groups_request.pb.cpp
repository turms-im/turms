...
const ::google::protobuf::MessageLite::ClassData* QueryGroupsRequest::GetClassData() const {
...
::uint8_t* QueryGroupsRequest::_InternalSerialize(
    ...
    // repeated int64 group_ids = 1;
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteInt64Packed(1, _internal_group_ids(), byte_size, target);
        }
    }
...
void QueryGroupsRequest::CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from) {
    MergeFrom(*::_pbi::DownCast<const QueryGroupsRequest*>(&from));
}
