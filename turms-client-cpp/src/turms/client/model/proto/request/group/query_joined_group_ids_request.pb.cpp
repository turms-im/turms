...
namespace proto {
        template <typename>
PROTOBUF_CONSTEXPR QueryJoinedGroupIdsRequest::QueryJoinedGroupIdsRequest(::_pbi::ConstantInitialized)
    : _impl_{
...
struct QueryJoinedGroupIdsRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR QueryJoinedGroupIdsRequestDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 QueryJoinedGroupIdsRequestDefaultTypeInternal _QueryJoinedGroupIdsRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
QueryJoinedGroupIdsRequest::QueryJoinedGroupIdsRequest(const QueryJoinedGroupIdsRequest& from)
...
void QueryJoinedGroupIdsRequest::SetCachedSize(int size) const {
...
const char* QueryJoinedGroupIdsRequest::_InternalParse(
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> QueryJoinedGroupIdsRequest::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV64S1,
     {8, 0, 0, PROTOBUF_FIELD_OFFSET(QueryJoinedGroupIdsRequest, _impl_.last_updated_date_)}},
  }}, {{
    65535, 65535
  }}, {{
    // optional int64 last_updated_date = 1;
    {PROTOBUF_FIELD_OFFSET(QueryJoinedGroupIdsRequest, _impl_.last_updated_date_), _Internal::kHasBitsOffset + 0, 0,
...
void QueryJoinedGroupIdsRequest::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const QueryJoinedGroupIdsRequest*>(
      &from));
}
...
void QueryJoinedGroupIdsRequest::InternalSwap(QueryJoinedGroupIdsRequest* other) {
  using std::swap;
...
std::string QueryJoinedGroupIdsRequest::GetTypeName() const {
