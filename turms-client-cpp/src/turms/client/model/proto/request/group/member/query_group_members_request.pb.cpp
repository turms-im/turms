...
void QueryGroupMembersRequest::clear_custom_attributes() {
...
inline PROTOBUF_NDEBUG_INLINE QueryGroupMembersRequest::Impl_::Impl_(
    ...
    const Impl_& from,
    const ::turms::client::model::proto::QueryGroupMembersRequest& from_msg)
...
inline void* QueryGroupMembersRequest::PlacementNew_(const void*,
                                                     void* mem,
                                                     ::google::protobuf::Arena* arena) {
...
constexpr auto QueryGroupMembersRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(QueryGroupMembersRequest, _impl_.member_ids_) +
            decltype(QueryGroupMembersRequest::_impl_.member_ids_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
        PROTOBUF_FIELD_OFFSET(QueryGroupMembersRequest, _impl_.custom_attributes_) +
            decltype(QueryGroupMembersRequest::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::ZeroInit(
            sizeof(QueryGroupMembersRequest), alignof(QueryGroupMembersRequest), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(
            &QueryGroupMembersRequest::PlacementNew_,
            sizeof(QueryGroupMembersRequest),
            alignof(QueryGroupMembersRequest));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<50> QueryGroupMembersRequest::_class_data_ = {
    {
        ...
        ::google::protobuf::MessageLite::GetNewImpl<QueryGroupMembersRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &QueryGroupMembersRequest::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<QueryGroupMembersRequest>(),
        &QueryGroupMembersRequest::ByteSizeLong,
...
::uint8_t* QueryGroupMembersRequest::_InternalSerialize(
    ...
    // repeated int64 member_ids = 3;
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteInt64Packed(3, this_._internal_member_ids(), byte_size, target);
        }
    }
    ...
    if (cached_has_bits & 0x00000002u) {
        ...
        target = ::_pbi::WireFormatLite::WriteBoolToArray(4, this_._internal_with_status(), target);
    }
...
void QueryGroupMembersRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
