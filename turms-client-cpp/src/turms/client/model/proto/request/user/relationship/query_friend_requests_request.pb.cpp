...
inline void QueryFriendRequestsRequest::SharedDtor(MessageLite& self) {
    QueryFriendRequestsRequest& this_ = static_cast<QueryFriendRequestsRequest&>(self);
    this_._internal_metadata_.Delete<std::string>();
    ABSL_DCHECK(this_.GetArena() == nullptr);
    this_._impl_.~Impl_();
}

inline void* QueryFriendRequestsRequest::PlacementNew_(const void*,
                                                       void* mem,
                                                       ::google::protobuf::Arena* arena) {
    return ::new (mem) QueryFriendRequestsRequest(arena);
}
constexpr auto QueryFriendRequestsRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(QueryFriendRequestsRequest, _impl_.custom_attributes_) +
            decltype(QueryFriendRequestsRequest::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::ZeroInit(
            sizeof(QueryFriendRequestsRequest), alignof(QueryFriendRequestsRequest), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(
            &QueryFriendRequestsRequest::PlacementNew_,
            sizeof(QueryFriendRequestsRequest),
            alignof(QueryFriendRequestsRequest));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<52> QueryFriendRequestsRequest::_class_data_ = {
    {
        &_QueryFriendRequestsRequest_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        nullptr,  // IsInitialized
        &QueryFriendRequestsRequest::MergeImpl,
        ::google::protobuf::MessageLite::GetNewImpl<QueryFriendRequestsRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &QueryFriendRequestsRequest::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<QueryFriendRequestsRequest>(),
        &QueryFriendRequestsRequest::ByteSizeLong,
        &QueryFriendRequestsRequest::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* QueryFriendRequestsRequest::GetClassData() const {
...
::uint8_t* QueryFriendRequestsRequest::_InternalSerialize(
    ...
    const QueryFriendRequestsRequest& this_ = static_cast<const QueryFriendRequestsRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* QueryFriendRequestsRequest::_InternalSerialize(
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const {
    const QueryFriendRequestsRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
    ...
    // bool are_sent_by_me = 1;
    if (this_._internal_are_sent_by_me() != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteBoolToArray(1, this_._internal_are_sent_by_me(), target);
    }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t QueryFriendRequestsRequest::ByteSizeLong(const MessageLite& base) {
    const QueryFriendRequestsRequest& this_ = static_cast<const QueryFriendRequestsRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
...
void QueryFriendRequestsRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
                                           const ::google::protobuf::MessageLite& from_msg) {
    auto* const _this = static_cast<QueryFriendRequestsRequest*>(&to_msg);
    auto& from = static_cast<const QueryFriendRequestsRequest&>(from_msg);
