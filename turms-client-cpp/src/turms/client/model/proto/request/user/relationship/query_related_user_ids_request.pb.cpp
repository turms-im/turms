...
const ::google::protobuf::MessageLite::ClassData* QueryRelatedUserIdsRequest::GetClassData() const {
...
::uint8_t* QueryRelatedUserIdsRequest::_InternalSerialize(
    ...
    if (cached_has_bits & 0x00000002u) {
        ...
        target = ::_pbi::WireFormatLite::WriteBoolToArray(1, this->_internal_blocked(), target);
    }
    ...
    // repeated int32 group_indexes = 2;
    {
        ...
        if (byte_size > 0) {
            target = stream->WriteInt32Packed(2, _internal_group_indexes(), byte_size, target);
        }
    }
...
void QueryRelatedUserIdsRequest::CheckTypeAndMergeFrom(
    ...
    MergeFrom(*::_pbi::DownCast<const QueryRelatedUserIdsRequest*>(&from));
}
