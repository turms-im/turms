...
inline void QueryNearbyUsersRequest::SharedDtor(MessageLite& self) {
    QueryNearbyUsersRequest& this_ = static_cast<QueryNearbyUsersRequest&>(self);
    this_._internal_metadata_.Delete<std::string>();
    ABSL_DCHECK(this_.GetArena() == nullptr);
    this_._impl_.~Impl_();
}

inline void* QueryNearbyUsersRequest::PlacementNew_(const void*,
                                                    void* mem,
                                                    ::google::protobuf::Arena* arena) {
    return ::new (mem) QueryNearbyUsersRequest(arena);
}
constexpr auto QueryNearbyUsersRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(QueryNearbyUsersRequest, _impl_.custom_attributes_) +
            decltype(QueryNearbyUsersRequest::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::ZeroInit(
            sizeof(QueryNearbyUsersRequest), alignof(QueryNearbyUsersRequest), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(&QueryNearbyUsersRequest::PlacementNew_,
                                                            sizeof(QueryNearbyUsersRequest),
                                                            alignof(QueryNearbyUsersRequest));
    }
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<49> QueryNearbyUsersRequest::_class_data_ = {
    {
        &_QueryNearbyUsersRequest_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        nullptr,  // IsInitialized
        &QueryNearbyUsersRequest::MergeImpl,
        ::google::protobuf::MessageLite::GetNewImpl<QueryNearbyUsersRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &QueryNearbyUsersRequest::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<QueryNearbyUsersRequest>(),
        &QueryNearbyUsersRequest::ByteSizeLong,
        &QueryNearbyUsersRequest::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
...
const ::google::protobuf::internal::ClassData* QueryNearbyUsersRequest::GetClassData() const {
...
::uint8_t* QueryNearbyUsersRequest::_InternalSerialize(
    ...
    const QueryNearbyUsersRequest& this_ = static_cast<const QueryNearbyUsersRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::uint8_t* QueryNearbyUsersRequest::_InternalSerialize(
    ::uint8_t* target, ::google::protobuf::io::EpsCopyOutputStream* stream) const {
    const QueryNearbyUsersRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
    ...
    if (cached_has_bits & 0x00000004u) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteBoolToArray(5, this_._internal_with_coordinates(), target);
    }
    ...
    if (cached_has_bits & 0x00000008u) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteBoolToArray(6, this_._internal_with_distance(), target);
    }
    ...
    if (cached_has_bits & 0x00000010u) {
        target = stream->EnsureSpace(target);
        target =
            ::_pbi::WireFormatLite::WriteBoolToArray(7, this_._internal_with_user_info(), target);
    }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::size_t QueryNearbyUsersRequest::ByteSizeLong(const MessageLite& base) {
    const QueryNearbyUsersRequest& this_ = static_cast<const QueryNearbyUsersRequest&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
::size_t QueryNearbyUsersRequest::ByteSizeLong() const {
    ...
    if (cached_has_bits & 0x0000001fu) {
        ...
        // optional int32 max_distance = 4;
        if (cached_has_bits & 0x00000002u) {
            total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this_._internal_max_distance());
        }
        // optional bool with_coordinates = 5;
        if (cached_has_bits & 0x00000004u) {
            total_size += 2;
...
void QueryNearbyUsersRequest::MergeImpl(::google::protobuf::MessageLite& to_msg,
                                        const ::google::protobuf::MessageLite& from_msg) {
    auto* const _this = static_cast<QueryNearbyUsersRequest*>(&to_msg);
    auto& from = static_cast<const QueryNearbyUsersRequest&>(from_msg);
