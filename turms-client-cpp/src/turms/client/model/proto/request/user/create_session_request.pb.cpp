...
inline void* CreateSessionRequest::PlacementNew_(const void*,
                                                 void* mem,
                                                 ::google::protobuf::Arena* arena) {
...
constexpr auto CreateSessionRequest::InternalNewImpl_() {
    constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
        PROTOBUF_FIELD_OFFSET(CreateSessionRequest, _impl_.device_details_) +
            decltype(CreateSessionRequest::_impl_.device_details_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
        PROTOBUF_FIELD_OFFSET(CreateSessionRequest, _impl_.custom_attributes_) +
            decltype(CreateSessionRequest::_impl_.custom_attributes_)::InternalGetArenaOffset(
                ::google::protobuf::MessageLite::internal_visibility()),
    });
    if (arena_bits.has_value()) {
        return ::google::protobuf::internal::MessageCreator::CopyInit(
            sizeof(CreateSessionRequest), alignof(CreateSessionRequest), *arena_bits);
    } else {
        return ::google::protobuf::internal::MessageCreator(&CreateSessionRequest::PlacementNew_,
...
const ::google::protobuf::internal::ClassDataLite<46> CreateSessionRequest::_class_data_ = {
    {
        ...
        ::google::protobuf::MessageLite::GetNewImpl<CreateSessionRequest>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &CreateSessionRequest::SharedDtor,
        ::google::protobuf::MessageLite::GetClearImpl<CreateSessionRequest>(),
        &CreateSessionRequest::ByteSizeLong,
...
::uint8_t* CreateSessionRequest::_InternalSerialize(
    ...
    if (cached_has_bits & 0x00000004u) {
        ...
        target = ::_pbi::WireFormatLite::WriteEnumToArray(4, this_._internal_user_status(), target);
    }

    // .turms.client.model.proto.DeviceType device_type = 5;
    if (this_._internal_device_type() != 0) {
        target = stream->EnsureSpace(target);
        target = ::_pbi::WireFormatLite::WriteEnumToArray(5, this_._internal_device_type(), target);
    }

    // map<string, string> device_details = 6;
    if (!this_._internal_device_details().empty()) {
        using MapType = ::google::protobuf::Map<std::string, std::string>;
        using WireHelper = _pbi::MapEntryFuncs<std::string,
                                               std::string,
                                               _pbi::WireFormatLite::TYPE_STRING,
                                               _pbi::WireFormatLite::TYPE_STRING>;
        const auto& field = this_._internal_device_details();
    ...
    if (cached_has_bits & 0x00000002u) {
        target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
            7, *this_._impl_.location_, this_._impl_.location_->GetCachedSize(), target, stream);
    }
    ...
    ::_pbi::Prefetch5LinesFrom7Lines(&this_);
    {
        // map<string, string> device_details = 6;
        {
            total_size += 1 * ::google::protobuf::internal::FromIntSize(
                                  this_._internal_device_details_size());
            for (const auto& entry : this_._internal_device_details()) {
