...
namespace proto {
      template <typename>
PROTOBUF_CONSTEXPR UpdateUserLocationRequest_DetailsEntry_DoNotUse::UpdateUserLocationRequest_DetailsEntry_DoNotUse(::_pbi::ConstantInitialized) {}
struct UpdateUserLocationRequest_DetailsEntry_DoNotUseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UpdateUserLocationRequest_DetailsEntry_DoNotUseDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~UpdateUserLocationRequest_DetailsEntry_DoNotUseDefaultTypeInternal() {}
  union {
    UpdateUserLocationRequest_DetailsEntry_DoNotUse _instance;
  };
};

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UpdateUserLocationRequest_DetailsEntry_DoNotUseDefaultTypeInternal _UpdateUserLocationRequest_DetailsEntry_DoNotUse_default_instance_;
        template <typename>
...
struct UpdateUserLocationRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UpdateUserLocationRequestDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UpdateUserLocationRequestDefaultTypeInternal _UpdateUserLocationRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
UpdateUserLocationRequest_DetailsEntry_DoNotUse::UpdateUserLocationRequest_DetailsEntry_DoNotUse() {}
UpdateUserLocationRequest_DetailsEntry_DoNotUse::UpdateUserLocationRequest_DetailsEntry_DoNotUse(::google::protobuf::Arena* arena)
    : SuperType(arena) {}
void UpdateUserLocationRequest_DetailsEntry_DoNotUse::MergeFrom(const UpdateUserLocationRequest_DetailsEntry_DoNotUse& other) {
...
UpdateUserLocationRequest::UpdateUserLocationRequest(const UpdateUserLocationRequest& from) : ::google::protobuf::MessageLite() {
...
void UpdateUserLocationRequest::SetCachedSize(int size) const {
...
const char* UpdateUserLocationRequest::_InternalParse(
...
const ::_pbi::TcParseTable<1, 3, 1, 66, 2> UpdateUserLocationRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // float latitude = 1;
    {PROTOBUF_FIELD_OFFSET(UpdateUserLocationRequest, _impl_.latitude_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
    // float longitude = 2;
    {PROTOBUF_FIELD_OFFSET(UpdateUserLocationRequest, _impl_.longitude_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kFloat)},
    // map<string, string> details = 3;
    {PROTOBUF_FIELD_OFFSET(UpdateUserLocationRequest, _impl_.details_), 0, 0,
    (0 | ::_fl::kFcRepeated | ::_fl::kMap)},
  }}, {{
    {::_pbi::TcParser::GetMapAuxInfo<decltype(UpdateUserLocationRequest()._impl_.details_)>(1, 0, 0)},
  }}, {{
    "\62\0\0\7\0\0\0\0"
...
::uint8_t* UpdateUserLocationRequest::_InternalSerialize(
  ...
  if (!_internal_details().empty()) {
    ...
    using WireHelper = UpdateUserLocationRequest_DetailsEntry_DoNotUse::Funcs;
 ...
 ::google::protobuf::internal::WireFormatLite::SERIALIZE, "turms.client.model.proto.UpdateUserLocationRequest.details");
        ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
...
// @@protoc_insertion_point(message_byte_size_start:turms.client.model.proto.UpdateUserLocationRequest)
  ...
  for (const auto& entry : _internal_details()) {
    total_size += UpdateUserLocationRequest_DetailsEntry_DoNotUse::Funcs::ByteSizeLong(entry.first, entry.second);
  }
  // float latitude = 1;
  static_assert(sizeof(::uint32_t) == sizeof(float),
                "Code assumes ::uint32_t and float are the same size.");
...
void UpdateUserLocationRequest::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const UpdateUserLocationRequest*>(
      &from));
}
...
PROTOBUF_NOINLINE bool UpdateUserLocationRequest::IsInitialized() const {
  return true;
}

void UpdateUserLocationRequest::InternalSwap(UpdateUserLocationRequest* other) {
  using std::swap;
...
std::string UpdateUserLocationRequest::GetTypeName() const {
