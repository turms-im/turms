...
namespace proto {
        template <typename>
PROTOBUF_CONSTEXPR CreateFriendRequestRequest::CreateFriendRequestRequest(::_pbi::ConstantInitialized)
    : _impl_{
...
struct CreateFriendRequestRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR CreateFriendRequestRequestDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 CreateFriendRequestRequestDefaultTypeInternal _CreateFriendRequestRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
CreateFriendRequestRequest::CreateFriendRequestRequest(const CreateFriendRequestRequest& from) : ::google::protobuf::MessageLite() {
...
void CreateFriendRequestRequest::SetCachedSize(int size) const {
...
const char* CreateFriendRequestRequest::_InternalParse(
...
const ::_pbi::TcParseTable<1, 2, 0, 67, 2> CreateFriendRequestRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int64 recipient_id = 1;
    {PROTOBUF_FIELD_OFFSET(CreateFriendRequestRequest, _impl_.recipient_id_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // string content = 2;
    {PROTOBUF_FIELD_OFFSET(CreateFriendRequestRequest, _impl_.content_), 0, 0,
...
::uint8_t* CreateFriendRequestRequest::_InternalSerialize(
  ...
  if (!this->_internal_content().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "turms.client.model.proto.CreateFriendRequestRequest.content");
...
void CreateFriendRequestRequest::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const CreateFriendRequestRequest*>(
      &from));
}
...
void CreateFriendRequestRequest::InternalSwap(CreateFriendRequestRequest* other) {
  using std::swap;
...
std::string CreateFriendRequestRequest::GetTypeName() const {
