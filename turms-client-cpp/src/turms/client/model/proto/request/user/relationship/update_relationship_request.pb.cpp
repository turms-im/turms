...
struct UpdateRelationshipRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UpdateRelationshipRequestDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UpdateRelationshipRequestDefaultTypeInternal _UpdateRelationshipRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
const char* UpdateRelationshipRequest::_InternalParse(
...
void UpdateRelationshipRequest::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const UpdateRelationshipRequest*>(
      &from));
}
...
std::string UpdateRelationshipRequest::GetTypeName() const {
