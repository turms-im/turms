...
namespace proto {
        template <typename>
PROTOBUF_CONSTEXPR UpdateFriendRequestRequest::UpdateFriendRequestRequest(::_pbi::ConstantInitialized)
    : _impl_{
...
struct UpdateFriendRequestRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR UpdateFriendRequestRequestDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 UpdateFriendRequestRequestDefaultTypeInternal _UpdateFriendRequestRequest_default_instance_;
}  // namespace proto
}  // namespace model
}  // namespace client
}  // namespace turms
...
UpdateFriendRequestRequest::UpdateFriendRequestRequest(const UpdateFriendRequestRequest& from) : ::google::protobuf::MessageLite() {
...
inline void UpdateFriendRequestRequest::SharedDtor() {
  ABSL_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.reason_.Destroy();
}
void UpdateFriendRequestRequest::SetCachedSize(int size) const {
...
const char* UpdateFriendRequestRequest::_InternalParse(
...
const ::_pbi::TcParseTable<2, 3, 0, 66, 2> UpdateFriendRequestRequest::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastV32S1,
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(UpdateFriendRequestRequest, _impl_.response_action_)}},
    ...
    // int64 request_id = 1;
    {PROTOBUF_FIELD_OFFSET(UpdateFriendRequestRequest, _impl_.request_id_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
    // .turms.client.model.proto.ResponseAction response_action = 2;
    {PROTOBUF_FIELD_OFFSET(UpdateFriendRequestRequest, _impl_.response_action_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kOpenEnum)},
    // optional string reason = 3;
    {PROTOBUF_FIELD_OFFSET(UpdateFriendRequestRequest, _impl_.reason_), _Internal::kHasBitsOffset + 0, 0,
...
::uint8_t* UpdateFriendRequestRequest::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "turms.client.model.proto.UpdateFriendRequestRequest.reason");
...
void UpdateFriendRequestRequest::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const UpdateFriendRequestRequest*>(
      &from));
}

void UpdateFriendRequestRequest::MergeFrom(const UpdateFriendRequestRequest& from) {
  UpdateFriendRequestRequest* const _this = this;
...
PROTOBUF_NOINLINE bool UpdateFriendRequestRequest::IsInitialized() const {
  return true;
}

void UpdateFriendRequestRequest::InternalSwap(UpdateFriendRequestRequest* other) {
  using std::swap;
...
std::string UpdateFriendRequestRequest::GetTypeName() const {
