...
const ::google::protobuf::MessageLite::ClassData* UpdateFriendRequestRequest::GetClassData() const {
    struct ClassData_ {
...
const char* UpdateFriendRequestRequest::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
void UpdateFriendRequestRequest::CheckTypeAndMergeFrom(
    ...
    MergeFrom(*::_pbi::DownCast<const UpdateFriendRequestRequest*>(&from));
}
