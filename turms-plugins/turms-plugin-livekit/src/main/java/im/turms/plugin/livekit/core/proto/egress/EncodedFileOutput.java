...
/**
 * Protobuf type {@code livekit.EncodedFileOutput}
 */
public final class EncodedFileOutput extends com.google.protobuf.GeneratedMessage implements
        // @@protoc_insertion_point(message_implements:livekit.EncodedFileOutput)
        EncodedFileOutputOrBuilder {
    ...
    static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
                ...
                /* patch= */ 1,
                /* suffix= */ "",
                EncodedFileOutput.class.getName());
    }

    // Use EncodedFileOutput.newBuilder() to construct.
    private EncodedFileOutput(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
    }
    ...
    public static com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return im.turms.plugin.livekit.core.proto.egress.LivekitEgress.internal_static_livekit_EncodedFileOutput_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return im.turms.plugin.livekit.core.proto.egress.LivekitEgress.internal_static_livekit_EncodedFileOutput_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput.class,
                        im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public im.turms.plugin.livekit.core.proto.egress.EncodedFileType getFileType() {
        im.turms.plugin.livekit.core.proto.egress.EncodedFileType result =
                im.turms.plugin.livekit.core.proto.egress.EncodedFileType.forNumber(fileType_);
        return result == null
                ? im.turms.plugin.livekit.core.proto.egress.EncodedFileType.UNRECOGNIZED
                : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        if (fileType_ != im.turms.plugin.livekit.core.proto.egress.EncodedFileType.DEFAULT_FILETYPE
                .getNumber()) {
        ...
        if (outputCase_ == 3) {
            output.writeMessage(3, (im.turms.plugin.livekit.core.proto.egress.S3Upload) output_);
        }
        if (outputCase_ == 4) {
            output.writeMessage(4, (im.turms.plugin.livekit.core.proto.egress.GCPUpload) output_);
        }
        if (outputCase_ == 5) {
        ...
        if (disableManifest_) {
            output.writeBool(6, disableManifest_);
        }
        if (outputCase_ == 7) {
    ...
    public int getSerializedSize() {
        ...
        if (disableManifest_) {
            size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, disableManifest_);
        }
        if (outputCase_ == 7) {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof EncodedFileOutput other)) {
            return super.equals(obj);
        }

        if (fileType_ != other.fileType_) {
            return false;
        }
    ...
    public static im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput parseFrom(
    ...
    public static im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput prototype) {
        return DEFAULT_INSTANCE.toBuilder()
                .mergeFrom(prototype);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            implements
            // @@protoc_insertion_point(builder_implements:livekit.EncodedFileOutput)
            im.turms.plugin.livekit.core.proto.egress.EncodedFileOutputOrBuilder {
        public static com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return im.turms.plugin.livekit.core.proto.egress.LivekitEgress.internal_static_livekit_EncodedFileOutput_descriptor;
        }
        ...
        // Construct using im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput getDefaultInstanceForType() {
            return im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput.getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput build() {
            im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput result = buildPartial();
        ...
        @java.lang.Override
        public im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput buildPartial() {
            im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput result =
                    new im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput(this);
            if (bitField0_ != 0) {
        ...
        private void buildPartialOneofs(
            ...
            if (outputCase_ == 3 && s3Builder_ != null) {
                result.output_ = s3Builder_.build();
            }
            if (outputCase_ == 4 && gcpBuilder_ != null) {
                result.output_ = gcpBuilder_.build();
            }
            if (outputCase_ == 5 && azureBuilder_ != null) {
                result.output_ = azureBuilder_.build();
            }
            if (outputCase_ == 7 && aliOSSBuilder_ != null) {
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput) {
                return mergeFrom(
                        (im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput) other);
            } else {
        ...
        public Builder mergeFrom(
                im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput other) {
            if (other == im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput
                    .getDefaultInstance()) {
                return this;
            }
        ...
        public Builder setFileType(
                im.turms.plugin.livekit.core.proto.egress.EncodedFileType value) {
            if (value == null) {
        ...
        // @@protoc_insertion_point(builder_scope:livekit.EncodedFileOutput)
    }

    // @@protoc_insertion_point(class_scope:livekit.EncodedFileOutput)
    private static final im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput DEFAULT_INSTANCE;
    static {
        DEFAULT_INSTANCE = new im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput();
    }

    public static im.turms.plugin.livekit.core.proto.egress.EncodedFileOutput getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<EncodedFileOutput> PARSER =
            new com.google.protobuf.AbstractParser<>() {
                @java.lang.Override
                public EncodedFileOutput parsePartialFrom(
                        com.google.protobuf.CodedInputStream input,
                        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                        throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static com.google.protobuf.Parser<EncodedFileOutput> parser() {
        return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<EncodedFileOutput> getParserForType() {
        return PARSER;
    }
