...
public interface ImageOutputOrBuilder extends
        // @@protoc_insertion_point(interface_extends:livekit.ImageOutput)
     ...
     */
    im.turms.plugin.livekit.core.proto.egress.ImageFileSuffix getFilenameSuffix();
     ...
     */
    im.turms.plugin.livekit.core.proto.models.ImageCodec getImageCodec();
    ...
    im.turms.plugin.livekit.core.proto.egress.ImageOutput.OutputCase getOutputCase();
}
