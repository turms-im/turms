...
public class ServiceRequestDispatcher implements IServiceRequestDispatcher {
    ...
    public Mono<ServiceResponse> dispatch(TracingContext context, ServiceRequest serviceRequest) {
        ...
        try {
            ...
            return Mono.just(ServiceResponseFactory.get(ResponseStatusCode.SERVER_INTERNAL_ERROR, e.toString()));
        } finally {
    ...
    private Mono<ServiceResponse> dispatch0(TracingContext context, ServiceRequest serviceRequest) {
        ...
        if (userId == null) {
            ...
            return Mono.just(new ServiceResponse(null, ResponseStatusCode.SERVER_INTERNAL_ERROR, message));
        }
        if (deviceType == null) {
        ...
        return clientRequestMono.flatMap(lastClientRequest -> {
            ...
            if (lastRequest == null) {
                ...
                return Mono.just(ServiceResponseFactory.get(ResponseStatusCode.SERVER_INTERNAL_ERROR, message));
            }
