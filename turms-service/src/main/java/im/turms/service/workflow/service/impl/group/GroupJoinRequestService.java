...
import im.turms.service.workflow.service.util.RequestStatusUtil;
        ...
        taskManager.reschedule(
                ...
                () -> {
                    ...
                    if (isLocalNodeLeader && deleteExpiredRequestsWhenCronTriggered && expirationDate != null) {
                        removeAllExpiredGroupJoinRequests(expirationDate)
        ...
        return groupMemberService.isBlocked(groupId, requesterId)
                ...
                .flatMap(isActive -> {
                    ...
                    return mongoClient.insert(groupJoinRequest)
                            .then(groupVersionService.updateJoinRequestsVersion(groupId)
                                    .onErrorResume(t -> {
