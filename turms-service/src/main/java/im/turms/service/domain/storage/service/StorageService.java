...
public class StorageService {
    ...
    private static final Mono<Void> SHARE_MESSAGE_ATTACHMENT_WITH_USER_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<Void> SHARE_MESSAGE_ATTACHMENT_WITH_GROUP_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<Void> UNSHARE_MESSAGE_ATTACHMENT_WITH_USER_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<Void> UNSHARE_MESSAGE_ATTACHMENT_WITH_GROUP_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<List<StorageResourceInfo>> QUERY_MESSAGE_ATTACHMENT_INFOS_UPLOADED_BY_REQUESTER_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<List<StorageResourceInfo>> QUERY_MESSAGE_ATTACHMENT_INFOS_IN_PRIVATE_CONVERSATION_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    private static final Mono<List<StorageResourceInfo>> QUERY_MESSAGE_ATTACHMENT_INFOS_IN_GROUP_CONVERSATION_NOT_IMPLEMENTED = STORAGE_NOT_IMPLEMENTED;
    ...
    static {
        try {
            ...
            QUERY_USER_PROFILE_PICTURE_UPLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryUserProfilePictureUploadInfo", Long.class, String.class, MediaType.class, Map.class);
            QUERY_USER_PROFILE_PICTURE_DOWNLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryUserProfilePictureDownloadInfo", Long.class, Long.class, Map.class);

            DELETE_GROUP_PROFILE_PICTURE_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("deleteGroupProfilePicture", Long.class, Long.class, Map.class);
            QUERY_GROUP_PROFILE_PICTURE_UPLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryGroupProfilePictureUploadInfo", Long.class, Long.class, String.class, MediaType.class, Map.class);
            QUERY_GROUP_PROFILE_PICTURE_DOWNLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryGroupProfilePictureDownloadInfo", Long.class, Long.class, Map.class);

            DELETE_MESSAGE_ATTACHMENT_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("deleteMessageAttachment", Long.class, Long.class, String.class, Map.class);
            SHARE_MESSAGE_ATTACHMENT_WITH_USER_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("shareMessageAttachmentWithUser", Long.class, Long.class, String.class, Long.class);
            SHARE_MESSAGE_ATTACHMENT_WITH_GROUP_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("shareMessageAttachmentWithGroup", Long.class, Long.class, String.class, Long.class);
            UNSHARE_MESSAGE_ATTACHMENT_WITH_USER_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("unshareMessageAttachmentWithUser", Long.class, Long.class, String.class, Long.class);
            UNSHARE_MESSAGE_ATTACHMENT_WITH_GROUP_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("unshareMessageAttachmentWithGroup", Long.class, Long.class, String.class, Long.class);
            QUERY_MESSAGE_ATTACHMENT_UPLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentUploadInfo", Long.class, String.class, MediaType.class, Map.class);
            QUERY_MESSAGE_ATTACHMENT_UPLOAD_INFO_IN_PRIVATE_CONVERSATION_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentUploadInfoInPrivateConversation", Long.class, Long.class, String.class, MediaType.class, Map.class);
            QUERY_MESSAGE_ATTACHMENT_UPLOAD_INFO_IN_GROUP_CONVERSATION_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentUploadInfoInGroupConversation", Long.class, Long.class, String.class, MediaType.class, Map.class);
            QUERY_MESSAGE_ATTACHMENT_DOWNLOAD_INFO_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentDownloadInfo", Long.class, Long.class, String.class, Map.class);

            QUERY_MESSAGE_ATTACHMENT_INFOS_UPLOADED_BY_REQUESTER_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentInfosUploadedByRequester", Long.class, DateRange.class);
            QUERY_MESSAGE_ATTACHMENT_INFOS_IN_PRIVATE_CONVERSATIONS_METHOD = StorageServiceProvider.class
                    .getDeclaredMethod("queryMessageAttachmentInfosInPrivateConversations", Long.class, Set.class, DateRange.class, Boolean.class);
        ...
        return switch (resourceType) {
            ...
            case GROUP_PROFILE_PICTURE -> pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                    ...
                    provider -> {
                        ...
                        return provider.deleteGroupProfilePicture(requesterId, resourceIdNum, extra);
                    });
            case MESSAGE_ATTACHMENT -> pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                    ...
                    DELETE_RESOURCE_NOT_IMPLEMENTED,
                    provider -> provider.deleteMessageAttachment(requesterId, resourceIdNum, resourceIdStr, extra));
    ...
    public Mono<Map<String, String>> queryResourceUploadInfo(Long requesterId,
        ...
        if (resourceMediaType == null) {
            ...
            try {
                ...
                return Mono.error(ResponseException.get(ResponseStatusCode.ILLEGAL_ARGUMENT, e.getMessage()));
            }
        }
        return switch (resourceType) {
            case USER_PROFILE_PICTURE -> pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                    ...
                    provider -> provider.queryUserProfilePictureUploadInfo(requesterId, resourceName, mediaType, extra));
            case GROUP_PROFILE_PICTURE -> pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                    ...
                    provider -> {
                        ...
                        return provider.queryGroupProfilePictureUploadInfo(requesterId, resourceIdNum, resourceName, mediaType, extra);
                    });
            case MESSAGE_ATTACHMENT -> {
                if (resourceIdNum == null) {
                    yield pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                            ...
                            QUERY_RESOURCE_UPLOAD_INFO_NOT_IMPLEMENTED,
                            provider -> provider.queryMessageAttachmentUploadInfo(requesterId, resourceName, mediaType, extra));
                }
                ...
                if (resourceIdNum < 0) {
                    yield pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                            ...
                            QUERY_RESOURCE_UPLOAD_INFO_NOT_IMPLEMENTED,
                            provider -> provider.queryMessageAttachmentUploadInfoInGroupConversation(requesterId, -resourceIdNum, resourceName, mediaType, extra));
                }
                yield pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                        QUERY_MESSAGE_ATTACHMENT_UPLOAD_INFO_IN_PRIVATE_CONVERSATION_METHOD,
                        QUERY_RESOURCE_UPLOAD_INFO_NOT_IMPLEMENTED,
                        provider -> provider.queryMessageAttachmentUploadInfoInPrivateConversation(requesterId, resourceIdNum, resourceName, mediaType, extra));
            }
            default -> Mono.error(ResponseException.get(ResponseStatusCode.ILLEGAL_ARGUMENT, "Unknown resource type: " + resourceType));
        };
    }
        ...
        return switch (resourceType) {
            case USER_PROFILE_PICTURE -> {
                ...
                yield pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                        ...
                        provider -> provider.queryUserProfilePictureDownloadInfo(requesterId, resourceIdNum, extra));
            }
            case GROUP_PROFILE_PICTURE -> {
                ...
                yield pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                        ...
                        QUERY_RESOURCE_DOWNLOAD_INFO_NOT_IMPLEMENTED,
                        provider -> provider.queryGroupProfilePictureDownloadInfo(requesterId, resourceIdNum, extra));
            }
            case MESSAGE_ATTACHMENT -> pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                    QUERY_MESSAGE_ATTACHMENT_DOWNLOAD_INFO_METHOD,
                    QUERY_RESOURCE_DOWNLOAD_INFO_NOT_IMPLEMENTED,
                    provider -> provider.queryMessageAttachmentDownloadInfo(requesterId, resourceIdNum, resourceIdStr, extra));
            default -> Mono.error(ResponseException.get(ResponseStatusCode.ILLEGAL_ARGUMENT, "Unknown resource type: " + resourceType));
        };
    }
    ...
    public Mono<Void> shareMessageAttachmentWithUser(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.shareMessageAttachmentWithUser(requesterId, messageAttachmentIdNum, messageAttachmentIdStr, userIdToShareWith));
    }
    ...
    public Mono<Void> shareMessageAttachmentWithGroup(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.shareMessageAttachmentWithGroup(requesterId, messageAttachmentIdNum, messageAttachmentIdStr, groupIdToShareWith));
    }
    ...
    public Mono<Void> unshareMessageAttachmentWithUser(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.unshareMessageAttachmentWithUser(requesterId, messageAttachmentIdNum, messageAttachmentIdStr, userIdToUnshareWith));
    }
    ...
    public Mono<Void> unshareMessageAttachmentWithGroup(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.unshareMessageAttachmentWithGroup(requesterId, messageAttachmentIdNum, messageAttachmentIdStr, groupIdToUnshareWith));
    }

    public Mono<List<StorageResourceInfo>> queryMessageAttachmentInfosUploadedByRequester(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.queryMessageAttachmentInfosUploadedByRequester(requesterId, creationDateRange));
    }

    public Mono<List<StorageResourceInfo>> queryMessageAttachmentInfosInPrivateConversations(Long requesterId,
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.queryMessageAttachmentInfosInPrivateConversations(requesterId, userIds, creationDateRange, areSharedByRequester));
    }
    ...
    public Mono<List<StorageResourceInfo>> queryMessageAttachmentInfosInGroupConversations(
        ...
        return pluginManager.invokeFirstExtensionPoint(StorageServiceProvider.class,
                ...
                provider -> provider.queryMessageAttachmentInfosInGroupConversations(requesterId, groupIds, userIds, creationDateRange));
    }
