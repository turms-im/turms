...
class _SettingsPaneState extends ConsumerState<SettingsPane> {
  ...
  Future<void> _updateActionOnClose(SettingActionOnClose value) async {
    ...
    await userSettingRepository.upsert(ref.read(loggedInUserViewModel)!.userId,
  ...
  Future<void> _updateLaunchOnStartup(bool value) async {
    ...
    try {
      ...
      unawaited(TToast.showToast(
          context, _appLocalizations.failedToUpdateSettings(e.toString())));
    }
      ...
      if (resetConflictedShortcuts) {
        for (final homePageAction in HomePageAction.values) {
          if (action != homePageAction &&
              (_actionToShortcut[homePageAction]!
                      .shortcutActivator
  ...
  bool _hasAnyShortcutChanged() {
    for (final homePageAction in HomePageAction.values) {
      final hasSameKeys = _actionToShortcut[homePageAction]
              ?.shortcutActivator
...
class _SettingsPaneView extends StatelessWidget {
      ...
      for (final entry in formFieldGroupToContext.entries)
        switch (entry.key) {
          ...
          SettingFormFieldGroup.shortcuts => _buildShortcutsFieldGroup(
              ...
              context),
          SettingFormFieldGroup.status =>
            _buildStatusFieldGroup(entry.value, appLocalizations),
      ...
      TFormFieldGroup(
          ...
          fields: [
            TFormFieldCheckbox(
              ...
              value: _settingsPaneController._userSettings.launchOnStartup ??
                  false,
            ),
            TFormFieldRadioGroup<SettingActionOnClose>(
              label: appLocalizations.actionOnClose,
              groupValue: _settingsPaneController._userSettings.actionOnClose ??
  ...
  TFormFieldGroup _buildStatusFieldGroup(SettingFormFieldGroupContext context,
          AppLocalizations appLocalizations) =>
      TFormFieldGroup(
          title: context.getTitle(appLocalizations),
          titleKey: context.key,
          fields: [
            TFormFieldCheckbox(
              ...
              value: _settingsPaneController
                      ._userSettings.newMessageNotification ??
                  false,
          ...
          fields: [
            TFormFieldSelect(
              ...
              value: _settingsPaneController._useSystemLocale
                  ...
                  : _nameToLocale[
                      _settingsPaneController._appLocalizations.localeName]!,
              entries: [
                TMenuEntry(
            ...
            TFormFieldSelect(
              ...
              value: _settingsPaneController._userSettings.theme ??
                  ThemeMode.system,
              entries: [
                TMenuEntry(
      ...
      TFormFieldGroup(
          ...
          fields: [
            TFormFieldCheckbox(
              ...
              value: _settingsPaneController
                      ._userSettings.checkForUpdatesAutomatically ??
                  false,
              onChanged:
                  _settingsPaneController._updateCheckForUpdatesAutomatically,
            )
          ]);
}
