  ...
  Row _buildSentMessageBubble(BuildContext context, DateTime now) {
    ...
    return Row(
      ...
      children: [
        ...
        UserProfilePopup(user: widget.sender, popupAnchor: Alignment.topRight),
      ],
    );
  }
      ...
      children: [
        ...
        IntrinsicWidth(
          ...
          child: switch (message.type) {
            ...
            MessageType.audio => MessageBubbleAudio(
              url: Uri.parse(message.originalUrl!),
            ),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(
              _formatMessageTimestamp(now, widget.messages.first.timestamp),
