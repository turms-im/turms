...
class TMessageEditorState extends State<MessageEditor> {
  ...
  late TMenuController _mentionUserMenuController;
  TPopupFollowerController? _mentionUserPopupFollowerController;
  ...
  void initState() {
    ...
    _mentionUserMenuController = TMenuController();
  }
  ...
  void _tryHideMentionUserMenu() {
    _mentionUserPopupFollowerController?.hide?.call();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final textStyleBodyMedium = context.theme.textTheme.bodyMedium!;

    final conversation = widget.conversation;
    return Focus(
      onKeyEvent: (context, event) {
        final logicalKey = event.logicalKey;
        final controller = _mentionUserPopupFollowerController;
        if (controller == null || !controller.visible) {
          return KeyEventResult.ignored;
        }
        if (logicalKey == LogicalKeyboardKey.escape ||
            widget.controller.selection.baseOffset <= _lastCaretOffset!) {
          _tryHideMentionUserMenu();
          return KeyEventResult.handled;
        } else if (logicalKey == LogicalKeyboardKey.arrowDown) {
          if (event is KeyDownEvent || event is KeyRepeatEvent) {
            _mentionUserMenuController.move?.call(true);
          }
          return KeyEventResult.handled;
        } else if (logicalKey == LogicalKeyboardKey.arrowUp) {
          if (event is KeyDownEvent || event is KeyRepeatEvent) {
            _mentionUserMenuController.move?.call(false);
          }
          return KeyEventResult.handled;
        } else if (logicalKey == LogicalKeyboardKey.enter) {
          _mentionUserMenuController.selectCurrentEntry?.call();
          _tryHideMentionUserMenu();
          return KeyEventResult.handled;
        }
        return KeyEventResult.ignored;
      ...
      child: TextField(
        ...
        onChanged: (_) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            ...
            _tryHideMentionUserMenu();
            _mentionUserPopupFollowerController = TPopupFollowerController();
            showPopup(
              context: context,
              controller: _mentionUserPopupFollowerController,
              ...
              follower: ConstrainedBox(
                ...
                child: TMenu(
                  controller: _mentionUserMenuController,
                  dense: true,
                  entries: conversation.contact.members
                      .map((e) => TMenuEntry(value: e.userId, label: e.name))
                      .toList(),
                  onSelected: (entry) {
                    // TODO
