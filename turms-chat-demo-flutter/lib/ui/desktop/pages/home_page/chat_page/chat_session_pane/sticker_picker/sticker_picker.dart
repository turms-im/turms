      ...
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child: _isGiphyEnabled
                      ...
                      child: Padding(
                        ...
                        child: TLazyIndexedStack(
                          ...
                          children: [
                            ...
                            GiphyPicker(onSelected: widget.onGiphyGifSelected),
                          ],
                        ),
                      ),
                    ),
                    const THorizontalDivider(color: _containerColorHovered),
                    Padding(
              ...
              : EmojiPickerPane(onEmojiSelected: widget.onEmojiSelected),
        ),
      ),
    ),
  );
