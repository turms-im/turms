...
class TAvatar extends ConsumerWidget {
  ...
  Widget _buildContent(
    ...
    if (null != icon) {
      return ColoredBox(
        ...
        child: Icon(icon, fill: 1, color: Colors.white, size: size.iconSize),
      );
    }
    if (name.isEmpty) {
      return ColoredBox(
    ...
    return ColoredBox(
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            fontSize: textSize ?? size.textSize,
            color: Colors.white,
          ),
        ),
      ),
  ...
  Widget _buildPresence(AppLocalizations appLocalizations) {
    Widget content = SizedBox(
      ...
      child: CustomPaint(painter: _TAvatarUserPresencePainter(presence)),
    );
    ...
    return Positioned(right: 0, bottom: 0, child: content);
  }
