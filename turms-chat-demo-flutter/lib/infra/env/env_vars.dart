class EnvVars {
  ...
  static const bool databaseLogStatements = bool.fromEnvironment(
    'DATABASE_LOG_STATEMENTS',
  );
  static const bool secureStorage = bool.fromEnvironment('SECURE_STORAGE');
  static const bool showFocusTracker = bool.fromEnvironment(
    'SHOW_FOCUS_TRACKER',
  );
  static const int messageImageMaxDownloadableSizeBytes = int.fromEnvironment(
    'MESSAGE_IMAGE_MAX_DOWNLOADABLE_SIZE_BYTES',
  );
