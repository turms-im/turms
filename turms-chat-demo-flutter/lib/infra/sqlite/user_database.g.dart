...
class $ConversationSettingTableTable extends ConversationSettingTable
    with
        TableInfo<$ConversationSettingTableTable,
  ...
  late final GeneratedColumn<bool> isGroupConversation = GeneratedColumn<bool>(
      'is_group_conversation', aliasedName, false,
    ...
    if (data.containsKey('is_group_conversation')) {
      context.handle(
          ...
          isGroupConversation.isAcceptableOrUnknown(
              data['is_group_conversation']!, _isGroupConversationMeta));
    } else if (isInserting) {
  ...
  Set<GeneratedColumn> get $primaryKey =>
      {contactId, isGroupConversation, settingId};
  @override
  ConversationSettingTableData map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    ...
    return ConversationSettingTableData(
      ...
      isGroupConversation: attachedDatabase.typeMapping.read(
          DriftSqlType.bool, data['${effectivePrefix}is_group_conversation'])!,
...
class ConversationSettingTableData extends DataClass
  ...
  factory ConversationSettingTableData.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ConversationSettingTableData(
      contactId: serializer.fromJson<BigInt>(json['contactId']),
      isGroupConversation:
          serializer.fromJson<bool>(json['isGroupConversation']),
  ...
  @override
  int get hashCode => Object.hash(contactId, isGroupConversation, settingId,
...
abstract class _$UserDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [conversationSettingTable, logEntryTable, userSettingTable];
}
...
class $$ConversationSettingTableTableFilterComposer
  ...
  ColumnFilters<int> get settingId => $composableBuilder(
      column: $table.settingId, builder: (column) => ColumnFilters(column));
...
class $$ConversationSettingTableTableOrderingComposer
  ...
  ColumnOrderings<int> get settingId => $composableBuilder(
      column: $table.settingId, builder: (column) => ColumnOrderings(column));
...
class $$ConversationSettingTableTableAnnotationComposer
  ...
  GeneratedColumn<bool> get isGroupConversation => $composableBuilder(
      column: $table.isGroupConversation, builder: (column) => column);
...
class $$ConversationSettingTableTableTableManager extends RootTableManager<
    _$UserDatabase,
    ...
    (
      ConversationSettingTableData,
      BaseReferences<_$UserDatabase, $ConversationSettingTableTable,
          ConversationSettingTableData>
    ),
    ConversationSettingTableData,
    PrefetchHooks Function()> {
  $$ConversationSettingTableTableTableManager(
      _$UserDatabase db, $ConversationSettingTableTable table)
...
class $UserDatabaseManager {
  ...
  $$ConversationSettingTableTableTableManager get conversationSettingTable =>
      $$ConversationSettingTableTableTableManager(
          _db, _db.conversationSettingTable);
