...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  @override
  List<DiskSpaceInfo> crateApiSystemGetDiskSpaceInfos() => handler.executeSync(
    SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
  ...
  TaskConstMeta get kCrateApiSystemGetDiskSpaceInfosConstMeta =>
      const TaskConstMeta(debugName: 'get_disk_space_infos', argNames: []);

  @override
  Future<void> crateApiAppInitApp() => handler.executeNormal(
    NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        pdeCallFfi(
  ...
  TaskConstMeta get kCrateApiSystemIsProcessRunningConstMeta =>
      const TaskConstMeta(debugName: 'is_process_running', argNames: ['pid']);
