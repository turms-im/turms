    ...
    init(_ turmsClient: TurmsClient) {
        ...
        self.turmsClient.driver
            .addNotificationListener { [weak self] notification in
                ...
                let n = Notification(timestamp: Date(timeIntervalSince1970: TimeInterval(notification.timestamp) / 1000), requesterId: notification.requesterID, relayedRequest: notification.relayedRequest)
