...
public struct QueryUsersIdsNearbyRequest {
...
extension QueryUsersIdsNearbyRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryUsersIdsNearbyRequest"
  ...
  public static func ==(lhs: QueryUsersIdsNearbyRequest, rhs: QueryUsersIdsNearbyRequest) -> Bool {
