...
public struct QueryJoinedGroupsInfosRequest {
...
extension QueryJoinedGroupsInfosRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryJoinedGroupsInfosRequest"
  ...
  public static func ==(lhs: QueryJoinedGroupsInfosRequest, rhs: QueryJoinedGroupsInfosRequest) -> Bool {
