...
public struct QueryJoinedGroupsIdsRequest {
...
extension QueryJoinedGroupsIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryJoinedGroupsIdsRequest"
  ...
  public static func ==(lhs: QueryJoinedGroupsIdsRequest, rhs: QueryJoinedGroupsIdsRequest) -> Bool {
