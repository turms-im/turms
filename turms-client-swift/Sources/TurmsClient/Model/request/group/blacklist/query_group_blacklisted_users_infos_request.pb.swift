...
public struct QueryGroupBlacklistedUsersInfosRequest {
...
extension QueryGroupBlacklistedUsersInfosRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryGroupBlacklistedUsersInfosRequest"
  ...
  public static func ==(lhs: QueryGroupBlacklistedUsersInfosRequest, rhs: QueryGroupBlacklistedUsersInfosRequest) -> Bool {
