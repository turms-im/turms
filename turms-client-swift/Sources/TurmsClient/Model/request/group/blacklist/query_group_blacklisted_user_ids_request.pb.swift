...
public struct QueryGroupBlacklistedUserIdsRequest {
...
extension QueryGroupBlacklistedUserIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryGroupBlacklistedUserIdsRequest"
  ...
  public static func ==(lhs: QueryGroupBlacklistedUserIdsRequest, rhs: QueryGroupBlacklistedUserIdsRequest) -> Bool {
