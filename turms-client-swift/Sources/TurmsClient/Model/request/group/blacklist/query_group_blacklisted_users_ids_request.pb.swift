...
public struct QueryGroupBlacklistedUsersIdsRequest {
...
extension QueryGroupBlacklistedUsersIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryGroupBlacklistedUsersIdsRequest"
  ...
  public static func ==(lhs: QueryGroupBlacklistedUsersIdsRequest, rhs: QueryGroupBlacklistedUsersIdsRequest) -> Bool {
