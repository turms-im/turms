...
extension QueryConversationsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedInt64Field(value: &self.targetIds) }()
      case 2: try { try decoder.decodeRepeatedInt64Field(value: &self.groupIds) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.targetIds.isEmpty {
      try visitor.visitPackedInt64Field(value: self.targetIds, fieldNumber: 1)
    }
    if !self.groupIds.isEmpty {
      try visitor.visitPackedInt64Field(value: self.groupIds, fieldNumber: 2)
    }
