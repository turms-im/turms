...
public struct UsersInfosWithVersion {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var userInfos: [UserInfo] {
    get {return _storage._userInfos}
    set {_uniqueStorage()._userInfos = newValue}
  }
...
extension UsersInfosWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UsersInfosWithVersion"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "user_infos"),
    2: .standard(proto: "last_updated_date"),
  ]

  fileprivate class _StorageClass {
    var _userInfos: [UserInfo] = []
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeRepeatedMessageField(value: &_storage._userInfos)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._userInfos.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._userInfos, fieldNumber: 1)
      }
  ...
  public static func ==(lhs: UsersInfosWithVersion, rhs: UsersInfosWithVersion) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._userInfos != rhs_storage._userInfos {return false}
