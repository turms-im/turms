...
public struct UserRelationshipsWithVersion {
  ...
  public var userRelationships: [UserRelationship] {
    get {return _storage._userRelationships}
    set {_uniqueStorage()._userRelationships = newValue}
  }
...
extension UserRelationshipsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _userRelationships: [UserRelationship] = []
    ...
    init(copying source: _StorageClass) {
      _userRelationships = source._userRelationships
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeRepeatedMessageField(value: &_storage._userRelationships)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._userRelationships.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._userRelationships, fieldNumber: 1)
      }
  ...
  public static func ==(lhs: UserRelationshipsWithVersion, rhs: UserRelationshipsWithVersion) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._userRelationships != rhs_storage._userRelationships {return false}
