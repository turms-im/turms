...
public struct GroupInvitationsWithVersion {
  ...
  public var groupInvitations: [GroupInvitation] {
    get {return _storage._groupInvitations}
    set {_uniqueStorage()._groupInvitations = newValue}
  }
...
extension GroupInvitationsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _groupInvitations: [GroupInvitation] = []
    ...
    init(copying source: _StorageClass) {
      _groupInvitations = source._groupInvitations
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeRepeatedMessageField(value: &_storage._groupInvitations)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._groupInvitations.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._groupInvitations, fieldNumber: 1)
      }
  ...
  public static func ==(lhs: GroupInvitationsWithVersion, rhs: GroupInvitationsWithVersion) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._groupInvitations != rhs_storage._groupInvitations {return false}
