...
public struct GroupInvitation {
  ...
  public var hasInviteeID: Bool {return self._inviteeID != nil}
  /// Clears the value of `inviteeID`. Subsequent reads from it will return its default value.
  public mutating func clearInviteeID() {self._inviteeID = nil}
  ...
  fileprivate var _inviterID: Int64? = nil
  fileprivate var _inviteeID: Int64? = nil
}
...
extension GroupInvitation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularInt64Field(value: &self._inviterID) }()
      case 8: try { try decoder.decodeSingularInt64Field(value: &self._inviteeID) }()
      default: break
      }
    }
  }
