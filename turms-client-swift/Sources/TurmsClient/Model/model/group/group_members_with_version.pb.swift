...
public struct GroupMembersWithVersion {
  ...
  public var groupMembers: [GroupMember] {
    get {return _storage._groupMembers}
    set {_uniqueStorage()._groupMembers = newValue}
  }
...
extension GroupMembersWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        switch fieldNumber {
        case 1: try decoder.decodeRepeatedMessageField(value: &_storage._groupMembers)
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      if !_storage._groupMembers.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._groupMembers, fieldNumber: 1)
      }
  ...
  public static func ==(lhs: GroupMembersWithVersion, rhs: GroupMembersWithVersion) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._groupMembers != rhs_storage._groupMembers {return false}
