...
extension PrivateConversation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularInt64Field(value: &self.ownerID)
      case 2: try decoder.decodeSingularInt64Field(value: &self.targetID)
      case 3: try decoder.decodeSingularInt64Field(value: &self.readDate)
      default: break
      }
    }
  }
