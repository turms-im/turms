...
public struct LongsWithVersion {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.

    public var longs: [Int64] = []
    ...
    extension LongsWithVersion: @unchecked Sendable {}
...
extension LongsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".LongsWithVersion"
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedInt64Field(value: &longs)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !longs.isEmpty {
            try visitor.visitPackedInt64Field(value: longs, fieldNumber: 1)
        }
    ...
    public static func == (lhs: LongsWithVersion, rhs: LongsWithVersion) -> Bool {
        if lhs.longs != rhs.longs { return false }
