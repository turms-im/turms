...
public struct StringsWithVersion {
    ...
    extension StringsWithVersion: @unchecked Sendable {}
...
extension StringsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".StringsWithVersion"
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !strings.isEmpty {
            try visitor.visitRepeatedStringField(value: strings, fieldNumber: 1)
        }
    ...
    public static func == (lhs: StringsWithVersion, rhs: StringsWithVersion) -> Bool {
