...
extension UserFriendRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try decoder.decodeSingularEnumField(value: &_requestStatus)
            case 5: try decoder.decodeSingularStringField(value: &_reason)
            case 6: try decoder.decodeSingularInt64Field(value: &_expirationDate)
