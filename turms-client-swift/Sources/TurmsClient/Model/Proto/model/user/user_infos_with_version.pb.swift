...
public struct UserInfosWithVersion {
    ...
    extension UserInfosWithVersion: @unchecked Sendable {}
...
extension UserInfosWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".UserInfosWithVersion"
    ...
    public static func == (lhs: UserInfosWithVersion, rhs: UserInfosWithVersion) -> Bool {
