...
public struct UsersInfosWithVersion {
    ...
    extension UsersInfosWithVersion: @unchecked Sendable {}
...
extension UsersInfosWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &userInfos)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !userInfos.isEmpty {
            try visitor.visitRepeatedMessageField(value: userInfos, fieldNumber: 1)
        }
