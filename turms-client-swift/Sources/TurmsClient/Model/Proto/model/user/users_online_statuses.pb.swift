...
public struct UsersOnlineStatuses {
    ...
    extension UsersOnlineStatuses: @unchecked Sendable {}
...
extension UsersOnlineStatuses: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &userStatuses)
            default: break
            }
        }
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !userStatuses.isEmpty {
            try visitor.visitRepeatedMessageField(value: userStatuses, fieldNumber: 1)
        }
