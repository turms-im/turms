...
extension MessagesWithTotal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try decoder.decodeSingularBoolField(value: &isGroupMessage)
            case 3: try decoder.decodeSingularInt64Field(value: &fromID)
            case 4: try decoder.decodeRepeatedMessageField(value: &messages)
            default: break
            }
        }
    }
