...
public struct GroupsWithVersion {
    ...
    extension GroupsWithVersion: @unchecked Sendable {}
...
extension GroupsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".GroupsWithVersion"
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &groups)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !groups.isEmpty {
            try visitor.visitRepeatedMessageField(value: groups, fieldNumber: 1)
        }
    ...
    public static func == (lhs: GroupsWithVersion, rhs: GroupsWithVersion) -> Bool {
