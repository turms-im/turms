...
public struct GroupInvitationsWithVersion {
    ...
    extension GroupInvitationsWithVersion: @unchecked Sendable {}
...
extension GroupInvitationsWithVersion: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &groupInvitations)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !groupInvitations.isEmpty {
            try visitor.visitRepeatedMessageField(value: groupInvitations, fieldNumber: 1)
        }
