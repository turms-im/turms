...
public struct QuerySignedPutUrlRequest {
    ...
    extension QuerySignedPutUrlRequest: @unchecked Sendable {}
...
extension QuerySignedPutUrlRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try try decoder.decodeSingularInt64Field(value: &contentLength)
            default: break
            }
        }
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if contentLength != 0 {
            try visitor.visitSingularInt64Field(value: contentLength, fieldNumber: 4)
        }
