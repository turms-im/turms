...
public struct QueryGroupsRequest {
    ...
    extension QueryGroupsRequest: @unchecked Sendable {}
...
extension QueryGroupsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedInt64Field(value: &groupIds)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !groupIds.isEmpty {
            try visitor.visitPackedInt64Field(value: groupIds, fieldNumber: 1)
        }
    ...
    public static func == (lhs: QueryGroupsRequest, rhs: QueryGroupsRequest) -> Bool {
