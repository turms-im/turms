...
public struct QueryGroupRequest {
    ...
    extension QueryGroupRequest: @unchecked Sendable {}
...
extension QueryGroupRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryGroupRequest"
    ...
    public static func == (lhs: QueryGroupRequest, rhs: QueryGroupRequest) -> Bool {
