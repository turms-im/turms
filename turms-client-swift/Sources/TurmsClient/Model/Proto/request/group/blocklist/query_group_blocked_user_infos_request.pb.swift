...
public struct QueryGroupBlockedUserInfosRequest {
    ...
    extension QueryGroupBlockedUserInfosRequest: @unchecked Sendable {}
...
extension QueryGroupBlockedUserInfosRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryGroupBlockedUserInfosRequest"
