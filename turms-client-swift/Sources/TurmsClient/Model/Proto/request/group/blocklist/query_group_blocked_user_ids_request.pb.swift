...
public struct QueryGroupBlockedUserIdsRequest {
    ...
    extension QueryGroupBlockedUserIdsRequest: @unchecked Sendable {}
...
extension QueryGroupBlockedUserIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryGroupBlockedUserIdsRequest"
    ...
    public static func == (lhs: QueryGroupBlockedUserIdsRequest, rhs: QueryGroupBlockedUserIdsRequest) -> Bool {
