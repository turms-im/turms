...
public struct UpdateGroupJoinRequestRequest {
    ...
    extension UpdateGroupJoinRequestRequest: @unchecked Sendable {}
...
extension UpdateGroupJoinRequestRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".UpdateGroupJoinRequestRequest"
    ...
    public static func == (lhs: UpdateGroupJoinRequestRequest, rhs: UpdateGroupJoinRequestRequest) -> Bool {
