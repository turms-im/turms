...
public struct CreateGroupInvitationRequest {
    ...
    extension CreateGroupInvitationRequest: @unchecked Sendable {}
...
extension CreateGroupInvitationRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try try decoder.decodeSingularInt64Field(value: &inviteeID)
            case 3: try try decoder.decodeSingularStringField(value: &content)
            default: break
            }
        }
    }
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if inviteeID != 0 {
            try visitor.visitSingularInt64Field(value: inviteeID, fieldNumber: 2)
        }
        if !content.isEmpty {
