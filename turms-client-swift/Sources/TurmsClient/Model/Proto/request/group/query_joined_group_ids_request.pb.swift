...
public struct QueryJoinedGroupIdsRequest {
    ...
    extension QueryJoinedGroupIdsRequest: @unchecked Sendable {}
...
extension QueryJoinedGroupIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryJoinedGroupIdsRequest"
    ...
    public static func == (lhs: QueryJoinedGroupIdsRequest, rhs: QueryJoinedGroupIdsRequest) -> Bool {
