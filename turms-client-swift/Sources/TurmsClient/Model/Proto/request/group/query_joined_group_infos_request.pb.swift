...
public struct QueryJoinedGroupInfosRequest {
    ...
    extension QueryJoinedGroupInfosRequest: @unchecked Sendable {}
...
extension QueryJoinedGroupInfosRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryJoinedGroupInfosRequest"
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try decoder.decodeSingularInt64Field(value: &_lastUpdatedDate)
    ...
    public static func == (lhs: QueryJoinedGroupInfosRequest, rhs: QueryJoinedGroupInfosRequest) -> Bool {
