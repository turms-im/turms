...
public struct CreateMeetingRequest {
    ...
    public var hasStartDate: Bool { return _startDate != nil }
    /// Clears the value of `startDate`. Subsequent reads from it will return its default value.
    public mutating func clearStartDate() { _startDate = nil }
    ...
    fileprivate var _startDate: Int64?
}

#if swift(>=5.5) && canImport(_Concurrency)
    extension CreateMeetingRequest: @unchecked Sendable {}
...
extension CreateMeetingRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".CreateMeetingRequest"
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 5: try decoder.decodeSingularStringField(value: &_password)
            case 6: try decoder.decodeSingularInt64Field(value: &_startDate)
    ...
    public static func == (lhs: CreateMeetingRequest, rhs: CreateMeetingRequest) -> Bool {
