...
public struct QueryFriendRequestsRequest {
    ...
    extension QueryFriendRequestsRequest: @unchecked Sendable {}
...
extension QueryFriendRequestsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeSingularBoolField(value: &areSentByMe)
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if areSentByMe != false {
            try visitor.visitSingularBoolField(value: areSentByMe, fieldNumber: 1)
        }
