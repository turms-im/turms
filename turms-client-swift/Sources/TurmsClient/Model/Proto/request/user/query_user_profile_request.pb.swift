...
public struct QueryUserProfileRequest {
    ...
    extension QueryUserProfileRequest: @unchecked Sendable {}
...
extension QueryUserProfileRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".QueryUserProfileRequest"
    ...
    public static func == (lhs: QueryUserProfileRequest, rhs: QueryUserProfileRequest) -> Bool {
