...
class StorageServiceTests: XCTestCase {
    ...
    func test_system() {
        ...
        TestUtil.assertCompleted("uploadAttachment_sendMessage_shouldReturnUrl", turmsClient.messageService.sendMessage(chatType: .private, toId: 2, text: "I've attached a picture").done {
            messageId = $0
        })
