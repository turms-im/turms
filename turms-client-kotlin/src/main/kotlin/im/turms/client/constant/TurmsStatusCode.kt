...
object TurmsStatusCode {
    ...
    // Group - Member
    const val NOT_OWNER_OR_MANAGER_TO_REMOVE_GROUP_MEMBER = 3400
    const val NOT_OWNER_TO_UPDATE_GROUP_MEMBER_INFO = 3401
    const val NOT_OWNER_OR_MANAGER_TO_UPDATE_GROUP_MEMBER_INFO = 3402
    const val NOT_MEMBER_TO_QUERY_MEMBER_INFO = 3403
    const val ADD_BLOCKED_USER_TO_GROUP = 3404
    const val ADD_BLOCKED_USER_TO_INACTIVE_GROUP = 3405
    const val ADD_USER_TO_INACTIVE_GROUP = 3406
    const val ADD_NEW_MEMBER_WITH_ROLE_HIGHER_THAN_REQUESTER = 3407
