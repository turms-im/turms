...
object ResponseStatusCode {
    ...
    const val GROUP_QUESTION_ANSWERER_HAS_BEEN_BLOCKED = 3304
    const val MEMBER_CANNOT_ANSWER_GROUP_QUESTION = 3305
    const val ANSWER_QUESTION_OF_INACTIVE_GROUP = 3306

    // Group - Member
    const val ADD_USER_TO_INACTIVE_GROUP = 3400
    const val ADD_NEW_MEMBER_WITH_ROLE_HIGHER_THAN_REQUESTER = 3401
    const val ADD_BLOCKED_USER_TO_GROUP = 3402
    const val ADD_BLOCKED_USER_TO_INACTIVE_GROUP = 3403
    const val NOT_OWNER_OR_MANAGER_TO_REMOVE_GROUP_MEMBER = 3404
    const val NOT_OWNER_TO_REMOVE_GROUP_OWNER_OR_MANAGER = 3405
    const val NOT_OWNER_TO_UPDATE_GROUP_MEMBER_INFO = 3406
    const val NOT_OWNER_OR_MANAGER_TO_UPDATE_GROUP_MEMBER_INFO = 3407
    const val NOT_MEMBER_TO_QUERY_MEMBER_INFO = 3408
    ...
    const val SEND_JOIN_REQUEST_TO_GROUP_DECLINING_REQUEST = 3605
    const val SEND_JOIN_REQUEST_TO_GROUP_REQUIRING_ANSWER_QUESTION = 3606
    const val RECALLING_GROUP_JOIN_REQUEST_IS_DISABLED = 3607
    ...
    const val REDUNDANT_GROUP_INVITATION = 3709
