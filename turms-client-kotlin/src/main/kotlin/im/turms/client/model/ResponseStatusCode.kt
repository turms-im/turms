...
object ResponseStatusCode {
    ...
    const val NOT_RELATED_USER_TO_UPDATE_PRIVATE_CONVERSATION_SETTING = 4200
    const val NOT_GROUP_MEMBER_TO_UPDATE_GROUP_CONVERSATION_SETTING = 4201
    ...
    // Search
    const val SEARCHING_USER_IS_DISABLED = 7100
    const val SEARCHING_GROUP_IS_DISABLED = 7200

    // Conference
    const val CONFERENCE_NOT_IMPLEMENTED = 8000

    // Conference - Meeting
    const val CREATE_MEETING_EXCEEDING_MAX_ACTIVE_MEETING_COUNT = 8100
    const val NOT_CREATOR_TO_CANCEL_MEETING = 8101
    const val CANCELING_MEETING_IS_DISABLED = 8102
    const val CANCEL_NONEXISTENT_MEETING = 8103
    const val NOT_CREATOR_TO_UPDATE_MEETING_PASSWORD = 8104
    const val UPDATE_INFO_OF_NONEXISTENT_MEETING = 8105

    const val ACCEPT_MEETING_INVITATION_WITH_WRONG_PASSWORD = 8200
    const val ACCEPT_MEETING_INVITATION_OF_CANCELED_MEETING = 8201
    const val ACCEPT_MEETING_INVITATION_OF_ENDED_MEETING = 8202
    const val ACCEPT_MEETING_INVITATION_OF_EXPIRED_MEETING = 8203
    const val ACCEPT_MEETING_INVITATION_OF_PENDING_MEETING = 8204
