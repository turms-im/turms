...
object ResponseStatusCode {
    ...
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_ACCESS_GROUP_QUESTION_ANSWER = 3303
    ...
    const val ADD_USER_TO_GROUP_WITH_ROLE_HIGHER_THAN_REQUESTER = 3402
    const val ADD_USER_TO_GROUP_WITH_SIZE_LIMIT_REACHED = 3403
    const val ADD_BLOCKED_USER_TO_GROUP = 3404
    const val ADD_BLOCKED_USER_TO_INACTIVE_GROUP = 3405
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_REMOVE_GROUP_MEMBER = 3406
    const val NOT_GROUP_OWNER_TO_REMOVE_GROUP_OWNER_OR_MANAGER = 3407
    const val NOT_GROUP_OWNER_TO_UPDATE_GROUP_MEMBER_ROLE = 3408
    const val UPDATE_GROUP_MEMBER_ROLE_OF_NONEXISTENT_GROUP = 3409
    const val NOT_GROUP_OWNER_TO_UPDATE_GROUP_MEMBER_INFO = 3410
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_UPDATE_GROUP_MEMBER_INFO = 3411
    const val NOT_GROUP_MEMBER_TO_UPDATE_GROUP_MEMBER_INFO = 3412
    const val UPDATE_GROUP_MEMBER_INFO_OF_NONEXISTENT_GROUP = 3413
    const val UPDATE_INFO_OF_NONEXISTENT_GROUP_MEMBER = 3414
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_MUTE_GROUP_MEMBER = 3415
    const val MUTE_GROUP_MEMBER_WITH_ROLE_EQUAL_TO_OR_HIGHER_THAN_REQUESTER = 3416
    const val MUTE_GROUP_MEMBER_OF_NONEXISTENT_GROUP = 3417
    const val MUTE_NONEXISTENT_GROUP_MEMBER = 3418
    const val NOT_GROUP_MEMBER_TO_QUERY_GROUP_MEMBER_INFO = 3419
    ...
    const val NOT_GROUP_JOIN_REQUEST_SENDER_TO_RECALL_REQUEST = 3601
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_ACCESS_GROUP_JOIN_REQUEST = 3602
    const val RECALL_NON_PENDING_GROUP_JOIN_REQUEST = 3603
    const val SEND_GROUP_JOIN_REQUEST_TO_INACTIVE_GROUP = 3604
    const val SEND_GROUP_JOIN_REQUEST_TO_GROUP_USING_MEMBERSHIP_REQUEST = 3605
    const val SEND_GROUP_JOIN_REQUEST_TO_GROUP_USING_INVITATION = 3606
    const val SEND_GROUP_JOIN_REQUEST_TO_GROUP_USING_QUESTION = 3607
    const val RECALLING_GROUP_JOIN_REQUEST_IS_DISABLED = 3608

    // Group - Invitation
    const val GROUP_INVITER_NOT_GROUP_MEMBER = 3700
    const val GROUP_INVITEE_ALREADY_GROUP_MEMBER = 3701
    const val GROUP_INVITEE_HAS_BEEN_BLOCKED_BY_GROUP = 3702
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_RECALL_GROUP_INVITATION = 3703
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_ACCESS_GROUP_INVITATION = 3704
    const val NOT_GROUP_OWNER_TO_SEND_GROUP_INVITATION = 3705
    const val NOT_GROUP_OWNER_OR_MANAGER_TO_SEND_GROUP_INVITATION = 3706
    const val NOT_GROUP_MEMBER_TO_SEND_GROUP_INVITATION = 3707
    ...
    const val GUESTS_HAVE_BEEN_MUTED = 5009
