...
public final class UserFriendRequestsWithVersion extends
        com.google.protobuf.GeneratedMessageLite<
                UserFriendRequestsWithVersion, UserFriendRequestsWithVersion.Builder> implements
     ...
     */
    @java.lang.Override
    public im.turms.client.model.proto.model.user.UserFriendRequest getUserFriendRequests(int index) {
    ...
    private void ensureUserFriendRequestsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.user.UserFriendRequest> tmp = userFriendRequests_;
        if (!tmp.isModifiable()) {
            userFriendRequests_ =
    ...
    private void setUserFriendRequests(
            int index, im.turms.client.model.proto.model.user.UserFriendRequest value) {
        value.getClass();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    private void addUserFriendRequests(im.turms.client.model.proto.model.user.UserFriendRequest value) {
        value.getClass();
        ensureUserFriendRequestsIsMutable();
    ...
    public static im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion parseFrom(java.io.InputStream input)
    ...
    public static im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<
                    im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion, Builder> implements
        ...
        // Construct using im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion.newBuilder()
        private Builder() {
        ...
        public java.util.List<im.turms.client.model.proto.model.user.UserFriendRequest> getUserFriendRequestsList() {
            return java.util.Collections.unmodifiableList(
                    instance.getUserFriendRequestsList());
        }
         ...
         */
        public Builder setUserFriendRequests(
                int index, im.turms.client.model.proto.model.user.UserFriendRequest.Builder builderForValue) {
            copyOnWrite();
            instance.setUserFriendRequests(index,
         ...
         * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
         */
        public Builder addUserFriendRequests(im.turms.client.model.proto.model.user.UserFriendRequest value) {
            copyOnWrite();
        ...
        public Builder addUserFriendRequests(
                int index, im.turms.client.model.proto.model.user.UserFriendRequest.Builder builderForValue) {
            copyOnWrite();
            instance.addUserFriendRequests(index,
                    builderForValue.build());
            return this;
        }
    ...
    protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion> parser = PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser =
                                    new DefaultInstanceBasedParser<im.turms.client.model.proto.model.user.UserFriendRequestsWithVersion>(
                                            DEFAULT_INSTANCE);
                            PARSER = parser;
                        }
                    }
    ...
    static {
        ...
        com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
                UserFriendRequestsWithVersion.class, defaultInstance);
    }
