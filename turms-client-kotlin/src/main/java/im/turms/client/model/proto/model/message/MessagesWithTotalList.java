...
public  final class MessagesWithTotalList extends
    com.google.protobuf.GeneratedMessageLite<
        MessagesWithTotalList, MessagesWithTotalList.Builder> implements
   ...
   */
  @java.lang.Override
  public im.turms.client.model.proto.model.message.MessagesWithTotal getMessagesWithTotalList(int index) {
  ...
  private void ensureMessagesWithTotalListIsMutable() {
    com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.message.MessagesWithTotal> tmp = messagesWithTotalList_;
    if (!tmp.isModifiable()) {
  ...
  private void setMessagesWithTotalList(
      int index, im.turms.client.model.proto.model.message.MessagesWithTotal value) {
    value.getClass();
   ...
   * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
   */
  private void addMessagesWithTotalList(im.turms.client.model.proto.model.message.MessagesWithTotal value) {
    value.getClass();
  ensureMessagesWithTotalListIsMutable();
  ...
  public static im.turms.client.model.proto.model.message.MessagesWithTotalList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static im.turms.client.model.proto.model.message.MessagesWithTotalList parseFrom(java.io.InputStream input)
  ...
  public static im.turms.client.model.proto.model.message.MessagesWithTotalList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(im.turms.client.model.proto.model.message.MessagesWithTotalList prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        im.turms.client.model.proto.model.message.MessagesWithTotalList, Builder> implements
    ...
    // Construct using im.turms.client.model.proto.model.message.MessagesWithTotalList.newBuilder()
    private Builder() {
    ...
    public java.util.List<im.turms.client.model.proto.model.message.MessagesWithTotal> getMessagesWithTotalListList() {
      return java.util.Collections.unmodifiableList(
          instance.getMessagesWithTotalListList());
    }
    /**
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
     ...
     */
    public Builder setMessagesWithTotalList(
        int index, im.turms.client.model.proto.model.message.MessagesWithTotal.Builder builderForValue) {
      copyOnWrite();
      instance.setMessagesWithTotalList(index,
     ...
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
    public Builder addMessagesWithTotalList(im.turms.client.model.proto.model.message.MessagesWithTotal value) {
      copyOnWrite();
    ...
    public Builder addMessagesWithTotalList(
        int index, im.turms.client.model.proto.model.message.MessagesWithTotal.Builder builderForValue) {
      copyOnWrite();
      instance.addMessagesWithTotalList(index,
          builderForValue.build());
      return this;
    }
    /**
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<im.turms.client.model.proto.model.message.MessagesWithTotalList> parser = PARSER;
        if (parser == null) {
          synchronized (im.turms.client.model.proto.model.message.MessagesWithTotalList.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<im.turms.client.model.proto.model.message.MessagesWithTotalList>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    ...
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      MessagesWithTotalList.class, defaultInstance);
  }
