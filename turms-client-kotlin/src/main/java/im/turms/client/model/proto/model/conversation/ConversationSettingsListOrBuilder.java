...
public interface ConversationSettingsListOrBuilder extends
     ...
     */
    java.util.List<im.turms.client.model.proto.model.conversation.ConversationSettings> getConversationSettingsListList();

    /**
     * <code>repeated .im.turms.proto.ConversationSettings conversation_settings_list = 1;</code>
     */
    im.turms.client.model.proto.model.conversation.ConversationSettings getConversationSettingsList(
            int index);
