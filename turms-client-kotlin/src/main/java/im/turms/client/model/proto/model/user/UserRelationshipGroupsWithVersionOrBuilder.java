...
public interface UserRelationshipGroupsWithVersionOrBuilder extends
     ...
     */
    java.util.List<im.turms.client.model.proto.model.user.UserRelationshipGroup> getUserRelationshipGroupsList();

    /**
     * <code>repeated .im.turms.proto.UserRelationshipGroup user_relationship_groups = 1;</code>
     */
    im.turms.client.model.proto.model.user.UserRelationshipGroup getUserRelationshipGroups(
            int index);
