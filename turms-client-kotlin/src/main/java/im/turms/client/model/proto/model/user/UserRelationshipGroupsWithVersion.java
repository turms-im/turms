...
public final class UserRelationshipGroupsWithVersion extends
        com.google.protobuf.GeneratedMessageLite<
                UserRelationshipGroupsWithVersion, UserRelationshipGroupsWithVersion.Builder> implements
     ...
     * <code>repeated .im.turms.proto.UserRelationshipGroup user_relationship_groups = 1;</code>
     */
    public java.util.List<? extends im.turms.client.model.proto.model.user.UserRelationshipGroupOrBuilder>
     ...
     */
    @java.lang.Override
    public im.turms.client.model.proto.model.user.UserRelationshipGroup getUserRelationshipGroups(int index) {
    ...
    private void ensureUserRelationshipGroupsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.user.UserRelationshipGroup> tmp = userRelationshipGroups_;
        if (!tmp.isModifiable()) {
    ...
    private void setUserRelationshipGroups(
            int index, im.turms.client.model.proto.model.user.UserRelationshipGroup value) {
        value.getClass();
     ...
     * <code>repeated .im.turms.proto.UserRelationshipGroup user_relationship_groups = 1;</code>
     */
    private void addUserRelationshipGroups(im.turms.client.model.proto.model.user.UserRelationshipGroup value) {
        value.getClass();
        ensureUserRelationshipGroupsIsMutable();
    ...
    public static im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion parseFrom(java.io.InputStream input)
    ...
    public static im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<
                    im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion, Builder> implements
        ...
        // Construct using im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion.newBuilder()
        private Builder() {
        ...
        public java.util.List<im.turms.client.model.proto.model.user.UserRelationshipGroup> getUserRelationshipGroupsList() {
            return java.util.Collections.unmodifiableList(
                    instance.getUserRelationshipGroupsList());
        }
         ...
         */
        public Builder setUserRelationshipGroups(
                int index, im.turms.client.model.proto.model.user.UserRelationshipGroup.Builder builderForValue) {
            copyOnWrite();
            instance.setUserRelationshipGroups(index,
         ...
         * <code>repeated .im.turms.proto.UserRelationshipGroup user_relationship_groups = 1;</code>
         */
        public Builder addUserRelationshipGroups(im.turms.client.model.proto.model.user.UserRelationshipGroup value) {
            copyOnWrite();
        ...
        public Builder addUserRelationshipGroups(
                int index, im.turms.client.model.proto.model.user.UserRelationshipGroup.Builder builderForValue) {
            copyOnWrite();
            instance.addUserRelationshipGroups(index,
                    builderForValue.build());
            return this;
        }
    ...
    protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion> parser = PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser =
                                    new DefaultInstanceBasedParser<im.turms.client.model.proto.model.user.UserRelationshipGroupsWithVersion>(
                                            DEFAULT_INSTANCE);
                            PARSER = parser;
                        }
                    }
    ...
    static {
        ...
        com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
                UserRelationshipGroupsWithVersion.class, defaultInstance);
    }
