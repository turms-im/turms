...
public final class Conversations extends
        com.google.protobuf.GeneratedMessageLite<
                Conversations, Conversations.Builder> implements
     ...
     */
    @java.lang.Override
    public im.turms.client.model.proto.model.conversation.PrivateConversation getPrivateConversations(int index) {
    ...
    private void ensurePrivateConversationsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.conversation.PrivateConversation> tmp = privateConversations_;
        if (!tmp.isModifiable()) {
    ...
    private void setPrivateConversations(
            int index, im.turms.client.model.proto.model.conversation.PrivateConversation value) {
        value.getClass();
     ...
     * <code>repeated .im.turms.proto.PrivateConversation private_conversations = 1;</code>
     */
    private void addPrivateConversations(im.turms.client.model.proto.model.conversation.PrivateConversation value) {
        value.getClass();
        ensurePrivateConversationsIsMutable();
     ...
     */
    @java.lang.Override
    public im.turms.client.model.proto.model.conversation.GroupConversation getGroupConversations(int index) {
    ...
    private void ensureGroupConversationsIsMutable() {
        com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.conversation.GroupConversation> tmp = groupConversations_;
        if (!tmp.isModifiable()) {
            groupConversations_ =
                    com.google.protobuf.GeneratedMessageLite.mutableCopy(tmp);
        }
    ...
    private void setGroupConversations(
            int index, im.turms.client.model.proto.model.conversation.GroupConversation value) {
        value.getClass();
     ...
     * <code>repeated .im.turms.proto.GroupConversation group_conversations = 2;</code>
     */
    private void addGroupConversations(im.turms.client.model.proto.model.conversation.GroupConversation value) {
        value.getClass();
        ensureGroupConversationsIsMutable();
    ...
    public static im.turms.client.model.proto.model.conversation.Conversations parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static im.turms.client.model.proto.model.conversation.Conversations parseFrom(java.io.InputStream input)
    ...
    public static im.turms.client.model.proto.model.conversation.Conversations parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static Builder newBuilder(im.turms.client.model.proto.model.conversation.Conversations prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<
                    im.turms.client.model.proto.model.conversation.Conversations, Builder> implements
        ...
        public java.util.List<im.turms.client.model.proto.model.conversation.PrivateConversation> getPrivateConversationsList() {
            return java.util.Collections.unmodifiableList(
                    instance.getPrivateConversationsList());
        }
         ...
         */
        public Builder setPrivateConversations(
                int index, im.turms.client.model.proto.model.conversation.PrivateConversation.Builder builderForValue) {
            copyOnWrite();
            instance.setPrivateConversations(index,
         ...
         * <code>repeated .im.turms.proto.PrivateConversation private_conversations = 1;</code>
         */
        public Builder addPrivateConversations(im.turms.client.model.proto.model.conversation.PrivateConversation value) {
            copyOnWrite();
        ...
        public Builder addPrivateConversations(
                int index, im.turms.client.model.proto.model.conversation.PrivateConversation.Builder builderForValue) {
            copyOnWrite();
            instance.addPrivateConversations(index,
                    builderForValue.build());
            return this;
        }
        ...
        public java.util.List<im.turms.client.model.proto.model.conversation.GroupConversation> getGroupConversationsList() {
            return java.util.Collections.unmodifiableList(
                    instance.getGroupConversationsList());
        }
         ...
         */
        public Builder setGroupConversations(
                int index, im.turms.client.model.proto.model.conversation.GroupConversation.Builder builderForValue) {
            copyOnWrite();
            instance.setGroupConversations(index,
                    builderForValue.build());
            return this;
        }
         ...
         * <code>repeated .im.turms.proto.GroupConversation group_conversations = 2;</code>
         */
        public Builder addGroupConversations(im.turms.client.model.proto.model.conversation.GroupConversation value) {
            copyOnWrite();
        ...
        public Builder addGroupConversations(
                int index, im.turms.client.model.proto.model.conversation.GroupConversation.Builder builderForValue) {
            copyOnWrite();
            instance.addGroupConversations(index,
                    builderForValue.build());
            return this;
        }
    ...
    protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.model.conversation.Conversations> parser = PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.model.conversation.Conversations.class) {
                        parser = PARSER;
                        if (parser == null) {
                            parser =
                                    new DefaultInstanceBasedParser<im.turms.client.model.proto.model.conversation.Conversations>(
                                            DEFAULT_INSTANCE);
                            PARSER = parser;
                        }
                    }
    ...
    static {
        ...
        com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
                Conversations.class, defaultInstance);
    }
