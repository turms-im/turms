...
public interface UsersOnlineStatusesOrBuilder extends
   ...
   */
  java.util.List<im.turms.client.model.proto.model.user.UserStatusDetail> 
      getUserStatusesList();
  /**
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
  im.turms.client.model.proto.model.user.UserStatusDetail getUserStatuses(int index);
  /**
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
