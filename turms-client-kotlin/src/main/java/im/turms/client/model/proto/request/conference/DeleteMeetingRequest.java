...
public final class DeleteMeetingRequest extends
    ...
    public static im.turms.client.model.proto.request.conference.DeleteMeetingRequest parseFrom(
    ...
    public static im.turms.client.model.proto.request.conference.DeleteMeetingRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            im.turms.client.model.proto.request.conference.DeleteMeetingRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<im.turms.client.model.proto.request.conference.DeleteMeetingRequest, Builder>
            implements
            // @@protoc_insertion_point(builder_implements:im.turms.proto.DeleteMeetingRequest)
            im.turms.client.model.proto.request.conference.DeleteMeetingRequestOrBuilder {
        // Construct using
    ...
    protected java.lang.Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new im.turms.client.model.proto.request.conference.DeleteMeetingRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.request.conference.DeleteMeetingRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.request.conference.DeleteMeetingRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final im.turms.client.model.proto.request.conference.DeleteMeetingRequest DEFAULT_INSTANCE;
    static {
    ...
    public static im.turms.client.model.proto.request.conference.DeleteMeetingRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
