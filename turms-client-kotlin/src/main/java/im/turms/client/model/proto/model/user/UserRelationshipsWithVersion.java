...
public  final class UserRelationshipsWithVersion extends
    com.google.protobuf.GeneratedMessageLite<
        UserRelationshipsWithVersion, UserRelationshipsWithVersion.Builder> implements
  ...
  private void ensureUserRelationshipsIsMutable() {
    com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.user.UserRelationship> tmp = userRelationships_;
    if (!tmp.isModifiable()) {
      userRelationships_ =
  ...
  private void setUserRelationships(
      int index, im.turms.client.model.proto.model.user.UserRelationship value) {
    value.getClass();
   ...
   * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
   */
  private void addUserRelationships(im.turms.client.model.proto.model.user.UserRelationship value) {
    value.getClass();
  ensureUserRelationshipsIsMutable();
  ...
  public static im.turms.client.model.proto.model.user.UserRelationshipsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static im.turms.client.model.proto.model.user.UserRelationshipsWithVersion parseFrom(java.io.InputStream input)
  ...
  public static im.turms.client.model.proto.model.user.UserRelationshipsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(im.turms.client.model.proto.model.user.UserRelationshipsWithVersion prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        im.turms.client.model.proto.model.user.UserRelationshipsWithVersion, Builder> implements
    ...
    // Construct using im.turms.client.model.proto.model.user.UserRelationshipsWithVersion.newBuilder()
    private Builder() {
    ...
    public java.util.List<im.turms.client.model.proto.model.user.UserRelationship> getUserRelationshipsList() {
      return java.util.Collections.unmodifiableList(
          instance.getUserRelationshipsList());
    }
    /**
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
     ...
     */
    public Builder setUserRelationships(
        int index, im.turms.client.model.proto.model.user.UserRelationship.Builder builderForValue) {
      copyOnWrite();
      instance.setUserRelationships(index,
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    public Builder addUserRelationships(im.turms.client.model.proto.model.user.UserRelationship value) {
      copyOnWrite();
    ...
    public Builder addUserRelationships(
        int index, im.turms.client.model.proto.model.user.UserRelationship.Builder builderForValue) {
      copyOnWrite();
      instance.addUserRelationships(index,
          builderForValue.build());
      return this;
    }
    /**
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<im.turms.client.model.proto.model.user.UserRelationshipsWithVersion> parser = PARSER;
        if (parser == null) {
          synchronized (im.turms.client.model.proto.model.user.UserRelationshipsWithVersion.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<im.turms.client.model.proto.model.user.UserRelationshipsWithVersion>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    ...
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      UserRelationshipsWithVersion.class, defaultInstance);
  }
