...
public final class QueryFriendRequestsRequest extends
    ...
    public static im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest parseFrom(
    ...
    public static im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest, Builder>
            implements
            // @@protoc_insertion_point(builder_implements:im.turms.proto.QueryFriendRequestsRequest)
            im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequestOrBuilder {
        // Construct using
    ...
    protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            case BUILD_MESSAGE_INFO: {
                java.lang.Object[] objects =
                        new java.lang.Object[]{"bitField0_", "areSentByMe_", "lastUpdatedDate_",};
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest DEFAULT_INSTANCE;
    ...
    public static im.turms.client.model.proto.request.user.relationship.QueryFriendRequestsRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }
