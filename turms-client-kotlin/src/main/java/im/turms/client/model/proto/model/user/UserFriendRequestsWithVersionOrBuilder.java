...
public interface UserFriendRequestsWithVersionOrBuilder extends
     ...
     */
    java.util.List<im.turms.client.model.proto.model.user.UserFriendRequest> getUserFriendRequestsList();

    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    im.turms.client.model.proto.model.user.UserFriendRequest getUserFriendRequests(int index);
