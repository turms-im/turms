 ...
 */
public final class QueryUserOnlineStatusesRequest extends
        com.google.protobuf.GeneratedMessageLite<QueryUserOnlineStatusesRequest, QueryUserOnlineStatusesRequest.Builder>
        implements
    ...
    public static im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest parseFrom(
    ...
    public static im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest prototype) {
    ...
    public static final class Builder extends
            com.google.protobuf.GeneratedMessageLite.Builder<im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest, Builder>
            implements
            // @@protoc_insertion_point(builder_implements:im.turms.proto.QueryUserOnlineStatusesRequest)
            im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequestOrBuilder {
        // Construct using
        // im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest.newBuilder()
        private Builder() {
    ...
    protected final java.lang.Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest();
            }
            case NEW_BUILDER: {
                return new Builder();
            }
            ...
            case GET_PARSER: {
                com.google.protobuf.Parser<im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest> parser =
                        PARSER;
                if (parser == null) {
                    synchronized (im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest.class) {
                        parser = PARSER;
                        if (parser == null) {
    ...
    private static final im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest DEFAULT_INSTANCE;

    static {
        QueryUserOnlineStatusesRequest defaultInstance = new QueryUserOnlineStatusesRequest();
        // New instances are implicitly immutable so no need to make
        // immutable.
        DEFAULT_INSTANCE = defaultInstance;
        com.google.protobuf.GeneratedMessageLite
                .registerDefaultInstance(QueryUserOnlineStatusesRequest.class, defaultInstance);
    }

    public static im.turms.client.model.proto.request.user.QueryUserOnlineStatusesRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    private static volatile com.google.protobuf.Parser<QueryUserOnlineStatusesRequest> PARSER;
