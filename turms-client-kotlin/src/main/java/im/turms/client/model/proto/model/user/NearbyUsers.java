...
public  final class NearbyUsers extends
    com.google.protobuf.GeneratedMessageLite<
        NearbyUsers, NearbyUsers.Builder> implements
  ...
  private void ensureNearbyUsersIsMutable() {
    com.google.protobuf.Internal.ProtobufList<im.turms.client.model.proto.model.user.NearbyUser> tmp = nearbyUsers_;
    if (!tmp.isModifiable()) {
      nearbyUsers_ =
  ...
  private void setNearbyUsers(
      int index, im.turms.client.model.proto.model.user.NearbyUser value) {
    value.getClass();
  ...
  public static im.turms.client.model.proto.model.user.NearbyUsers parseFrom(java.io.InputStream input)
  ...
  public static im.turms.client.model.proto.model.user.NearbyUsers parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        im.turms.client.model.proto.model.user.NearbyUsers, Builder> implements
     ...
     */
    public Builder setNearbyUsers(
        int index, im.turms.client.model.proto.model.user.NearbyUser.Builder builderForValue) {
      copyOnWrite();
      instance.setNearbyUsers(index,
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<im.turms.client.model.proto.model.user.NearbyUsers> parser = PARSER;
        if (parser == null) {
          synchronized (im.turms.client.model.proto.model.user.NearbyUsers.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<im.turms.client.model.proto.model.user.NearbyUsers>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    ...
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      NearbyUsers.class, defaultInstance);
  }
