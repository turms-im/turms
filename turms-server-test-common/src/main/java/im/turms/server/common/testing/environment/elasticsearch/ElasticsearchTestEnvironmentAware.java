 ...
 * @author James Chen
 */
public interface ElasticsearchTestEnvironmentAware extends ServiceTestEnvironmentAware {

    default ServiceTestEnvironmentType getElasticsearchTestEnvironmentType() {
        throw new UnsupportedOperationException();
    }

    default boolean isElasticsearchRunning() {
        return isRunning();
    }
    ...
    default String getElasticsearchUri() {
        return getElasticsearchHost()
                + ":"
