...
class Conversations extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Conversations', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'im.turms.proto'), createEmptyInstance: create)
    ..pc<$0.PrivateConversation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateConversations', $pb.PbFieldType.PM, subBuilder: $0.PrivateConversation.create)
    ..pc<$1.GroupConversation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupConversations', $pb.PbFieldType.PM, subBuilder: $1.GroupConversation.create)
  ...
  'Will be removed in next major version')
  Conversations copyWith(void Function(Conversations) updates) => super.copyWith((message) => updates(message as Conversations)) as Conversations; // ignore: deprecated_member_use
