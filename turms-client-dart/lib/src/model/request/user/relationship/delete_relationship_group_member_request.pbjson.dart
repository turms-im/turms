...
const DeleteRelationshipGroupMemberRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target_group_index', '3': 3, '4': 1, '5': 5, '9': 0, '10': 'targetGroupIndex', '17': true},
  ],
  '8': const [
...
final $typed_data.Uint8List deleteRelationshipGroupMemberRequestDescriptor = $convert.base64Decode('CiREZWxldGVSZWxhdGlvbnNoaXBHcm91cE1lbWJlclJlcXVlc3QSFwoHdXNlcl9pZBgBIAEoA1IGdXNlcklkEh8KC2dyb3VwX2luZGV4GAIgASgFUgpncm91cEluZGV4EjEKEnRhcmdldF9ncm91cF9pbmRleBgDIAEoBUgAUhB0YXJnZXRHcm91cEluZGV4iAEBQhUKE190YXJnZXRfZ3JvdXBfaW5kZXg=');
