...
class CreateSessionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateSessionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'im.turms.proto'), createEmptyInstance: create)
    ...
    ..e<$1.UserStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.UserStatus.AVAILABLE, valueOf: $1.UserStatus.valueOf, enumValues: $1.UserStatus.values)
    ..e<$2.DeviceType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceType', $pb.PbFieldType.OE, defaultOrMaker: $2.DeviceType.DESKTOP, valueOf: $2.DeviceType.valueOf, enumValues: $2.DeviceType.values)
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceDetails', entryClassName: 'CreateSessionRequest.DeviceDetailsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('im.turms.proto'))
    ..aOM<$0.UserLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $0.UserLocation.create)
  ...
  @$pb.TagNumber(4)
  set userStatus($1.UserStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set deviceType($2.DeviceType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set location($0.UserLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
