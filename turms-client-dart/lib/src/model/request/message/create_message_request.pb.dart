...
class CreateMessageRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateMessageRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'im.turms.proto'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageId')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isSystemMessage')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupId')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recipientId')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliveryDate')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..p<$core.List<$core.int>>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'records', $pb.PbFieldType.PY)
    ..a<$core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'burnAfter', $pb.PbFieldType.O3)
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preMessageId')
  ...
  @$pb.TagNumber(2)
  set isSystemMessage($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set recipientId($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set deliveryDate($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set burnAfter($core.int v) { $_setSignedInt32(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set preMessageId($fixnum.Int64 v) { $_setInt64(8, v); }
  @$pb.TagNumber(9)
