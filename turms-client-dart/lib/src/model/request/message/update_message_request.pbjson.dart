...
const UpdateMessageRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'recall_date', '3': 4, '4': 1, '5': 3, '9': 1, '10': 'recallDate', '17': true},
  ],
  '8': const [
    const {'1': '_text'},
...
final $typed_data.Uint8List updateMessageRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVNZXNzYWdlUmVxdWVzdBIdCgptZXNzYWdlX2lkGAEgASgDUgltZXNzYWdlSWQSFwoEdGV4dBgCIAEoCUgAUgR0ZXh0iAEBEhgKB3JlY29yZHMYAyADKAxSB3JlY29yZHMSJAoLcmVjYWxsX2RhdGUYBCABKANIAVIKcmVjYWxsRGF0ZYgBAUIHCgVfdGV4dEIOCgxfcmVjYWxsX2RhdGU=');
