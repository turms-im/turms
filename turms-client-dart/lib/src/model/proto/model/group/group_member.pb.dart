...
class GroupMember extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GroupMember', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'im.turms.proto'), createEmptyInstance: create)
    ...
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'joinDate')
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'muteEndDate')
    ..e<$1.UserStatus>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.UserStatus.AVAILABLE, valueOf: $1.UserStatus.valueOf, enumValues: $1.UserStatus.values)
    ..pc<$2.DeviceType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usingDeviceTypes', $pb.PbFieldType.PE, valueOf: $2.DeviceType.valueOf, enumValues: $2.DeviceType.values)
  ...
  @$pb.TagNumber(5)
  set joinDate($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set userStatus($1.UserStatus v) { setField(7, v); }
  @$pb.TagNumber(7)
