...
class GroupJoinQuestionsWithVersion extends $pb.GeneratedMessage {
  factory GroupJoinQuestionsWithVersion({
    ...
    if (groupJoinQuestions != null) {
      $result.groupJoinQuestions.addAll(groupJoinQuestions);
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GroupJoinQuestionsWithVersion',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'im.turms.proto'),
      createEmptyInstance: create)
    ..pc<$0.GroupJoinQuestion>(
        1, _omitFieldNames ? '' : 'groupJoinQuestions', $pb.PbFieldType.PM,
