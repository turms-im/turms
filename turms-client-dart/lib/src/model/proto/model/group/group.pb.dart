...
class Group extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Group', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'im.turms.proto'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeId')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creatorId')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerId')
  ...
  @$pb.TagNumber(2)
  set typeId($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set intro($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set announcement($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set creationDate($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
