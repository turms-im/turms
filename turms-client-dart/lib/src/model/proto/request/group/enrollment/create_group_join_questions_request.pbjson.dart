...
const CreateGroupJoinQuestionsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'questions', '3': 2, '4': 3, '5': 11, '6': '.im.turms.proto.GroupJoinQuestion', '10': 'questions'},
  ],
};

/// Descriptor for `CreateGroupJoinQuestionsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createGroupJoinQuestionsRequestDescriptor = $convert.base64Decode('Ch9DcmVhdGVHcm91cEpvaW5RdWVzdGlvbnNSZXF1ZXN0EhkKCGdyb3VwX2lkGAEgASgDUgdncm91cElkEj8KCXF1ZXN0aW9ucxgCIAMoCzIhLmltLnR1cm1zLnByb3RvLkdyb3VwSm9pblF1ZXN0aW9uUglxdWVzdGlvbnM=');
