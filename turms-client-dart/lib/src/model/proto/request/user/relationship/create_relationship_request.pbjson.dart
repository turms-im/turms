...
const CreateRelationshipRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'group_index', '3': 3, '4': 1, '5': 5, '9': 0, '10': 'groupIndex', '17': true},
  ],
  '8': const [
...
final $typed_data.Uint8List createRelationshipRequestDescriptor = $convert.base64Decode('ChlDcmVhdGVSZWxhdGlvbnNoaXBSZXF1ZXN0EhcKB3VzZXJfaWQYASABKANSBnVzZXJJZBIYCgdibG9ja2VkGAIgASgIUgdibG9ja2VkEiQKC2dyb3VwX2luZGV4GAMgASgFSABSCmdyb3VwSW5kZXiIAQFCDgoMX2dyb3VwX2luZGV4');
