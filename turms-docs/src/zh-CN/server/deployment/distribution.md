...
* Turms服务端只需要很少的线程就能正常运行，因此运维人员一般无需再专门为Turms服务端修改`noproc`配置。
  ...
  关于为什么Turms服务端只需要很少的线程就能正常运行，读者可以阅读[Turms服务端线程模型](https://turms-im.github.io/docs/zh-CN/server/module/system-resource-management.html#%E7%BA%BF%E7%A8%8B%E6%A8%A1%E5%9E%8B)
