...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return im.turms.server.common.access.client.dto.model.user.UserOnlineStatusesOuterClass.internal_static_im_turms_proto_UserOnlineStatuses_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses.class, im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends im.turms.server.common.access.client.dto.model.user.UserOnlineStatusOrBuilder>
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.user.UserOnlineStatus getStatuses(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses other = (im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses) obj;
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses.newBuilder()
    private Builder() {
    ...
    public im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses build() {
      im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses result = buildPartial();
    ...
    public im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses buildPartial() {
      im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses result = new im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses) {
        return mergeFrom((im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses other) {
      if (other == im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses.getDefaultInstance()) return this;
      if (statusesBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              im.turms.server.common.access.client.dto.model.user.UserOnlineStatus m =
                  input.readMessage(
                      im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.parser(),
                      extensionRegistry);
              if (statusesBuilder_ == null) {
                ensureStatusesIsMutable();
                statuses_.add(m);
    ...
    private void ensureStatusesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        statuses_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.user.UserOnlineStatus>(statuses_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.user.UserOnlineStatus, im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder, im.turms.server.common.access.client.dto.model.user.UserOnlineStatusOrBuilder> statusesBuilder_;
    ...
    public Builder setStatuses(
        int index, im.turms.server.common.access.client.dto.model.user.UserOnlineStatus value) {
      if (statusesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setStatuses(
        int index, im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder builderForValue) {
      if (statusesBuilder_ == null) {
        ensureStatusesIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserOnlineStatus statuses = 1;</code>
     */
    public Builder addStatuses(im.turms.server.common.access.client.dto.model.user.UserOnlineStatus value) {
      if (statusesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder addStatusesBuilder() {
      return getStatusesFieldBuilder().addBuilder(
          im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserOnlineStatus statuses = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder addStatusesBuilder(
        int index) {
      return getStatusesFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserOnlineStatus statuses = 1;</code>
     */
    public java.util.List<im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder>
         getStatusesBuilderList() {
      return getStatusesFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.user.UserOnlineStatus, im.turms.server.common.access.client.dto.model.user.UserOnlineStatus.Builder, im.turms.server.common.access.client.dto.model.user.UserOnlineStatusOrBuilder>
  ...
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.user.UserOnlineStatuses();
  }
  ...
  private static final com.google.protobuf.Parser<UserOnlineStatuses>
      PARSER = new com.google.protobuf.AbstractParser<UserOnlineStatuses>() {
    @java.lang.Override
