...
public enum TurmsStatusCode {
    ...
    NOT_OWNER_OR_MANAGER_TO_ACCESS_GROUP_QUESTION_ANSWER(3303, "Only the owner and managers of the group can access group question answers", 403),
    ...
    NOT_OWNER_OR_MANAGER_TO_UPDATE_GROUP_MEMBER_INFO(3402, "Only the owner and managers of the group can update the group member's information", 403),
