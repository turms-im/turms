...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userFriendRequests_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.user.UserFriendRequest>();
              mutable_bitField0_ |= 0x00000001;
            }
            userFriendRequests_.add(
                input.readMessage(im.turms.server.common.access.client.dto.model.user.UserFriendRequest.parser(), extensionRegistry));
            break;
          }
          case 16: {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersionOuterClass.internal_static_im_turms_proto_UserFriendRequestsWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion.class, im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends im.turms.server.common.access.client.dto.model.user.UserFriendRequestOrBuilder> 
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.user.UserFriendRequest getUserFriendRequests(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion other = (im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion) obj;
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion.newBuilder()
    private Builder() {
    ...
    public im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion build() {
      im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion result = buildPartial();
    ...
    public im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion buildPartial() {
      im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion result = new im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion) {
        return mergeFrom((im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion other) {
      if (other == im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion.getDefaultInstance()) return this;
      if (userFriendRequestsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion) e.getUnfinishedMessage();
    ...
    private void ensureUserFriendRequestsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userFriendRequests_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.user.UserFriendRequest>(userFriendRequests_);
        bitField0_ |= 0x00000001;
       }
    }
    ...
    public Builder setUserFriendRequests(
        int index, im.turms.server.common.access.client.dto.model.user.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserFriendRequests(
        int index, im.turms.server.common.access.client.dto.model.user.UserFriendRequest.Builder builderForValue) {
      if (userFriendRequestsBuilder_ == null) {
        ensureUserFriendRequestsIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public Builder addUserFriendRequests(im.turms.server.common.access.client.dto.model.user.UserFriendRequest value) {
      if (userFriendRequestsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public im.turms.server.common.access.client.dto.model.user.UserFriendRequest.Builder addUserFriendRequestsBuilder() {
      return getUserFriendRequestsFieldBuilder().addBuilder(
          im.turms.server.common.access.client.dto.model.user.UserFriendRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.user.UserFriendRequest.Builder addUserFriendRequestsBuilder(
        int index) {
      return getUserFriendRequestsFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.user.UserFriendRequest.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserFriendRequest user_friend_requests = 1;</code>
     */
    public java.util.List<im.turms.server.common.access.client.dto.model.user.UserFriendRequest.Builder> 
         getUserFriendRequestsBuilderList() {
      return getUserFriendRequestsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.user.UserFriendRequest, im.turms.server.common.access.client.dto.model.user.UserFriendRequest.Builder, im.turms.server.common.access.client.dto.model.user.UserFriendRequestOrBuilder> 
        getUserFriendRequestsFieldBuilder() {
      if (userFriendRequestsBuilder_ == null) {
  ...
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.user.UserFriendRequestsWithVersion();
  }
