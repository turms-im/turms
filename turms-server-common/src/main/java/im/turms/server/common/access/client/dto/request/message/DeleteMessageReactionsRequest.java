...
/**
 * Protobuf type {@code im.turms.proto.DeleteMessageReactionsRequest}
 */
public final class DeleteMessageReactionsRequest extends com.google.protobuf.GeneratedMessage
        implements
        // @@protoc_insertion_point(message_implements:im.turms.proto.DeleteMessageReactionsRequest)
        DeleteMessageReactionsRequestOrBuilder {
    ...
    static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
                ...
                /* patch= */ 2,
                /* suffix= */ "",
                DeleteMessageReactionsRequest.class.getName());
    }

    // Use DeleteMessageReactionsRequest.newBuilder() to construct.
    private DeleteMessageReactionsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
    }

    private DeleteMessageReactionsRequest() {
        reactionTypes_ = emptyIntList();
        customAttributes_ = java.util.Collections.emptyList();
    }

    public static com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequestOuterClass.internal_static_im_turms_proto_DeleteMessageReactionsRequest_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
        return im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequestOuterClass.internal_static_im_turms_proto_DeleteMessageReactionsRequest_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest.class,
                        im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest.Builder.class);
    }
    ...
    public static final int REACTION_TYPES_FIELD_NUMBER = 2;
    @SuppressWarnings("serial")
    private com.google.protobuf.Internal.IntList reactionTypes_ = emptyIntList();
     ...
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer> getReactionTypesList() {
        return reactionTypes_;
    }
     ...
     */
    public int getReactionTypes(int index) {
        return reactionTypes_.getInt(index);
    }

    private int reactionTypesMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        if (!getReactionTypesList().isEmpty()) {
            output.writeUInt32NoTag(18);
            output.writeUInt32NoTag(reactionTypesMemoizedSerializedSize);
        }
        for (int i = 0; i < reactionTypes_.size(); i++) {
            output.writeInt32NoTag(reactionTypes_.getInt(i));
        }
        ...
        }
        {
            ...
            for (int i = 0; i < reactionTypes_.size(); i++) {
                dataSize += com.google.protobuf.CodedOutputStream
                        .computeInt32SizeNoTag(reactionTypes_.getInt(i));
            }
            size += dataSize;
            if (!getReactionTypesList().isEmpty()) {
                size += 1;
            ...
            reactionTypesMemoizedSerializedSize = dataSize;
        }
        for (im.turms.server.common.access.client.dto.model.common.Value value : customAttributes_) {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof DeleteMessageReactionsRequest other)) {
    ...
    public int hashCode() {
        ...
        if (getReactionTypesCount() > 0) {
            hash = (37 * hash) + REACTION_TYPES_FIELD_NUMBER;
            hash = (53 * hash) + getReactionTypesList().hashCode();
        }
    ...
    public static im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest parseFrom(
    ...
    public static im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest parseDelimitedFrom(
            java.io.InputStream input) throws java.io.IOException {
    ...
    public static Builder newBuilder(
            im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest prototype) {
        return DEFAULT_INSTANCE.toBuilder()
                .mergeFrom(prototype);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            implements
            // @@protoc_insertion_point(builder_implements:im.turms.proto.DeleteMessageReactionsRequest)
            im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequestOrBuilder {
        public static com.google.protobuf.Descriptors.Descriptor getDescriptor() {
            return im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequestOuterClass.internal_static_im_turms_proto_DeleteMessageReactionsRequest_descriptor;
        }
        ...
        // Construct using
        // im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest getDefaultInstanceForType() {
            return im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest
                    .getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest build() {
            im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest result =
                    buildPartial();
        ...
        @java.lang.Override
        public im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest buildPartial() {
            im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest result =
                    new im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest(
                            this);
        ...
        private void buildPartial0(
            ...
            if (((from_bitField0_ & 0x00000002) != 0)) {
                reactionTypes_.makeImmutable();
                result.reactionTypes_ = reactionTypes_;
            }
        }

        @java.lang.Override
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest) {
                return mergeFrom(
                        (im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest) other);
            } else {
        ...
        public Builder mergeFrom(
                im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest other) {
            if (other == im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest
                    .getDefaultInstance()) {
                return this;
            }
            ...
            if (!other.reactionTypes_.isEmpty()) {
                if (reactionTypes_.isEmpty()) {
                    reactionTypes_ = other.reactionTypes_;
                    reactionTypes_.makeImmutable();
                    bitField0_ |= 0x00000002;
                } else {
                    ensureReactionTypesIsMutable();
                    reactionTypes_.addAll(other.reactionTypes_);
                }
                onChanged();
            }
            if (customAttributesBuilder_ == null) {
                    ...
                    switch (tag) {
                        ...
                        case 18 -> {
                            ...
                            while (input.getBytesUntilLimit() > 0) {
                                reactionTypes_.addInt(input.readInt32());
                            }
        ...
        private void ensureReactionTypesIsMutable() {
            if (!reactionTypes_.isModifiable()) {
                reactionTypes_ = makeMutableCopy(reactionTypes_);
            }
            bitField0_ |= 0x00000002;
        }
         ...
         * @param value The reactionTypes to set.
         * @return This builder for chaining.
         */
        public Builder setReactionTypes(int index, int value) {

            ensureReactionTypesIsMutable();
            reactionTypes_.setInt(index, value);
            bitField0_ |= 0x00000002;
            onChanged();
            return this;
        }
         ...
         * <code>repeated int32 reaction_types = 2;</code>
         *
         * @param value The reactionTypes to add.
         * @return This builder for chaining.
         */
        public Builder addReactionTypes(int value) {

            ensureReactionTypesIsMutable();
            reactionTypes_.addInt(value);
            bitField0_ |= 0x00000002;
            onChanged();
            return this;
        }
         ...
         * <code>repeated int32 reaction_types = 2;</code>
         *
         * @param values The reactionTypes to add.
         * @return This builder for chaining.
         */
        public Builder addAllReactionTypes(java.lang.Iterable<? extends java.lang.Integer> values) {
            ensureReactionTypesIsMutable();
            com.google.protobuf.AbstractMessageLite.Builder.addAll(values, reactionTypes_);
            bitField0_ |= 0x00000002;
            onChanged();
            return this;
        }
        ...
        // @@protoc_insertion_point(builder_scope:im.turms.proto.DeleteMessageReactionsRequest)
    }

    // @@protoc_insertion_point(class_scope:im.turms.proto.DeleteMessageReactionsRequest)
    private static final im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest DEFAULT_INSTANCE;
    static {
        DEFAULT_INSTANCE =
                new im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest();
    }

    public static im.turms.server.common.access.client.dto.request.message.DeleteMessageReactionsRequest getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<DeleteMessageReactionsRequest> PARSER =
            new com.google.protobuf.AbstractParser<>() {
                @java.lang.Override
                public DeleteMessageReactionsRequest parsePartialFrom(
                        com.google.protobuf.CodedInputStream input,
                        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
                        throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static com.google.protobuf.Parser<DeleteMessageReactionsRequest> parser() {
        return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<DeleteMessageReactionsRequest> getParserForType() {
        return PARSER;
    }
