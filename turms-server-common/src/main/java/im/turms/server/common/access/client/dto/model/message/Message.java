...
public final class Message extends
    ...
    public static final class Builder extends
        ...
        public Builder mergeFrom(im.turms.server.common.access.client.dto.model.message.Message other) {
            if (other == im.turms.server.common.access.client.dto.model.message.Message.getDefaultInstance()) {
                return this;
            }
            if (other.hasId()) {
                setId(other.getId());
