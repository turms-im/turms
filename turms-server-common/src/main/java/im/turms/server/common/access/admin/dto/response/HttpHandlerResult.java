...
public record HttpHandlerResult<T>(
    ...
    public static final HttpHandlerResult<Void> OK = new HttpHandlerResult<>(HttpResponseStatus.OK, null, null);
    ...
    public static final HttpHandlerResult<ResponseDTO<Void>> RESPONSE_NO_CONTENT = HttpHandlerResult
            .create(ResponseStatusCode.NO_CONTENT.getHttpStatusCode(), new ResponseDTO<>(ResponseStatusCode.NO_CONTENT, null));
    ...
    public static <T> HttpHandlerResult<T> create(int status,
                                                  @Nullable Map<String, String> headers,
                                                  @Nullable T body) {
    ...
    public static <T> HttpHandlerResult<ResponseDTO<PaginationDTO<T>>> page(long total, Collection<T> data) {
        if (total <= 0) {
    ...
    public static Mono<HttpHandlerResult<ResponseDTO<UpdateResultDTO>>> updateResult(Mono<UpdateResult> data) {
    ...
    public static Mono<HttpHandlerResult<ResponseDTO<DeleteResultDTO>>> deleteResult(Mono<DeleteResult> data) {
    ...
    public static <T> Mono<HttpHandlerResult<ResponseDTO<Collection<T>>>> okIfTruthy(Flux<T> data, int estimatedSize) {
        return data
    ...
    public static <T> Mono<HttpHandlerResult<ResponseDTO<T>>> okIfTruthy(Mono<T> dataMono) {
        return dataMono
                .map(data -> HttpHandlerResult.create(HttpResponseStatus.OK, new ResponseDTO<>(ResponseStatusCode.OK, data)))
    ...
    public static <T> HttpHandlerResult<ResponseDTO<T>> okIfTruthy(T data) {
        ...
        return HttpHandlerResult.create(HttpResponseStatus.OK, new ResponseDTO<>(ResponseStatusCode.OK, data));
    }
