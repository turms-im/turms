...
public interface UserRelationshipsWithVersionOrBuilder extends
     ...
     */
    java.util.List<im.turms.server.common.access.client.dto.model.user.UserRelationship> getUserRelationshipsList();

    /**
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    im.turms.server.common.access.client.dto.model.user.UserRelationship getUserRelationships(
            int index);
     ...
     * <code>repeated .im.turms.proto.UserRelationship user_relationships = 1;</code>
     */
    java.util.List<? extends im.turms.server.common.access.client.dto.model.user.UserRelationshipOrBuilder> getUserRelationshipsOrBuilderList();
