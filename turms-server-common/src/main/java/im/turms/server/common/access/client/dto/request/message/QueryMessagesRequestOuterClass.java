...
public final class QueryMessagesRequestOuterClass {
    ...
    static {
        ...
        internal_static_im_turms_proto_QueryMessagesRequest_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_im_turms_proto_QueryMessagesRequest_descriptor,
                new java.lang.String[]{"Ids", "AreGroupMessages", "AreSystemMessages", "FromIds", "DeliveryDateAfter", "DeliveryDateBefore", "MaxCount", "WithTotal", "AreGroupMessages",
                        "AreSystemMessages", "DeliveryDateAfter", "DeliveryDateBefore", "MaxCount",});
    }
