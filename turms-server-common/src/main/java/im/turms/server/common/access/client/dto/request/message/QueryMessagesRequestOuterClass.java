...
public final class QueryMessagesRequestOuterClass {
    ...
    static {
        ...
        internal_static_im_turms_proto_QueryMessagesRequest_fieldAccessorTable = new
                com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
                internal_static_im_turms_proto_QueryMessagesRequest_descriptor,
                new java.lang.String[]{"Ids", "AreGroupMessages", "AreSystemMessages", "FromIds", "DeliveryDateStart", "DeliveryDateEnd", "MaxCount", "WithTotal", "Descending", "AreGroupMessages", "AreSystemMessages", "DeliveryDateStart", "DeliveryDateEnd", "MaxCount", "Descending",});
    }
