...
public final class UpdateMessageAttachmentInfoRequest extends
    ...
    private UpdateMessageAttachmentInfoRequest(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }
    ...
    public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(1, attachmentIdNum_);
        }
        if (((bitField0_ & 0x00000002) != 0)) {
        ...
        if (((bitField0_ & 0x00000004) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(3, userIdToShareWith_);
        }
        if (((bitField0_ & 0x00000008) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(4, userIdToUnshareWith_);
        }
        if (((bitField0_ & 0x00000010) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(5, groupIdToShareWith_);
        }
        if (((bitField0_ & 0x00000020) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(6, groupIdToUnshareWith_);
        }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (hasAttachmentIdNum()) {
            if (getAttachmentIdNum()
                != other.getAttachmentIdNum()) {
                return false;
            }
        }
        ...
        if (hasAttachmentIdStr()) {
            if (!getAttachmentIdStr()
                    .equals(other.getAttachmentIdStr())) {
                return false;
            }
        }
        ...
        if (hasUserIdToShareWith()) {
            if (getUserIdToShareWith()
                != other.getUserIdToShareWith()) {
                return false;
            }
        }
        ...
        if (hasUserIdToUnshareWith()) {
            if (getUserIdToUnshareWith()
                != other.getUserIdToUnshareWith()) {
                return false;
            }
        }
        ...
        if (hasGroupIdToShareWith()) {
            if (getGroupIdToShareWith()
                != other.getGroupIdToShareWith()) {
                return false;
            }
        }
        ...
        if (hasGroupIdToUnshareWith()) {
            if (getGroupIdToUnshareWith()
                != other.getGroupIdToUnshareWith()) {
                return false;
            }
        }
    ...
    public static im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest prototype) {
    ...
    public static final class Builder extends
        ...
        public im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest getDefaultInstanceForType() {
            return im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest.getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest build() {
            im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest result = buildPartial();
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest) {
                return mergeFrom((im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest) other);
            } else {
        ...
        public Builder mergeFrom(im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest other) {
            if (other == im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest.getDefaultInstance()) {
                return this;
            }
         ...
         * @return This builder for chaining.
         */
        public Builder setAttachmentIdStr(
         ...
         * @return This builder for chaining.
         */
        public Builder setAttachmentIdStrBytes(
    ...
    static {
        DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.request.storage.UpdateMessageAttachmentInfoRequest();
    }
