...
public final class UpdateGroupRequest extends
    ...
    public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeBoolSize(2, quitAfterTransfer_);
        }
        if (((bitField0_ & 0x00000002) != 0)) {
        ...
        if (((bitField0_ & 0x00000040) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(8, muteEndDate_);
        }
        if (((bitField0_ & 0x00000080) != 0)) {
            size += com.google.protobuf.CodedOutputStream
                    .computeInt64Size(9, successorId_);
        }
    ...
    public static final class Builder extends
        ...
        public Builder mergeFrom(im.turms.server.common.access.client.dto.request.group.UpdateGroupRequest other) {
            if (other == im.turms.server.common.access.client.dto.request.group.UpdateGroupRequest.getDefaultInstance()) {
                return this;
            }
