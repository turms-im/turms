...
public class ResponseExceptionPublisherPool {
    ...
    private static final Mono ADD_BLOCKED_USER_TO_GROUP = Mono
            .error(ResponseException.get(ResponseStatusCode.ADD_BLOCKED_USER_TO_GROUP));
    ...
    private static final Mono ALREADY_UP_TO_DATE = Mono
            .error(ResponseException.get(ResponseStatusCode.ALREADY_UP_TO_DATE));

    private static final Mono IP_BLOCKLIST_IS_DISABLED = Mono
            .error(ResponseException.get(ResponseStatusCode.IP_BLOCKLIST_IS_DISABLED));
    ...
    private static final Mono NO_CONTENT = Mono
            .error(ResponseException.get(ResponseStatusCode.NO_CONTENT));
    ...
    private static final Mono SERVER_UNAVAILABLE = Mono
            .error(ResponseException.get(ResponseStatusCode.SERVER_UNAVAILABLE));
    ...
    private static final Mono UPDATING_READ_DATE_IS_DISABLED = Mono
            .error(ResponseException.get(ResponseStatusCode.UPDATING_READ_DATE_IS_DISABLED));

    private static final Mono USER_ID_BLOCKLIST_IS_DISABLED = Mono
            .error(ResponseException.get(ResponseStatusCode.USER_ID_BLOCKLIST_IS_DISABLED));
