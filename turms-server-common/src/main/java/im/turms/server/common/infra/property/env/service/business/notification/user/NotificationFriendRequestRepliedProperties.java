...
public class NotificationFriendRequestRepliedProperties {
    ...
    @Description("Whether to notify the requester when a recipient has replied to the friend request sent by the requester")
    @GlobalProperty
    @MutableProperty
    private boolean notifyFriendRequestRequester = true;
