...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userInfos_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.user.UserInfo>();
              mutable_bitField0_ |= 0x00000001;
            }
            userInfos_.add(
                input.readMessage(im.turms.server.common.access.client.dto.model.user.UserInfo.parser(), extensionRegistry));
            break;
          }
          case 16: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersionOuterClass.internal_static_im_turms_proto_UsersInfosWithVersion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersionOuterClass.internal_static_im_turms_proto_UsersInfosWithVersion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion.class, im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends im.turms.server.common.access.client.dto.model.user.UserInfoOrBuilder> 
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion other = (im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion) obj;
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersionOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersionOuterClass.internal_static_im_turms_proto_UsersInfosWithVersion_descriptor;
    }
    ...
    // Construct using im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion getDefaultInstanceForType() {
      return im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion build() {
      im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion buildPartial() {
      im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion result = new im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion) {
        return mergeFrom((im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion other) {
      if (other == im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion.getDefaultInstance()) return this;
      if (userInfosBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion) e.getUnfinishedMessage();
    ...
    public Builder setUserInfos(
        int index, im.turms.server.common.access.client.dto.model.user.UserInfo value) {
      if (userInfosBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserInfos(
        int index, im.turms.server.common.access.client.dto.model.user.UserInfo.Builder builderForValue) {
      if (userInfosBuilder_ == null) {
        ensureUserInfosIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserInfo user_infos = 1;</code>
     */
    public Builder addUserInfos(im.turms.server.common.access.client.dto.model.user.UserInfo value) {
      if (userInfosBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public im.turms.server.common.access.client.dto.model.user.UserInfo.Builder addUserInfosBuilder(
        int index) {
      return getUserInfosFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.user.UserInfo.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserInfo user_infos = 1;</code>
     */
    public java.util.List<im.turms.server.common.access.client.dto.model.user.UserInfo.Builder> 
  ...
  private static final im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion();
  }

  public static im.turms.server.common.access.client.dto.model.user.UsersInfosWithVersion getDefaultInstance() {
