...
public interface TurmsRequestOrBuilder extends
     ...
     */
    im.turms.server.common.access.client.dto.request.user.relationship.DeleteFriendRequestRequest getDeleteFriendRequestRequest();

    /**
     * <code>.im.turms.proto.DeleteFriendRequestRequest delete_friend_request_request = 203;</code>
     */
    im.turms.server.common.access.client.dto.request.user.relationship.DeleteFriendRequestRequestOrBuilder getDeleteFriendRequestRequestOrBuilder();
     ...
     */
    im.turms.server.common.access.client.dto.request.group.enrollment.UpdateGroupInvitationRequest getUpdateGroupInvitationRequest();

    /**
     * <code>.im.turms.proto.UpdateGroupInvitationRequest update_group_invitation_request = 510;</code>
     */
    im.turms.server.common.access.client.dto.request.group.enrollment.UpdateGroupInvitationRequestOrBuilder getUpdateGroupInvitationRequestOrBuilder();
     ...
     */
    im.turms.server.common.access.client.dto.request.group.enrollment.UpdateGroupJoinRequestRequest getUpdateGroupJoinRequestRequest();

    /**
     * <code>.im.turms.proto.UpdateGroupJoinRequestRequest update_group_join_request_request = 512;</code>
     */
    im.turms.server.common.access.client.dto.request.group.enrollment.UpdateGroupJoinRequestRequestOrBuilder getUpdateGroupJoinRequestRequestOrBuilder();
