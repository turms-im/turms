...
public final class UserRelationshipGroup extends com.google.protobuf.GeneratedMessageV3 implements
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return im.turms.server.common.access.client.dto.model.user.UserRelationshipGroupOuterClass.internal_static_im_turms_proto_UserRelationshipGroup_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        ...
                        im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup.Builder.class);
    }
    ...
    public static Builder newBuilder(
            im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup prototype) {
        return DEFAULT_INSTANCE.toBuilder()
                .mergeFrom(prototype);
    }
    ...
    public static final class Builder
        ...
        // Construct using
        // im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup getDefaultInstanceForType() {
            return im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup
                    .getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup build() {
            im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup result =
                    buildPartial();
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup) {
                return mergeFrom(
                        (im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup) other);
            } else {
        ...
        public Builder mergeFrom(
                im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup other) {
            if (other == im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup
                    .getDefaultInstance()) {
                return this;
            }
            if (other.getIndex() != 0) {
    ...
    public static im.turms.server.common.access.client.dto.model.user.UserRelationshipGroup getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<UserRelationshipGroup> PARSER =
