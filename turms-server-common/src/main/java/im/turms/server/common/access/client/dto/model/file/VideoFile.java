...
public final class VideoFile extends com.google.protobuf.GeneratedMessageV3 implements
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return im.turms.server.common.access.client.dto.model.file.VideoFileOuterClass.internal_static_im_turms_proto_VideoFile_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        ...
                        im.turms.server.common.access.client.dto.model.file.VideoFile.Builder.class);
    }
    ...
    public static final class Description extends com.google.protobuf.GeneratedMessageV3 implements
        ...
        protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return im.turms.server.common.access.client.dto.model.file.VideoFileOuterClass.internal_static_im_turms_proto_VideoFile_Description_fieldAccessorTable
                    .ensureFieldAccessorsInitialized(
                            ...
                            im.turms.server.common.access.client.dto.model.file.VideoFile.Description.Builder.class);
        }
        ...
        public static Builder newBuilder(
                im.turms.server.common.access.client.dto.model.file.VideoFile.Description prototype) {
            return DEFAULT_INSTANCE.toBuilder()
                    .mergeFrom(prototype);
        }
        ...
        public static final class Builder
            ...
            // Construct using
            // im.turms.server.common.access.client.dto.model.file.VideoFile.Description.newBuilder()
            private Builder() {
            ...
            @java.lang.Override
            public im.turms.server.common.access.client.dto.model.file.VideoFile.Description getDefaultInstanceForType() {
                return im.turms.server.common.access.client.dto.model.file.VideoFile.Description
                        .getDefaultInstance();
            }

            @java.lang.Override
            public im.turms.server.common.access.client.dto.model.file.VideoFile.Description build() {
                im.turms.server.common.access.client.dto.model.file.VideoFile.Description result =
                        buildPartial();
            ...
            @java.lang.Override
            public im.turms.server.common.access.client.dto.model.file.VideoFile.Description buildPartial() {
                im.turms.server.common.access.client.dto.model.file.VideoFile.Description result =
            ...
            public Builder mergeFrom(com.google.protobuf.Message other) {
                if (other instanceof im.turms.server.common.access.client.dto.model.file.VideoFile.Description) {
                    return mergeFrom(
                            (im.turms.server.common.access.client.dto.model.file.VideoFile.Description) other);
                } else {
            ...
            public Builder mergeFrom(
                    im.turms.server.common.access.client.dto.model.file.VideoFile.Description other) {
                if (other == im.turms.server.common.access.client.dto.model.file.VideoFile.Description
                        .getDefaultInstance()) {
                    return this;
                }
                if (!other.getUrl()
        ...
        public static im.turms.server.common.access.client.dto.model.file.VideoFile.Description getDefaultInstance() {
     ...
     */
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.file.VideoFile.Description getDescription() {
        return description_ == null
                ? im.turms.server.common.access.client.dto.model.file.VideoFile.Description
                        .getDefaultInstance()
                : description_;
    }
     ...
     */
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.file.VideoFile.DescriptionOrBuilder getDescriptionOrBuilder() {
        return description_ == null
                ? im.turms.server.common.access.client.dto.model.file.VideoFile.Description
                        .getDefaultInstance()
                : description_;
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof VideoFile other)) {
            return super.equals(obj);
        }
    ...
    public static Builder newBuilder(
            im.turms.server.common.access.client.dto.model.file.VideoFile prototype) {
        return DEFAULT_INSTANCE.toBuilder()
                .mergeFrom(prototype);
    }
    ...
    public static final class Builder
        ...
        // Construct using
        // im.turms.server.common.access.client.dto.model.file.VideoFile.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.file.VideoFile getDefaultInstanceForType() {
            return im.turms.server.common.access.client.dto.model.file.VideoFile
                    .getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.file.VideoFile build() {
            im.turms.server.common.access.client.dto.model.file.VideoFile result = buildPartial();
            if (!result.isInitialized()) {
                throw newUninitializedMessageException(result);
            }
            return result;
        ...
        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.file.VideoFile buildPartial() {
            im.turms.server.common.access.client.dto.model.file.VideoFile result =
                    new im.turms.server.common.access.client.dto.model.file.VideoFile(this);
            if (bitField0_ != 0) {
                buildPartial0(result);
            }
            onBuilt();
        ...
        @java.lang.Override
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.server.common.access.client.dto.model.file.VideoFile) {
                return mergeFrom(
                        (im.turms.server.common.access.client.dto.model.file.VideoFile) other);
            } else {
                super.mergeFrom(other);
                return this;
            }
        ...
        public Builder mergeFrom(
                im.turms.server.common.access.client.dto.model.file.VideoFile other) {
            if (other == im.turms.server.common.access.client.dto.model.file.VideoFile
                    .getDefaultInstance()) {
                return this;
            }
        ...
        public Builder setDescription(
                im.turms.server.common.access.client.dto.model.file.VideoFile.Description value) {
            if (descriptionBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         */
        public Builder setDescription(
                im.turms.server.common.access.client.dto.model.file.VideoFile.Description.Builder builderForValue) {
            if (descriptionBuilder_ == null) {
        ...
        public Builder mergeDescription(
            ...
            if (descriptionBuilder_ == null) {
                if (((bitField0_ & 0x00000001) != 0)
                        && description_ != null
                        && description_ != im.turms.server.common.access.client.dto.model.file.VideoFile.Description
                                .getDefaultInstance()) {
         ...
         * <code>optional .im.turms.proto.VideoFile.Description description = 1;</code>
         */
        public im.turms.server.common.access.client.dto.model.file.VideoFile.Description.Builder getDescriptionBuilder() {
            bitField0_ |= 0x00000001;
            onChanged();
    ...
    public static im.turms.server.common.access.client.dto.model.file.VideoFile getDefaultInstance() {
        return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<VideoFile> PARSER =
            new com.google.protobuf.AbstractParser<>() {
                @java.lang.Override
