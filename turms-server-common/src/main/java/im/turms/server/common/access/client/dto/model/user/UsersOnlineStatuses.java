...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return im.turms.server.common.access.client.dto.model.user.UsersOnlineStatusesOuterClass.internal_static_im_turms_proto_UsersOnlineStatuses_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses.class, im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses.Builder.class);
  }

  public static final int USER_STATUSES_FIELD_NUMBER = 1;
  private java.util.List<im.turms.server.common.access.client.dto.model.user.UserStatusDetail> userStatuses_;
  /**
   * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
   */
  @java.lang.Override
  public java.util.List<im.turms.server.common.access.client.dto.model.user.UserStatusDetail> getUserStatusesList() {
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.user.UserStatusDetail getUserStatuses(int index) {
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.user.UserStatusDetailOrBuilder getUserStatusesOrBuilder(
      int index) {
    return userStatuses_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses other = (im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses) obj;
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses prototype) {
  ...
  public static final class Builder extends
      ...
      im.turms.server.common.access.client.dto.model.user.UsersOnlineStatusesOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return im.turms.server.common.access.client.dto.model.user.UsersOnlineStatusesOuterClass.internal_static_im_turms_proto_UsersOnlineStatuses_descriptor;
    }
    ...
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses getDefaultInstanceForType() {
      return im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses.getDefaultInstance();
    }

    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses build() {
      im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses result = buildPartial();
    ...
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses buildPartial() {
      im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses result = new im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses) {
        return mergeFrom((im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses other) {
      if (other == im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses.getDefaultInstance()) return this;
      if (userStatusesBuilder_ == null) {
    ...
    private void ensureUserStatusesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        userStatuses_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.user.UserStatusDetail>(userStatuses_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.user.UserStatusDetail, im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder, im.turms.server.common.access.client.dto.model.user.UserStatusDetailOrBuilder> userStatusesBuilder_;
    ...
    public Builder setUserStatuses(
        int index, im.turms.server.common.access.client.dto.model.user.UserStatusDetail value) {
      if (userStatusesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setUserStatuses(
        int index, im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder builderForValue) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public Builder addUserStatuses(im.turms.server.common.access.client.dto.model.user.UserStatusDetail value) {
      if (userStatusesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addUserStatuses(
        im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder builderForValue) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
    ...
    public Builder addAllUserStatuses(
        java.lang.Iterable<? extends im.turms.server.common.access.client.dto.model.user.UserStatusDetail> values) {
      if (userStatusesBuilder_ == null) {
        ensureUserStatusesIsMutable();
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder getUserStatusesBuilder(
        int index) {
     ...
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder addUserStatusesBuilder() {
      return getUserStatusesFieldBuilder().addBuilder(
          im.turms.server.common.access.client.dto.model.user.UserStatusDetail.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.user.UserStatusDetail.Builder addUserStatusesBuilder(
        int index) {
      return getUserStatusesFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.user.UserStatusDetail.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.UserStatusDetail user_statuses = 1;</code>
     */
  ...
  private static final im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses();
  }

  public static im.turms.server.common.access.client.dto.model.user.UsersOnlineStatuses getDefaultInstance() {
