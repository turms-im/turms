...
public final class StorageResourceInfos extends
     ...
     */
    @java.lang.Override
    public java.util.List<? extends im.turms.server.common.access.client.dto.model.storage.StorageResourceInfoOrBuilder>
     ...
     */
    @java.lang.Override
    public im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo getInfos(int index) {
    ...
    public static im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
    }
    ...
    public static im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos parseFrom(java.io.InputStream input)
            throws java.io.IOException {
    ...
    public static im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos parseDelimitedFrom(java.io.InputStream input)
            throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos prototype) {
    ...
    public static final class Builder extends
        ...
        public im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos getDefaultInstanceForType() {
            return im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos.getDefaultInstance();
        }

        @java.lang.Override
        public im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos build() {
            im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos result = buildPartial();
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
            if (other instanceof im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos) {
                return mergeFrom((im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos) other);
            } else {
        ...
        public Builder mergeFrom(im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos other) {
            if (other == im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos.getDefaultInstance()) {
                return this;
            }
            if (infosBuilder_ == null) {
        ...
        public Builder setInfos(
                int index, im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo value) {
            if (infosBuilder_ == null) {
                if (value == null) {
         ...
         */
        public Builder setInfos(
                int index, im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.Builder builderForValue) {
            if (infosBuilder_ == null) {
                ensureInfosIsMutable();
         ...
         * <code>repeated .im.turms.proto.StorageResourceInfo infos = 1;</code>
         */
        public Builder addInfos(im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo value) {
            if (infosBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
        ...
        public im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.Builder addInfosBuilder() {
            return getInfosFieldBuilder().addBuilder(
                    im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.getDefaultInstance());
        }
        ...
        public im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.Builder addInfosBuilder(
                int index) {
            return getInfosFieldBuilder().addBuilder(
                    index, im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.getDefaultInstance());
        }

        /**
         * <code>repeated .im.turms.proto.StorageResourceInfo infos = 1;</code>
         */
        public java.util.List<im.turms.server.common.access.client.dto.model.storage.StorageResourceInfo.Builder>
        getInfosBuilderList() {
    ...
    static {
        DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.storage.StorageResourceInfos();
    }
