...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              messagesWithTotalList_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.message.MessagesWithTotal>();
              mutable_bitField0_ |= 0x00000001;
            }
            messagesWithTotalList_.add(
                input.readMessage(im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return im.turms.server.common.access.client.dto.model.message.MessagesWithTotalListOuterClass.internal_static_im_turms_proto_MessagesWithTotalList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList.class, im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends im.turms.server.common.access.client.dto.model.message.MessagesWithTotalOrBuilder> 
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.message.MessagesWithTotal getMessagesWithTotalList(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList other = (im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList) obj;
  ...
  public static im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList.newBuilder()
    private Builder() {
    ...
    public im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList build() {
      im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList result = buildPartial();
    ...
    public im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList buildPartial() {
      im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList result = new im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList) {
        return mergeFrom((im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList other) {
      if (other == im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList.getDefaultInstance()) return this;
      if (messagesWithTotalListBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList) e.getUnfinishedMessage();
    ...
    private void ensureMessagesWithTotalListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        messagesWithTotalList_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.message.MessagesWithTotal>(messagesWithTotalList_);
    ...
    public Builder setMessagesWithTotalList(
        int index, im.turms.server.common.access.client.dto.model.message.MessagesWithTotal value) {
      if (messagesWithTotalListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setMessagesWithTotalList(
        int index, im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.Builder builderForValue) {
      if (messagesWithTotalListBuilder_ == null) {
        ensureMessagesWithTotalListIsMutable();
     ...
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
    public Builder addMessagesWithTotalList(im.turms.server.common.access.client.dto.model.message.MessagesWithTotal value) {
      if (messagesWithTotalListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.Builder addMessagesWithTotalListBuilder() {
      return getMessagesWithTotalListFieldBuilder().addBuilder(
          im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
    public im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.Builder addMessagesWithTotalListBuilder(
        int index) {
      return getMessagesWithTotalListFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.MessagesWithTotal messages_with_total_list = 1;</code>
     */
    public java.util.List<im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.Builder> 
         getMessagesWithTotalListBuilderList() {
      return getMessagesWithTotalListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.message.MessagesWithTotal, im.turms.server.common.access.client.dto.model.message.MessagesWithTotal.Builder, im.turms.server.common.access.client.dto.model.message.MessagesWithTotalOrBuilder> 
        getMessagesWithTotalListFieldBuilder() {
      if (messagesWithTotalListBuilder_ == null) {
  ...
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.model.message.MessagesWithTotalList();
  }
