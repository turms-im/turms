...
public enum ResponseStatusCode {
    ...
    NOT_OWNER_OR_MANAGER_TO_ACCESS_GROUP_QUESTION_ANSWER(3303, "Only the owner and managers of the group can access group question answers",
            403),
    CREATE_GROUP_QUESTION_FOR_INACTIVE_GROUP(3304, "Cannot create a group question for the inactive group", 403),
    CREATE_GROUP_QUESTION_FOR_GROUP_USING_JOIN_REQUEST(3305, "Cannot create a group question for the group that uses the join request strategy", 403),
    CREATE_GROUP_QUESTION_FOR_GROUP_USING_INVITATION(3306, "Cannot create a group question for the group that uses the invitation strategy", 403),
    CREATE_GROUP_QUESTION_FOR_GROUP_USING_MEMBERSHIP_REQUEST(3307, "Cannot create a group question for the group that uses the membership request strategy", 403),
    GROUP_QUESTION_ANSWERER_HAS_BEEN_BLOCKED(3308, "The group question answerer has been blocked", 403),
    MEMBER_CANNOT_ANSWER_GROUP_QUESTION(3309, "A group member cannot answer group questions", 409),
    ANSWER_INACTIVE_QUESTION(3310, "Cannot answer the inactive questions because the type of the group has changed", 403),
    ANSWER_QUESTION_OF_INACTIVE_GROUP(3311, "Cannot answer the questions of an inactive group", 403),

    // Group - Member
    ADD_USER_TO_GROUP_REQUIRING_INVITATION(3400, "Cannot add a user to the group that requires invitations", 403),
    ADD_USER_TO_INACTIVE_GROUP(3401, "Cannot add a user to the inactive group", 403),
    ADD_USER_WITH_ROLE_HIGHER_THAN_REQUESTER(3402, "Cannot add a user with the role higher than the requester's", 403),
    ...
    NOT_OWNER_OR_MANAGER_TO_REMOVE_GROUP_MEMBER(3405, "Only the owner and managers of the group can remove the group member", 403),
    NOT_OWNER_TO_REMOVE_GROUP_OWNER_OR_MANAGER(3406, "Only the owner of the group can remove the owner or managers", 403),
    NOT_OWNER_TO_UPDATE_GROUP_MEMBER_INFO(3407, "Only the group owner can update the group member's information", 403),
    ...
    NOT_MEMBER_TO_QUERY_MEMBER_INFO(3409, "Only the group members can query its group members' information", 403),
    ...
    SEND_JOIN_REQUEST_TO_GROUP_USING_MEMBERSHIP_REQUEST(3605, "Cannot send a join request to the group that uses the membership request strategy", 403),
    SEND_JOIN_REQUEST_TO_GROUP_USING_INVITATION(3606, "Cannot send a join request to the group that uses the invitation strategy", 403),
    SEND_JOIN_REQUEST_TO_GROUP_USING_QUESTION(3607, "Cannot send a join request to the group that uses the question strategy", 403),
    RECALLING_GROUP_JOIN_REQUEST_IS_DISABLED(3608, "The feature to recall group join requests is disabled", 510),
    ...
    SEND_GROUP_INVITATION_TO_GROUP_NOT_REQUIRE_INVITATION(3709, "Cannot send a group invitation to the group that does not require invitations", 406),
