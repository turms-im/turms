...
public enum ResponseStatusCode {
    ...
    BLOCKED_USER_SEND_GROUP_JOIN_REQUEST(3600, "The group join request sender has been blocked",
            403),
    NOT_SENDER_TO_RECALL_GROUP_JOIN_REQUEST(3601,
            "Only the group join request sender can recall the group join request", 403),
    NOT_GROUP_OWNER_OR_MANAGER_TO_QUERY_GROUP_JOIN_REQUEST(3602,
    ...
    RECALLING_GROUP_JOIN_REQUEST_IS_DISABLED(3608, "Recalling group join requests is disabled",
            510),
    UPDATE_NON_PENDING_GROUP_JOIN_REQUEST(3609, "Cannot update non-pending group join requests",
            403),
    NOT_GROUP_OWNER_OR_MANAGER_TO_UPDATE_GROUP_JOIN_REQUEST(3610,
