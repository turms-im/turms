...
@Data
@NoArgsConstructor
public class NotificationOneSidedRelationshipGroupMemberAddedProperties {

    @Description("Whether to notify the requester's other online sessions when they have added "
