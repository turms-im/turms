...
private static final long serialVersionUID = 0L;
  ...
  private CreateGroupJoinQuestionsRequest(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequestOuterClass.internal_static_im_turms_proto_CreateGroupJoinQuestionsRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest.class, im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends im.turms.server.common.access.client.dto.model.group.GroupJoinQuestionOrBuilder>
   ...
   */
  @java.lang.Override
  public im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion getQuestions(int index) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest)) {
      return super.equals(obj);
    }
    im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest other = (im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest) obj;
  ...
  public static im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest parseFrom(
  ...
  public static im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest.newBuilder()
    private Builder() {
    ...
    public im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest build() {
      im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest result = buildPartial();
    ...
    public im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest buildPartial() {
      im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest result = new im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest) {
        return mergeFrom((im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest)other);
      } else {
    ...
    public Builder mergeFrom(im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest other) {
      if (other == im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest.getDefaultInstance()) return this;
          ...
          switch (tag) {
            ...
            case 18: {
              im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion m =
                  input.readMessage(
                      im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.parser(),
                      extensionRegistry);
              if (questionsBuilder_ == null) {
                ensureQuestionsIsMutable();
                questions_.add(m);
    ...
    private void ensureQuestionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        questions_ = new java.util.ArrayList<im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion>(questions_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestionOrBuilder> questionsBuilder_;
    ...
    public Builder setQuestions(
        int index, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion value) {
      if (questionsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setQuestions(
        int index, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder builderForValue) {
      if (questionsBuilder_ == null) {
        ensureQuestionsIsMutable();
     ...
     * <code>repeated .im.turms.proto.GroupJoinQuestion questions = 2;</code>
     */
    public Builder addQuestions(im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion value) {
      if (questionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder addQuestionsBuilder() {
      return getQuestionsFieldBuilder().addBuilder(
          im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinQuestion questions = 2;</code>
     */
    public im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder addQuestionsBuilder(
        int index) {
      return getQuestionsFieldBuilder().addBuilder(
          index, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.getDefaultInstance());
    }
    /**
     * <code>repeated .im.turms.proto.GroupJoinQuestion questions = 2;</code>
     */
    public java.util.List<im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder>
         getQuestionsBuilderList() {
      return getQuestionsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestion.Builder, im.turms.server.common.access.client.dto.model.group.GroupJoinQuestionOrBuilder>
  ...
  static {
    DEFAULT_INSTANCE = new im.turms.server.common.access.client.dto.request.group.enrollment.CreateGroupJoinQuestionsRequest();
  }
  ...
  private static final com.google.protobuf.Parser<CreateGroupJoinQuestionsRequest>
      PARSER = new com.google.protobuf.AbstractParser<CreateGroupJoinQuestionsRequest>() {
    @java.lang.Override
