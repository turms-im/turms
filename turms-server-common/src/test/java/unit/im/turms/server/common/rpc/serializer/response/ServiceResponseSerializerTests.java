...
package unit.im.turms.server.common.rpc.serializer.response;
...
class ServiceResponseSerializerTests extends BaseSerializerTest {
    ...
    void shouldGetTheSameRequest_afterWriteAndRead_forLegalRequest() {
        ...
        ServiceResponse actualRequest = writeDataAndReadBuffer(new ServiceResponseSerializer(),
                expectedResponse);
