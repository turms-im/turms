...
class CountOnlineUsersRequestSerializerTests extends BaseSerializerTest {
    ...
    void shouldGetTheSameRequest_afterWriteAndRead_forLegalRequest() {
        ...
        CountOnlineUsersRequest actualRequest = writeRequestAndReadBuffer(new CountOnlineUsersRequestSerializer(),
                expectedRequest);
