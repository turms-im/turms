...
class HandleServiceRequestSerializerTests extends BaseSerializerTest {
    ...
    void shouldGetTheSameRequest_afterWriteAndRead_forLegalRequest() {
        ...
        HandleServiceRequest actualRequest = writeRequestAndReadBuffer(new HandleServiceRequestSerializer(),
